...
public class Class45
{
    ...
    {
        ByteStream byteStream = new ByteStream(true, class2.method154("fragmentsenc.txt", null));
        ByteStream byteStream_1 = new ByteStream(true, class2.method154("badenc.txt", null));
        ByteStream byteStream_2 = new ByteStream(true, class2.method154("domainenc.txt", null));
        ByteStream byteStream_3 = new ByteStream(true, class2.method154("tldlist.txt", null));
        method374(byteStream, byteStream_1, byteStream_2, byteStream_3);
    }

    public static void method374(ByteStream byteStream, ByteStream byteStream_1, ByteStream byteStream_2, ByteStream byteStream_3)
    {
        method376(true, byteStream_1);
        method377(20529, byteStream_2);
        method378(byteStream, 21901);
        method375(byteStream_3, -7305);
    }

    public static void method375(ByteStream byteStream, int i)
    {
        int j = byteStream.method526();
        aCharArrayArray744 = new char[j][];
        anIntArray745 = new int[j];
        for(int k = 0; k < j; k++)
        {
            anIntArray745[k] = byteStream.method521();
            char ac[] = new char[byteStream.method521()];
            for(int l = 0; l < ac.length; l++)
                ac[l] = (char) byteStream.method521();
    ...
    public static void method376(boolean flag, ByteStream byteStream)
    {
        if(!flag)
        {
            return;
        ...
        {
            int i = byteStream.method526();
            aCharArrayArray741 = new char[i][];
            aByteArrayArrayArray742 = new byte[i][][];
            method379(34541, byteStream, aCharArrayArray741, aByteArrayArrayArray742);
            return;
        }
    }

    public static void method377(int i, ByteStream byteStream)
    {
        int j = byteStream.method526();
        aCharArrayArray743 = new char[j][];
        method380(byteStream, aCharArrayArray743, -37125);
        if(i != 20529)
            anInt729 = 311;
    }

    public static void method378(ByteStream byteStream, int i)
    {
        if(i != 21901)
            return;
        anIntArray740 = new int[byteStream.method526()];
        for(int j = 0; j < anIntArray740.length; j++)
            anIntArray740[j] = byteStream.method523();

    }

    public static void method379(int i, ByteStream byteStream, char ac[][], byte abyte0[][][])
    {
        for(int j = 0; j < ac.length; j++)
        {
            char ac1[] = new char[byteStream.method521()];
            for(int k = 0; k < ac1.length; k++)
                ac1[k] = (char) byteStream.method521();

            ac[j] = ac1;
            byte abyte1[][] = new byte[byteStream.method521()][2];
            for(int l = 0; l < abyte1.length; l++)
            {
                abyte1[l][0] = (byte) byteStream.method521();
                abyte1[l][1] = (byte) byteStream.method521();
            }
    ...
    public static void method380(ByteStream byteStream, char ac[][], int i)
    {
        if(i != -37125)
            anInt728 = 218;
        for(int j = 0; j < ac.length; j++)
    ...
    public static int method398(char c, char c1, char c2, int i)
    {
        ...
        if(c >= 'n' && c <= 'z')
        {
            ...
            if(c == 'o')
            {
                if(c1 == '0' || c1 == '*')
                    return 1;
                return (c1 != '(' || c2 != ')') && (c1 != '[' || c2 != ']') && (c1 != '{' || c2 != '}') && (c1 != '<' || c2 != '>') ? 0 : 2;
            }
            if(c == 'p')
                return 0;
            if(c == 'q')
    ...
    public static final String aStringArray746[] = {
