    ...
    implements Runnable
{
            ...
            if(anInt1362 > 0 && i >= anInt1362)
            {
                ...
                if(anInt1362 + anInt1361 >= abyte0.length && aClass50_Sub1_Sub3_1372 != null)
                {
                    if(aClient1373.aClass23Array1228[0] != null)
                        aClient1373.aClass23Array1228[aClass50_Sub1_Sub3_1372.anInt1467 + 1].method293(abyte0.length, true, abyte0, aClass50_Sub1_Sub3_1372.anInt1468);
    ...
    public Class50_Sub1_Sub3 method330()
    {
        ...
        try
        {
            GZIPInputStream gzipinputstream = new GZIPInputStream(new ByteArrayInputStream(class50_sub1_sub3.aByteArray1470));
            do
            {
    ...
    public void run()
    {
        try
        {
            while(aBoolean1339) 
            {
                ...
                if(aClient1373.aBoolean1137 && aSocket1355 != null && anOutputStream1349 != null && (anInt1341 > 0 || aClient1373.aClass23Array1228[0] == null))
                {
                    anInt1375++;
                    if(anInt1375 > 500)
                    {
    ...
    public void method335(Class2 class2, client client1)
    {
        ...
        for(int i = 0; i < 4; i++)
        {
            ...
            for(int l = 0; l < j; l++)
                anIntArrayArray1377[i][l] = byteStream.method523();
        ...
        for(int k = 0; k < 4; k++)
        {
            ...
            ByteStream byteStream_1 = new ByteStream(true, abyte1);
            anIntArrayArray1344[k] = new int[i1];
            for(int l1 = 0; l1 < i1; l1++)
                anIntArrayArray1344[k][l1] = byteStream_1.method526();
        ...
        ByteStream byteStream_2 = new ByteStream(true, abyte2);
        j1 = abyte2.length / 7;
        ...
        {
            anIntArray1346[i2] = byteStream_2.method523();
            anIntArray1360[i2] = byteStream_2.method523();
            anIntArray1365[i2] = byteStream_2.method523();
            anIntArray1336[i2] = byteStream_2.method521();
        }

        abyte2 = class2.method154("anim_index", null);
        byteStream_2 = new ByteStream(true, abyte2);
        j1 = abyte2.length / 2;
        anIntArray1376 = new int[j1];
        for(int j2 = 0; j2 < j1; j2++)
            anIntArray1376[j2] = byteStream_2.method523();
        ...
        for(int k2 = 0; k2 < j1; k2++)
            anIntArray1366[k2] = byteStream_2.method521();
    ...
    public void method338(boolean flag)
    {
        ...
        while(class50_sub1_sub3 != null) 
        {
            ...
            byte abyte0[] = null;
            if(aClient1373.aClass23Array1228[0] != null)
                abyte0 = aClient1373.aClass23Array1228[class50_sub1_sub3.anInt1467 + 1].method292(aByte1371, class50_sub1_sub3.anInt1468);
            if(!method341(abyte0, 764, anIntArrayArray1377[class50_sub1_sub3.anInt1467][class50_sub1_sub3.anInt1468], anIntArrayArray1344[class50_sub1_sub3.anInt1467][class50_sub1_sub3.anInt1468]))
                abyte0 = null;
            synchronized(aClass6_1340)
            {
                if(abyte0 == null)
        ...
        try
        {
            if(aSocket1355 == null)
            {
                ...
                if(l - aLong1378 < 4000L)
                    return;
                aLong1378 = l;
                aSocket1355 = aClient1373.method32(43594 + client.anInt924);
