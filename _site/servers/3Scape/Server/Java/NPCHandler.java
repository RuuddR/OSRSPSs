						...
						if (misc.random2(50) == 1) {
							...
							npcs[i].textUpdate = "Moo";
                 					...
                 					if (misc.random2(50) == 3) { 
                     					npcs[i].updateRequired = true; 
                     					npcs[i].textUpdateRequired = true;  
                     					npcs[i].textUpdate = "Azn Was Here!";} 
		       					} if (npcs[i].npcType == 43) { 
                 					if (misc.random2(50) == 3) { 
                     					npcs[i].updateRequired = true; 
                     					npcs[i].textUpdateRequired = true;  
                     					npcs[i].textUpdate = "tEh |337 Sheep - <3Scape Owner";} 
...
if((npcs[NPCID].npcType == 1096) || (npcs[NPCID].npcType == 1608) || (npcs[NPCID].npcType == 55) || (npcs[NPCID].npcType == 1610) || (npcs[NPCID].npcType == 3494) || (npcs[NPCID].npcType == 2060) || (npcs[NPCID].npcType == 221) || (npcs[NPCID].npcType == 84) || (npcs[NPCID].npcType == 110) || (npcs[NPCID].npcType == 3340) || (npcs[NPCID].npcType == 49) || (npcs[NPCID].npcType == 2783)) {
ItemHandler.addItem(Item3.randomtrain(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
...
if(npcs[NPCID].npcType == 2025 || npcs[NPCID].npcType == 2026 || npcs[NPCID].npcType == 2027 || npcs[NPCID].npcType == 2028 || npcs[NPCID].npcType == 2029 || npcs[NPCID].npcType == 2030) {
