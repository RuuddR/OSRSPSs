...
p.sendQuest("@bla@Mouse Buttons", 918);
p.sendQuest("@red@V-Dark", 919);
p.sendQuest("@red@Dark", 920);
p.sendQuest("@red@Bright", 921);
p.sendQuest("@gre@V-Bright", 922);

p.sendQuest("@bla@Mouse Buttns", 923);
p.sendQuest("@red@I'm cool", 925);
p.sendQuest("@gre@Two", 924);
p.sendQuest("@bla@Chat Effects", 926);
p.sendQuest("@gre@On", 928);
p.sendQuest("@red@I'm cool", 927);

p.sendQuest("@red@I'm cool", 960);
p.sendQuest("@gre@Yes", 959);
...
p.sendQuest("@whi@", 949);
p.sendQuest("@whi@", 950);
p.sendQuest("@bla@      Tele Port's", 174);

p.sendQuest(" Change your character looks!", 3649);
p.sendQuest("@bla@Rearrange mode -", 5390);
p.sendQuest("@bla@Withdraw as -", 5388);
p.sendQuest("@whi@Swap", 8133);
p.sendQuest("@whi@Insert", 8132);
p.sendQuest("@whi@Item", 5389);
p.sendQuest("@whi@Note", 5391);
...
p.sendQuest("@bla@Ignore List", 5717);
p.sendQuest("@whi@Add Friend", 5070);
p.sendQuest("@whi@Del Friend", 5071);
p.sendQuest("@bla@Add Player", 5720);
p.sendQuest("@bla@Del Player", 5721);
...
p.sendFrame126("Close Window",3902 );
...
p.sendQuest("@gre@Level 82 : kyle blitz Blitz", 12873);
