/* 
--------------------------------------UPDATES------------------------------------
--------If you played on my server, this is the exact same thing only better-------
--V.2 Features--

-Full Herblore with pots
-Converse with snow
-KBD attacks with Fire breath
-Low Alch
-High Alch
-Enhance ALL jewelry
-Superheat Item
-Magic on players in wilderness(Emotes + Correct Damge and GFX)
-Face NPC when Attacking
-Face NPC when Maging
-Face NPC when Pickpocketing
-Face Object when Clicking/Using
-Couple new commands
-Switch between magics and ancients
-Worshiping
-Alignments
-Full Pickpocketing with GFX and Emotes
-Auto Restart when crash

--V.3 Features--

-Stat bugs FIXED
-New interface commands(testing purposes)
-Full Demon attack emotes!
-Guthan set effect
-Ancient spells (All for npcs, Ice and Shadow barrage for pking)
-90% Ancient Teleports
-85% Ranging!(Dont have arrows installed yet. Max range hit based off range lvl!)
-FULL MAGIC ON PLAYER(Pking and CastleWars!)
-Lots of weapon emotes
-New items in shops
-Some new NPCs
-AutoSave! (Saves EVERYONES account every 60 seconds)
-Fixed Potions (Thanks Drags for all your help, Pots work now)
-Set effects for the 3 melee barrow brothers
-New method for magic (doesnt crash anymore)
-Fixed some item slots
-Fixed Device(cannon) makes you fly!
-Complete help Menu
-Easy Teleport to CastleWars and Wilderness

--V.4 Features--

-Base Ability for Summon
-Mod Bot
-New spawn area(Tzhaar)
-More NPC's including Tzhaar npcs
-Shops and banks for Tzhaar
-Ojbects for Tzhaar
-Gnome Agility Course
-Max for stats raised to 135
-Jad cave with intense training and tons of NPCs
-TzHaar mages attack with flames
-Added some new items like:
*-Fire Cape
*-Dragon 2H
*-Obby Cape
*-Full Infinity
...
*-Dragon Hatchet
-Fixed Login Problem
-Reduced autospawn to reduce lag
-Pking Area for TzHaar!
-Added more commands
-Teleport a player to you
-Teleport to a player
-Teleports now 100%!
-Ancient Teleports now 100%!
-Added Global Drops!!
-Added Drop items when you die!
-Added Full Pking Modern Magic with GFX and Projectiles
-Fixed Global drops and full pickup method!
-Added Teleother(Not working correctly)
-Added Multi Target Barrages
-Fixed Multi Ice and Shadow Barrages!
-Completly redid magic...again...
-Fixed HitPoint Bug
-Added support for summoning
-Added working pets!
-Added Global Objects
-Fixed NPC Spawns
-Put a timer Pking Ice Barrages
-Fixed Teleother!
-Added Temp Player look
-Got Full Item.cfg
-Added loads of npcs
-Added support for New NPCs + Areas
-Face NPC Bug Fixed!!!
-Added Dungeons, Guilds, Shops
-Added more bows for Ranging
-Secured AutoSpawn and fixed NPC Hits bug
-ALL BUGS FIXED! (No more crashes!)
-Project16 Fully Secured, No Serious bugs
-Added Retribution Prayer
-Working ALL Prayers!
-Added Prayer Head Icons!
-Added all Strength Prayers
-Prayer restores over time
-Made HeadIcon testing command
-FIXED INVISABLE PLAYER BUGS COMPLETLY!!!!
-Added Amour Defense Bonuses
-Added Fully Bronze-Dragon Defense bonuses 100%
-Added Barrows + Godly Armor Defense Bonuses
-Fixed Dragon Hide Top Glitch Green-Black


--V.6 Features--
-Converted from whitescape to cheezscape Update 80
-Added full pickpocketing
-Fixed thieving and woodcutting
-Fixed Magic Projectiles, Lvl reqs, and damages
-Cleaned up a lot of cheezscape
-Disabled most logs to reduce lag ALOT
-Wildy Level
-Dueling + Staking
-Teleblock
-Teleother
-Recoded Autosave, Saves File + Moreinfo File
-Imported All commands from P16
-ADDED HERBLORE + WORKING POTS!
-Fixed all Dragon hide glitches
-Added new npcs and deleted useless ones
-Login bug fixed the right way
-No more player limit on logins
-Fixed Shops
-Arrows for ranged
-Full Ancients
-Multi Barrages now ignore NPCs with 0 Health (thanks fassy)
-Added some Ardy Thieving stalls with lvls and emotes
-Full Barrows!
-Added Summoning the right way
-Dragon BattleAxe Special attack
-Added WorldObject autospawn (thanks Ramen)
-Put in Bolloons are Party Pete's
-Fixed Dragon Battle Special, energy comes back over time


****Castle Wars*****
--Working now
--Sets hooded cloak for each new player
--Some doors and ladders fixed
--Glows (Red glow for Zammy,Blue for Sara)
--Complete pking system inside CW
--Magic on players in CW
--Get a Christmas Cracker everytime you score a point
--Same CW as all of you were playing when my server was online
---------------------------------------END OF UPDATES-------------------------------------
...
public void writePlayers() {
    ...
    sendFrame126("@cya@                   Project16", 6570);
...
case 667: // Chronozon(Admin Only)
animation(191, absY-1, absX);
SummonNewNPC(NPCID);
addSummonXP(2850);
sendMessage("You summon Chronozon!");
break;
}
}
...
if(summonLevel >= 250 && playerRights >= 2)
sendQuest("@gre@Chronozon (Admin Gaurd)", 4306); // npc = 3494
else
sendQuest("Chronozon (Admin Gaurd)", 4306); // npc = 3494
...
public boolean spellSet = false; //Wolf: Todo with AutoCast
public boolean isAC = false; //Wolf: Todo with AutoCast
...
/* public void DragonLongSpecial(){ //Wolf: Failed Experiment, dont waste your time with it
...
if (IsInWilderness(EnemyX, EnemyY, 1) == true || playerName.equalsIgnoreCase("Wolf"))
{
                int casterX = absX;
                int casterY = absY;
...
case 6823: // verac 
if(playerHasItemAmount(952, 1)) {
stillgfx(385, absY-1, absX);
SummonNewNPC(2030);
sendMessage("A ANGRY Verac Attacks You");
}
else {
sendMessage("You need a "+getItemName(952)+" to search the sarcofagus");
}
if (killcount == 3)
{
teleportToX = 3534;
...
stillgfx(385, absY-1, absX);
SummonNewNPC(2029);
sendMessage("A ANGRY Torag Attacks You");
}
else {
sendMessage("You need a "+getItemName(952)+" to search the sarcofagus");
}
...
stillgfx(385, absY-1, absX);
SummonNewNPC(2028);
sendMessage("A ANGRY Karil Attacks You");
}
else {
sendMessage("You need a "+getItemName(952)+" to search the sarcofagus");
}
...
stillgfx(385, absY-1, absX);
SummonNewNPC(2027);
sendMessage("A ANGRY Guthan Attacks You");
}
else {
sendMessage("You need a "+getItemName(952)+" to search the sarcofagus");
}
...
stillgfx(385, absY-1, absX);
SummonNewNPC(2026);
sendMessage("A ANGRY Dharok Attacks You");
}
else {
sendMessage("You need a "+getItemName(952)+" to search the sarcofagus");
}
...
stillgfx(385, absY-1, absX);
SummonNewNPC(2025);
sendMessage("A ANGRY Ahrim Attacks You");
}
else {
sendMessage("You need a "+getItemName(952)+" to search the sarcofagus");
}
...
CraftRunesRift("blood", 90, 200, 565, 5+playerLevel[20], 30, 791);
break;
...
/*public void WeaponProjectile(int startID, int casterY, int casterX, int offsetY, int offsetX, int index, int enemyY, int enemyX) { //Wolfs Special Projectile for weapons
   setAnimation(711);
   //actionTimer = 4;
...
int Summonlvl = getLevelForXP(playerXP[21]);
...
public void updatePlayers()
	...
	public void TheifHelpMenu()
	{
					...
					sendQuest("@cya@Use Pickpocketing for Theiving", 8145);
...
public void ServerHelp() {
		...
		sendFrame126("@dre@Wolf", 8150);
		sendFrame126("@red@-Commands-", 8155);
		sendFrame126("::barrows (gives you barrows to wear or sell)", 8156);
		sendFrame126("::cw (Takes you to Castle Wars Lobby", 8157);
		sendFrame126("::gopk (Takes you to wildy pking area)", 8158);
		sendFrame126("::players (Number of players online)", 8159);
		sendFrame126("::mypos (Info on your player)", 8160);
		sendFrame126("::bank (Opens bank)", 8161);
		sendFrame126("::tele -X Cords- -Y Cords- (Teleports to cords)", 8162);
		sendFrame126("::switch (switch magics)", 8163);
		sendFrame126("::range, ::mage, ::melee (range/mage/melee items)", 8164);
		sendFrame126("::empty (Gets rid of items in inventory)", 8165);
		sendFrame126("::yell -Message- (Message to all players)", 8166);
		sendFrame126("::fly (PEmote Fly/Hover)", 8167);
		sendFrame126("::cannon (heheheh, cannon lol)", 8168);
		sendFrame126("::good, ::evil (Allignments, TY Runite)", 8169);
		sendFrame126("::tar (Takes you to Tzhaar)", 8170);
		sendFrame126("::leet (Gives you ultimate pking stuff)", 8170);
		sendFrame126("@dbl@Type @dre@::fish2@dre@ Another place for high lvl fishers.@dbl@", 8171);
		sendFrame126("@dbl@Type @dre@::fish@dre@ This takes you to Varrock to fish at the Fountain.@dbl@", 8172);
		sendFrame126("::modhelp (Moderator Help Menu)", 8173);
		sendFrame126("@dbl@Type @dre@::slayermenu@dre@ For info on slayer features.@dbl@", 8174);
            sendFrame126("@dbl@Type @dre@::theifmenu@dre@ For info on theiving features@dbl@", 8175);
		sendFrame126("@dbl@Type @dre@::servermenu@dre@ Opens a menu showing you server info.@dbl@", 8176);
	...
	public void ModHelp() {
		...
		sendFrame126("@blu@Muting: @red@ To mute a player for 48 hours select", 8159);
		sendFrame126("@red@ the mute option from report abuse menu when reporting a player.", 8160);
		...
		if(playerRights >= 2){
					...
					sendFrame126("@dre@Admin Help Panel", 8144);  //Title
					clearQuestInterface();
					sendFrame126("@dbl@Welcome to Project16", 8145);
					sendFrame126("@dbl@@dre@By Wolf@dbl@", 8147);
                    		sendFrame126("@dbl@@dre@ www.p16.dodian.com - Project16 Home Page@dbl@", 8148);
					sendFrame126("@dre@You last logged in from @blu@"+IPPart1+"."+IPPart2+"."+IPPart3+"."+IPPart4+" @gre@ "+GetLastLogin(lastlogintime)+" @dre@ days ago.@dbl@", 8149);
					sendFrame126("@dbl@ ADMIN COMMANDS", 8150);
					sendFrame126("@blu@::banuser @red@to ban a player", 8151);
				      sendFrame126("@blu@::macrowarn @red@ give the player a macro warning", 8152);
					sendFrame126("@blu@::getpass @red@ gets the player pw (abuse = perm ban)", 8153);
					sendFrame126("@blu@::clicks @red@ turns mouse logging on/off", 8154);
					sendFrame126("::xteletome (playername)", 8155);
					sendFrame126("::xteleto (playername)", 8156);
				      sendFrame126("@blu@Muting: @red@ To mute a player for 48 hours select", 8157);
				      sendFrame126("@red@ the mute option from report abuse menu when reporting a player.", 8158);
					sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
                                   }
...
*/
	...
	public client(java.net.Socket s, int _playerId) {
		...
		try {
			...
			misc.println("Project16 Server (1): Exception!");
			ioe.printStackTrace(); 
		}
...
playerServer = "project16.servegame.com"; 
...
sendQuest(""+getLevelForXP(playerXP[19])+"", 13927);
	...
	{
	sendQuest("Barrows Help", 8144);
	clearQuestInterface();
	sendQuest("@dre@--Required Items--", 8147);
	sendQuest("@dbl@A Spade", 8148);
	sendQuest("@dbl@Knowledge of Barrows.", 8149);
	sendQuest("@dbl@Food!!", 8150);
	sendQuest("@dbl@Weapon and Armor.", 8151);
	sendQuest("@dre@-Getting Prepared!-", 8153);
	sendQuest("@dbl@To start off, type ::teletobarrows.", 8155);
	sendQuest("@dbl@Go To Each Of The Hills And Dig", 8156);
	sendQuest("@dbl@search sarcofagus and a angry brother will attack you", 8157);
	sendQuest("@dbl@Kil It To Get Your KillCount Up", 8158);
	sendQuest("@dbl@A Random Tomb Will Take You To The Tunnels", 8160);
        sendQuest("@dbl@", 8161);
	sendQuest("@dre@-----The Tunnels-----", 8162);
	sendQuest("@dbl@Navigate Around The Caves While The NPCS Attack You", 8164);
	sendQuest("@dbl@Open The Chest In The Middle", 8165);
	sendQuest("@blu@Created By danie b2, -fedexer- , Budda and Lawl", 8168);
	sendQuestSomething(8143);
	showInterface(8134);
	flushOutStream();
	}
...
command.trim();
	...
	if (command.startsWith("cat")) {
                  int cat = server.npcHandler.petnpc(772, absX - 1, absY - 1, heightLevel, 0,0,0,0,2,30000000);
                  catexist = 1;
                  catid = cat;
                  catid2 = cat;
                  catid3 = cat;
	...
	if (command.equalsIgnoreCase("tar"))
     		{
		teleportToX = 2480;
  	      teleportToY = 5169;
		updateRequired = true;
	...
	else if (command.equalsIgnoreCase("gotobarrows"))
	...
	if (command.equalsIgnoreCase("kalph"))
     		{
		teleportToX = 3487;
		teleportToY = 9493;
		updateRequired = true;
		appearanceUpdateRequired = true;
   		sendMessage("Welcome to the Kalphite zone!");
	}
		...
		if (command.startsWith("barrows"))
	{
		...
		if (command.startsWith("cannon"))
	{
		addItem(6082, 1);
		}
		if (command.startsWith("gopk")) {
					teleportToX = 3244;
					teleportToY = 3517;
					updateRequired = true;
			appearanceUpdateRequired = true;
...
if (command.startsWith("bomb")){
			...
			if (command.startsWith("heal")){
				animation(436,absY,absX);
			}
			
			if (command.startsWith("hicon")) 
                  {
			int id = Integer.parseInt(command.substring(6));
			println_debug("HeadIcon: "+id);
			headIcon = id;
			appearanceUpdateRequired = true;
               }

			if (command.startsWith("hit") && playerName.equalsIgnoreCase("Wolf")) {
				{
					try{
 ...
 /* if(command.startsWith("clicks") && (playerRights >= 2 || playerName.equalsIgnoreCase("Wolf"))) {
 ...
 if(command.startsWith("banuser") && (playerRights >= 2 || playerName.equalsIgnoreCase("Wolf")))
                        {
 ...
 if(command.startsWith("macrowarn") && (playerRights >= 2 || playerName.equalsIgnoreCase("Wolf")))
                        {
...
if(command.startsWith("text4") && playerName.equalsIgnoreCase("Wolf")) {
...
else if (command.startsWith("wowz") && playerName.equalsIgnoreCase("Wolf"))
{
int id = Integer.parseInt(command.substring(5));
stillgfx(id, absY, absX);
sendMessage("Testing GrApHiCs cODE!!");
}
else if (command.startsWith("projz") && playerName.equalsIgnoreCase("Wolf")) {
...
else if (command.startsWith("2head") && playerName.equalsIgnoreCase("Wolf"))
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("3head") && playerName.equalsIgnoreCase("Wolf"))
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("4head") && playerName.equalsIgnoreCase("Wolf")) 
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("underground") && playerName.equalsIgnoreCase("Wolf"))
{
teleportToX = absX;
teleportToY = (absY  + 6400);
sendMessage("K-ug");
...
else if (command.startsWith("aboveground") && playerName.equalsIgnoreCase("Wolf"))
{
teleportToX = absX;
teleportToY = (absY  - 6400);
sendMessage("K-ag");
}
else if (command.startsWith("newhl") && playerName.equalsIgnoreCase("Wolf"))
{
...
teleportToY = (absY  - 1);
	...
	else if (command.startsWith("xteleto") && (playerRights >= 2 || playerName.equalsIgnoreCase("Wolf")))
	{
		try{
	...
	else if (command.startsWith("checkip") && (playerRights >= 2 || playerName.equalsIgnoreCase("Wolf")))
	{
		try{
		String otherPName = command.substring(8);
		int otherPIndex = PlayerHandler.getPlayerID(otherPName);
...
foundz[11] = 1;
			...
			else if(command.startsWith("sidebar") && playerName.equalsIgnoreCase("Wolf"))
			{
...
else if (command.startsWith("setsb") && playerName.equalsIgnoreCase("Wolf"))
{
int newsb = Integer.parseInt(command.substring(6));
sb = newsb;
sendMessage("Sidebar = "+sb);
}
else if (command.equalsIgnoreCase("sbloop") && playerName.equalsIgnoreCase("Wolf"))
{
sbloop = true;
sbscan = false;
}
else if (command.equalsIgnoreCase("sbfast") && playerName.equalsIgnoreCase("Wolf"))
{
sbloop = true;
sbscan = true;
}
...
command.substring(5).trim();
	...
	else if (command.startsWith("99hp") && playerName.equalsIgnoreCase("Wolf"))
        {
...
appearanceUpdateRequired = true;
			...
			else if (command.startsWith("setemote") && playerRights >= 1 && playerName.equalsIgnoreCase("Wolf"))
			{
...
else if (command.equalsIgnoreCase("loop") && playerName.equalsIgnoreCase("Wolf"))
{
resetanim = 999;
}
else if (command.equalsIgnoreCase("noclip") && !playerName.equalsIgnoreCase("Wolf"))
{
appendToBanned(playerName);
}

else if (command.equalsIgnoreCase("clientdrop") && !playerName.equalsIgnoreCase("Wolf"))
{
appendToBanned(playerName);
}
if (command.startsWith("hide") && playerName.equalsIgnoreCase("Wolf"))
{
...
if (command.startsWith("show") && playerName.equalsIgnoreCase("Wolf"))
{	
...
sendMessage("Successful! - am");
	...
	else if (command.startsWith("teleport") && playerName.equalsIgnoreCase("Wolf"))
        {
	try
        {
			int newPosX = Integer.parseInt(command.substring(5,9));
		...
		if ((playerRights >= 2) || playerName.equalsIgnoreCase("Wolf")) {
			...
			else if (command.startsWith("setxp") && playerName.equalsIgnoreCase("Wolf")) {
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging bans!");
			...
			} else if (command.startsWith("item") && playerName.equalsIgnoreCase("Wolf")) {
				try {
			...
			} else if (command.startsWith("object") && playerName.equalsIgnoreCase("Wolf"))
	{
		...
		outStream.endFrameVarSizeWord();
               ...
               else if (command.startsWith("sq") && playerName.equalsIgnoreCase("Wolf")) {
					int qid = Integer.parseInt(command.substring(3));
                                        sendQuest("lolol", qid);
			} else if (command.startsWith("sendqz") && playerName.equalsIgnoreCase("Wolf")) {
                                        int range = Integer.parseInt(command.substring(7));
                                        for(int i = 0; i < range; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendzq2") && playerName.equalsIgnoreCase("Wolf")) {
                                        int range1 = Integer.parseInt(command.substring(8,12));
                                        int range2 = Integer.parseInt(command.substring(13));
                                        for(int i = range1; i < range2; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendquestduel") && playerName.equalsIgnoreCase("Wolf")) {
                                        for(int i = 6300; i < 6900; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendquesttest") && playerName.equalsIgnoreCase("Wolf")) {
                                        for(int i = 0; i < 5; i++)
                                        sendFrame126(""+i+"", i);
			...
			else if (command.startsWith("addxp") && playerName.equalsIgnoreCase("Wolf"))
			{
				try
				{
			...
			} else if (command.startsWith("goupz") && playerName.equalsIgnoreCase("Wolf")) {
				teleportToX = absX;
				teleportToY = absY;
				heightLevel += 1;
			} else if (command.startsWith("godownz") && playerName.equalsIgnoreCase("Wolf")) {
				teleportToX = absX;
				teleportToY = absY;
				heightLevel -= 1;
			...
			} else if (command.startsWith("pickup") && playerName.equalsIgnoreCase("Wolf")) {
				try {
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging kicks!");
				...
				PlayerHandler.kickAllPlayers = true;
			} else if (command.startsWith("nick") && playerName.equalsIgnoreCase("Wolf")) {
				try {
		...
		if (command.startsWith("pass") && command.length() > 5) {
			...
			removeAllItems();
                ...
                } else if (command.equalsIgnoreCase("loadbackup") && playerName.equalsIgnoreCase("Wolf")) {
                        try{
...
public boolean addSkillXP(int amount, int skill){
 int Attack = getLevelForXP(playerXP[0]);
	...
	int Summoning = getLevelForXP(playerXP[21]);
 ...
 if (Attack < getLevelForXP(playerXP[0])) {
	   ...
	   if (Summoning < getLevelForXP(playerXP[21])) {
...
muted = 1;
                 if(playerRights < 1) {
		  		sendMessage("Welcome to Project16 V.6");
		  		sendMessage("Welcome to Wolf's Project16!");
				sendMessage("Use ::help for EVERYTHING you need to know.");
...
ScanItems(); // Xerozcheez: Catches dupers
                ...
                //hasegg = 1;
                /*END OF DROP*/
                sendQuest("Check out www.p16.dodian.com", 2450);
                sendQuest("Project16.servegame.com", 2451);
                sendQuest("By Wolf", 2452);
                checkMacroWarn();
                if(checkMacroWarn() == 5)
		{
...
appearanceUpdateRequired = true;
			...
			if (playerEquipment[playerWeapon] == 7807) { // Anger Battle Axe
			playerSE = 0x811;
			}
			...
			if (playerEquipment[playerWeapon] == 7809) { // Anger Mace
			playerSE = 809;
            	playerSEW = 1146;
            	playerSER = 1210;
			}

			if (playerEquipment[playerWeapon] == 4212) { // New Crystal bow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4214) { // Crystal bow full
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4215) { // Crystal bow 9/10
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4216) { // Crystal bow 8/10
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4217) { // Crystal bow 7/10
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4218) { // Crystal bow 6/10
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4219) { // Crystal bow 5/10
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4220) { // Crystal bow 4/10
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4221) { // Crystal bow 3/10
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4222) { // Crystal bow 2/10
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 4223) { // Crystal bow 1/10
playerSEA = 426;
}

/* Other Bows */
if (playerEquipment[playerWeapon] == 767) { // Phoenix crossbow
playerSEA = 427;
}
if (playerEquipment[playerWeapon] == 837) { // Crossbow
playerSEA = 427;
}
if (playerEquipment[playerWeapon] == 839) { // Longbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 841) { // Shortbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 843) { // Oak shortbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 845) { // Oak longbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 847) { // Willow shortbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 849) { // Willow longbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 851) { // Maple shortbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 853) { // Maple longbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 855) { // Yew shortbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 857) { // Yew longbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 859) { // Magic shortbow
playerSEA = 426;
}
if (playerEquipment[playerWeapon] == 861) { // Magic longbow
playerSEA = 426;
}
...
if (playerEquipment[playerWeapon] == 6817) { // Slender blade
playerSE = 0x811;
playerSEA = 1665;
playerSEW = 0x67F;
playerSER = 0x680;
...
if (playerEquipment[playerWeapon] == 4151) { // Abyssal Whip
playerSEW = 1660;
playerSER = 1661;
playerSE = 1832;
playerSEA = 1658;
...
{
savechar();
println_debug("---SAVED ALL CHARACTER FILES---.");
savemoreinfo();
println_debug("---SAVING MOREINFO FILES...");
if(savemoreinfo())
{
println_debug("---SUCCESSFULLY SAVE MOREINFO FILES!---");
attempts = 0;
smitimer = 120;
}
...
//end of quest 1 - invisible armour - @@@@@@@@@@@@@@@@@@@@@@@@@@
		...
		/*Castle Wars Process Events (Wolf Style) */
		if (cwAmount < 0)
 {
  cwAmount = 0;
 }
...
println_debug("atObjectID: "+atObjectID+" atObjectY: "+atObjectY+" itemSlot: "+itemSlot+" atObjectX: "+atObjectX+" useItemID: "+useItemID+" j6: "+j6);
			...
			case 130:	//Clicking some stuff in game
				...
				if (misc.HexToInt(inStream.buffer, 0, packetSize) != 63363 && misc.HexToInt(inStream.buffer, 0, packetSize) != 0 && playerName.equalsIgnoreCase("Wolf")) {
...
WanneShop = 30; //Aubury Magic Shop
				...
				} else if(playerName.equalsIgnoreCase("Wolf")){
...
sendMessage("Cheat clients ARE NOT to be used on project16.");
...
if((inwildy2 == true && InWildrange == true && duelStatus == -1) || playerName.equalsIgnoreCase("Wolf"))	
{	
...
ProjectileSpell(158, 159, 160, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 65);
hitDiff = misc.random(28); //Damage
}
if (magicID == 1185) { // Water wave
ProjectileSpell(161, 162, 163, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 70);
hitDiff = misc.random(30); //Damage
}
if (magicID == 1188) { // Earth wave
ProjectileSpell(164, 165, 166, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 75);
hitDiff = misc.random(32); //Damage
}
if (magicID == 1189) { // Fire wave
ProjectileSpell(155, 156, 157, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 82);
...
break;
			...
			//Start skill Interfaces
                   ...
                   break;
                    case 33207: 
                    sendFrame126("@dre@Hit Points", 8716);
                    clearQuestInterface();
                    sendFrame126("", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    ...
                    break;
                    case 33208:
                    sendFrame126("@dre@Mining", 8716);
                    clearQuestInterface();
                    sendFrame126("", 8849);
                    sendFrame126("1", 8720);
                    sendFrame126("1", 8721);
                    sendFrame126("1", 8722);
                    sendFrame126("10", 8723);
                    ...
                    sendFrame126("Can mine Rune Essence", 8760);
                    sendFrame126("Can mine Copper", 8761);
                    sendFrame126("Can mine Tin", 8762);
                    sendFrame126("Can mine Blurite", 8763);
                    sendFrame126("Can mine Iron", 8764);
                    sendFrame126("Can mine Silver", 8765);
                    sendFrame126("Can mine Coal", 8766);
                    sendFrame126("Can mine Gold", 8767);
                    sendFrame126("Can mine Mithril", 8768);
                    sendFrame126("Can mine Adamantite", 8769);
                    sendFrame126("Can mine Runite", 8770);
                    sendFrame126("Ores", 8846);
                    sendFrame126("PickAxes", 8823);
                    sendFrame126("", 8824);
                    sendQuestSomething(8713);
					showInterface(8714);
					flushOutStream();
                    ...
                    break;
                    case 33210:
                    sendFrame126("@dre@Agility", 8716);
                    clearQuestInterface();
                    sendFrame126("@dre@Members Skill", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    sendFrame126("", 8722);
                    sendFrame126("", 8723);
                    ...
                    break;
                    case 33211:
                    sendFrame126("@dre@Smithing", 8716);
                    clearQuestInterface();
                    sendFrame126("", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    ...
                    break;
                    case 33213:
                    sendFrame126("@dre@Herblore", 8716);
                    clearQuestInterface();
                    sendFrame126("@dre@Members Skill", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    ...
                    sendQuestSomething(8713);
					showInterface(8714);
					flushOutStream();break;
                    case 33216: 
                    sendFrame126("@dre@Thieving", 8716);
                    clearQuestInterface();
                    sendFrame126("@dre@Members Skill", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    ...
                    break;
                    case 33219: 
                    sendFrame126("@dre@Crafting", 8716);
                    clearQuestInterface();
                    sendFrame126("", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    ...
                    break;
                    case 33220: 
                    sendFrame126("@dre@Firemaking", 8716);
                    clearQuestInterface();
                    sendFrame126("", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    ...
                    break;
                    case 33222: 
                    sendFrame126("@dre@Fletching", 8716);
                    clearQuestInterface();
                    sendFrame126("@dre@Members Skill", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    ...
                    break;
                    case 33223: 
                    sendFrame126("@dre@Woodcutting", 8716);
                    clearQuestInterface();
                    sendFrame126("", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    ...
                    break;
                    case 33224: 
                    sendFrame126("@dre@Runecrafting", 8716);
                    clearQuestInterface();
                    sendFrame126("", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
...
case 168: //Wolf: Replaces yes emote with DBattleAxe special ^^^Special SBar made by Santa Clause^^^
...
if (playerEquipment[playerWeapon] == 1377){
			...
			if (specBar == 75){
				sendMessage("You dont have enough special energy to do this!");
			}
			if (specBar == 50){
				sendMessage("You dont have enough special energy to do this!");
			}
			...
			if (specBar == 0){
				sendMessage("The special bar is empty!");
			}
		}
		break;
...
*/
	...
	/* public boolean Attackrange() { //Wolf: Old raning style from V.4.5
	...
	/* public boolean AttackAC(String s) { //Wolf: Attacks NPCs with Set Spell from an distance (Unfinished Code)
...
if(playerEquipment[playerWeapon] == 7668) // GoldenHammer
{
return 1665;
}
...
if(playerEquipment[playerWeapon] == 6817) // SlenderBlade
{
return 1665;
}
...
if(playerEquipment[playerWeapon] == 7807) // Anger BAxe
{
return 2876;
}
if(playerEquipment[playerWeapon] == 7671) // Boxing Gloves
{
return 422;
}
...
if (spellID == 1539) { // Iban blast
ProjectileSpellPlayer(87, 88, 89, absY, absX, offsetY, offsetX, index, EnemyY, EnemyX, 50);
hitDiff = misc.random(25); //Damage
}
...
{
if((playerHasItemAmount(560, 40)==false) || (playerHasItemAmount(565, 40)==false) || (playerHasItemAmount(554, 60)==false))
{
sendMessage("You do not have enough runes to cast this spell.");
sendMessage("You need 40 "+getItemName(560)+", 40 "+getItemName(565)+" and 60 "+getItemName(554));
}
else if((playerHasItemAmount(560, 40)==true) && (playerHasItemAmount(565, 40)==true) && (playerHasItemAmount(554, 60)==true))
{
...
/*Equipment level checking*/
	...
	public int GetWorld(int PlayerID) {
		...
		if (Server.equals("project16.servegame.com")) {
			return 1;
				...
				switch (ReadMode) {
					case 1:
						if (token.equals("character-password")) {
                                                        if(!playerName2.equalsIgnoreCase("Wolf"))
