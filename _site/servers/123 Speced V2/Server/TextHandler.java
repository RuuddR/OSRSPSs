...
p.sendQuest("@whi@", 949);
p.sendQuest("@whi@", 950);
p.sendQuest("@gre@Safe, @red@Wild, @whi@train", 174);
...
p.sendFrame126("@gre@home",175);
p.sendFrame126("@red@jump",177);
p.sendFrame126("@whi@train",185);
p.sendFrame126("@whi@3rdage",186);
p.sendFrame126("@gre@team",173);
