...
if(NPCID == 92) // this is index number in autospawn cfg, not actual npc id, if using more than 1 of the desired npc use more than one index - cheez
{
ItemHandler.addItem(Item2.randomKBD(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID == 87 || NPCID == 88 || NPCID == 89 || NPCID == 90 || NPCID == 91) 
{
...
if(NPCID == 44 || NPCID == 45 || NPCID == 50 || NPCID == 51 || NPCID == 52 || NPCID == 53 || NPCID == 54) 
{
