...
//						Class30_Sub2_Sub1_Sub4_1271.method382(0xffffff, 55, anInt939, class30_sub2_sub1_sub4.method383(anInt1116, s + ": "), 28, true);
    ...
    public final void method135(boolean flag, boolean flag1) {
        ...
        if(anInt833 == 0) {
            ...
            i = c1 / 2 - 20;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, "@yel@Welcome to RuneScape", i, true);
            i += 30;
            int l = c / 2 - 80;
            int k1 = c1 / 2 + 20;
        ...
        if(anInt833 == 2) {
            ...
            aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffFF, "@whi@Username: " + aString1173 + ((anInt1216 == 0) & (anInt1161 % 40 < 20) ? "@xxx@|" : ""), j);
            j += 15;
        ...
        if(anInt833 == 3) {
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "@yel@New User", c1 / 2 - 60, true); //Text
            int k = c1 / 2 - 35;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Welcome to the Blank Client.", k, true);
            k += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "The client was modified by Dillan,", k, true);
            k += 15;
			   aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Goodluck", k, true);
            k += 15;
...
//                method58(25106);
    ...
    public final void method140(boolean flag)
    {
        ...
        if(anInt833 == 0)
        {
            ...
            if(super.anInt26 == 1 && super.anInt27 >= i - 75 && super.anInt27 <= i + 75 && super.anInt28 >= l - 20 && super.anInt28 <= l + 20)
            {
                aString1266 = "Enter your username and password.";
                aString1267 = "";
                anInt833 = 2;
                anInt1216 = 0;
                return;
