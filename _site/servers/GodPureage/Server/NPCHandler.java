                ...
                if (npcs[i].IsDead == false) {
                    ...
                    if (npcs[i].npcType == 409) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Welcome to God PureScape!";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 2253) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Castle Wars Portal!!";
                        }
                    }
                    if (npcs[i].npcType == 541) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "PURE ARMOUR FTW";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 0) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "WELCOME to God Pure'S server, have a fun time!";
                        }
                    }
...
npcs[i].textUpdate = "Players Online: " + players;
                    ...
                    if (npcs[i].npcType == 550) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Welcome to God Pure-scape :)";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 1759) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "NO PKING HERE OR UR IP BANNED! ONLY TRAINING!!";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 920) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Barrows Portal!";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 2169) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "trimmed stuff";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 554) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "SKILLER STUFF";
                        }
                    }
                    if (npcs[i].npcType == 530) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Skillers Shop! PRAYER BONES,FLETCH,R ESS,COOK,AND WC!";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 520) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Colored Robes";
                        }
                    }
			...
			if (npcs[i].npcType == 1552) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "ME SANTA!";
                        }
                    }
                        if (npcs[i].npcType == 3224) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "TEAMING ALOWED, NO looting. EWW, i hate my hat!";
                        }
	           }
                        if (npcs[i].npcType == 3439) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "W3LC0M3 T0 God Pure-Scape. do ::commands for commands";
                        }
                    }
			if (npcs[i].npcType == 3433) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "NO TEAMING HERE, BUT LOOTIN ALOWED!";
                        }
                    }
			if (npcs[i].npcType == 3436) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "NO TEAMING HERE, BUT LOOTIN ALOWED!";
			...
			if (npcs[i].npcType == 3455) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "TEAMING HERE! SMELL MY FEET NOOBS! LOL";
                        }
                   }
			if (npcs[i].npcType == 3422) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "NO TEAMING! MOO IMA COW! DONT ATTACK ME IF U DO UR IP BANNED!";
                        }
                   }
			if (npcs[i].npcType == 1432) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "NO TEAMING HERE! BLAH BLAH BLAH BLAH BLAH BLAH, BLAH BLAH BLAH";
                        }
                    }
			if (npcs[i].npcType == 345) {
                        if (misc.random2(10) == 3) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "NO TEAMING HERE, AND NO MEMBER ITEMS TO PK ONLY F2P STUFF!";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 1659) {
                        ...
                        if (misc.random2(10) <= 3) // this is the time delay
                        {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            if (PlayerHandler.isPlayerOn("God Pure")) {
                                npcs[i].textUpdate = "God Pure is ONLINE";
                            } else {
                                npcs[i].textUpdate = "God Pure is OFFLINE";
                            }
                        }
                    }
                    ...
                    if (server.itemHandler.DroppedItemsID[i] > 0) {} else {
                        ...
                        if (npcs[NPCID] != null
                            ...
                            if (npcs[NPCID].npcType == 795) {
                                ...
                                ppl.teleportToX = 2551; // Change coordinates
                                ppl.teleportToY = 3043; // Change coordinates
                            ...
                            if (npcs[NPCID].npcType == 2881) {
                                ItemHandler.addItem(Item2.randomDagannoth_Supreme(),
                                        npcs[NPCID].absX, npcs[NPCID].absY, 1,
                                        GetNpcKiller(NPCID), false);
                            }
