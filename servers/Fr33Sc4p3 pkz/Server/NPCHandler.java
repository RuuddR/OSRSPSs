		...
		for (int i = 0; i < maxNPCs; i++) {
			if (npcs[i] != null) {
				...
				if (npcs[i].IsDead == false) {
					if (npcs[i].npcType == 1268 || npcs[i].npcType == 1266) {
						...
						AttackNPC(i);
							...
							npcs[i].textUpdate = "I had ya ma last night bitch";
                                                ...
                                                if(misc.random(50) == 636) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Haha I own you neeb";
                                                }
                                                if(misc.random(50) == 2617) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Sell and buy ur fire capes here!";
                                                }
                                                if(misc.random(50) == 2619) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "BANK HERE!!";
                                                }
                                                if(misc.random(50) == 636) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "We love fr33sc4p3 (NO RANGED)!";
                                                }*/
					} /*else if (i == 94) {
                                                npcs[i].attacknpc = 95;
                                                npcs[i].IsUnderAttackNpc = true;
					...
					if (npcs[i].npcType == 189 || npcs[i].npcType == 397 || npcs[i].npcType == 1766 || npcs[i].npcType == 1767 || npcs[i].npcType == 1768) {
						if (misc.random2(50) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Welcome to Entrana! Update on Training area!";
						}
					}
										if (npcs[i].npcType == 3104) {
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "To ban type ::banuser *name*";
						}
						}
						if (npcs[i].npcType == 9) {
						if (misc.random2(10) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "We are the Guards of fr33sc4p3";
						}
						}
					...
					if (npcs[i].npcType == 2617) { // dude to tele you from tzhaar - TEMP
						if (misc.random2(10) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Sell and buy ur fire capes here!";
					...
					if (npcs[i].npcType == 636) { // Dark_Mage
					...
					if (npcs[i].npcType == 608) { // White Knight - White Owner
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Get your white armour here!";
						}
					 
                                        }
                                        if (npcs[i].npcType == 3095) { // White Knight - White Owner
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Press ::Boxrules AND READ THEM!";
						}
					 
                                        }
                                        if (npcs[i].npcType == 3212) { // White Knight - White Owner
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Change your port to 43594 for fr33sc4p3 non-pk";
						}
					 
                                        }
                                        if (npcs[i].npcType == 3102) { // White Knight - White Owner
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "And people cant atack you while there glowing!";
						}
					 
                                        }
                                        if (npcs[i].npcType == 3117) { // White Knight - White Owner
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Press ::pkarm , ::anti and ::food1 to start pking!";
						}
					 
                                        }
                                        if (npcs[i].npcType == 3097) { // White Knight - White Owner
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Dont atack people who are glowin!";
						}
					 
                                        }
					if (npcs[i].npcType == 3118) { // White Knight - White Owner
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Welcome to mod city!";
						}
					}
					if (npcs[i].npcType == 534) { 
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I Have t trail stuff!!";
						}
					}
					...
					if (npcs[i].npcType == 944) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Weponz , armour and shit here";
						}
					}
					if (npcs[i].npcType == 3449) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Press ::rules and ::punishment";
						}
					}
					if (npcs[i].npcType == 747) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "No teaming here!! ";
						}
					}
                                        
					if (npcs[i].npcType == 970) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Try searching the crates!!";
						}
					}
					...
					if (npcs[i].npcType == 553) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "No 0 item pking here or anywere!";
						}
					}
                                        
					if (npcs[i].npcType == 2874) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Pk at ::pkbox and mage bank!!";
						}
					}
						...
						if (misc.random2(15) == 1) {
							...
							npcs[i].textUpdate = "pure shop";
                                        ...
                                        if (npcs[i].npcType == 3105) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "To kick type ::kick *name*";
						}
					}
					if (npcs[i].npcType == 659) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Random Crap here!";
						}
					}
					

					if (npcs[i].npcType == 3103) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Type ::modshop to go shop!!";
						}
					}
                                        if (npcs[i].npcType == 2713) {
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Go to ::duelarena2 to team-pk";
						}
					}
					if (npcs[i].npcType == 2842) {
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Argh! Entrana, Good place to train, heard..";
						}
					}
						...
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "All my species live at the Monkey Training arena!";
						}
					}
										if (npcs[i].npcType == 2753) {
						if (misc.random2(50) >= 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Take saradomin down for me please..";
						}
					}
						if (npcs[i].npcType == 1781) {
						if (misc.random2(50) >= 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Get your capes! Trade me..";
						}
					}
											else if (npcs[i].npcType == 1552)
					{
						if (misc.random2(50) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Get Your rare shit here";
							}
						}
						else if (npcs[i].npcType == 2253)
					{
						if (misc.random2(10) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							if (PlayerHandler.isPlayerOn("Thug Life"))
							{
								npcs[i].textUpdate = "Thug life is online!";
							}
							else
							{
								npcs[i].textUpdate = "Thug life is offline!";
							}
												}
			}
