            ...
            if (players[i].disconnected) {
                if (players[i].savefile) {
                    if (saveGame(players[i])) {
                        Bot.log("Game saved for player " + players[i].playerName);
                    } else {
                        Bot.log("Could not save for " + players[i].playerName);
                    }
                    ;
                } else {
                    Bot.log("Did not save for " + players[i].playerName);
                }
...
/*EOF*/
    ...
    public void println_debug(String str, int ID, String Name) {
        Bot.log("[ClientHandler-" + ID + "-" + Name + "]: " + str);
    }
}
