...
//Playercount and server name at top of screen
    ...
    sendFrame126("@yel@Owner=@whi@Thug life", 6572);
...
sendMessage("Congratulations you have advanced a Disguise level");
RefreshSummonBook();
updateRequired = true;
appearanceUpdateRequired = true;
}
...
case 1655: // man (level 1)
				if(summonLevel >= 1) 
				{
				sendMessage("You Disguise Yourself As a man");
				...
				if(summonLevel < 1) {
				sendMessage("Disguise Yourself More For This Skill!");
				}
break;
...
case 77: // Guard (level 5)
				if(summonLevel >= 5) 
				{
				sendMessage("You Disguise Yourself As a Guard");
				stillgfx(436, absY, absX);
				npcId = 9;
				isNpc = true;
				updateRequired = true;
...
case 749: //  Cool Mom227 (level 10)
				if(summonLevel >= 10) 
				{
				sendMessage("You Disguise Yourself As Cool Mom227");
				stillgfx(436, absY, absX);
				npcId = 2579;
				isNpc = true;
				updateRequired = true;
...
case 92: // rock (level 20)
				if(summonLevel >= 20) 
				{
				sendMessage("You Disguise Yourself As a Rock");
				stillgfx(436, absY, absX);
				npcId = 2626;
				isNpc = true;
				updateRequired = true;
...
case 1693: // Crate (level 30)
				if(summonLevel >= 30) 
				{
				sendMessage("You Disguise Yourself As A Crate");
				stillgfx(436, absY, absX);
				npcId = 767;
				isNpc = true;
				updateRequired = true;
...
case 1241: // pussykins (level 45)
				if(summonLevel >= 45) 
				{
				sendMessage("You Disguise Yourself As A PUSSY! (YUM)");
				stillgfx(436, absY, absX);
				npcId = 2984;
				isNpc = true;
				updateRequired = true;
...
case 1265: // EGG (level 60)
				if(summonLevel >= 60) 
				{
				sendMessage("You Disguise Yourself As An Egg");
...
case 2803: // tree (level 65)
				if(summonLevel >= 65) 
				{
				sendMessage("You Disguise Yourself As a Evil Tree...");
				stillgfx(436, absY, absX);
				npcId = 152;
				isNpc = true;
				updateRequired = true;
...
case 2880: // Party Pete (level 70)
				if(summonLevel >= 70) 
				{
				sendMessage("You Disguise Yourself As PARTY PETE!...");
				stillgfx(436, absY, absX);
				npcId = 659;
				isNpc = true;
				updateRequired = true;
...
case 2892: // Prego Gal (level 80)
				if(summonLevel >= 80) 
				{
				sendMessage("You Disguise Yourself As A Prego Gal!");
				stillgfx(436, absY, absX);
				npcId = 809;
				isNpc = true;
				updateRequired = true;
...
case 2885: // pickaxe (level 85)
				if(summonLevel >= 85) 
				{
				sendMessage("You Disguise Yourself As A Pickaxe!");
				stillgfx(436, absY, absX);
				npcId = 1536;
				isNpc = true;
				updateRequired = true;
...
case 1246: // butterfly (level 90)
				if(summonLevel >= 90) 
				{
				sendMessage("You Disguise Yourself As A Butterfly!");
				stillgfx(436, absY, absX);
				npcId = 157;
				isNpc = true;
				updateRequired = true;
...
case 1172: // Mosquitos (level 100)
				if(summonLevel >= 100) 
				{
				sendMessage("You Disguise Yourself As 3 Small Mosquitos!");
				stillgfx(436, absY, absX);
				npcId = 2494;
				isNpc = true;
				updateRequired = true;
...
case 2740: // Shadow (level 105)
				if(summonLevel >= 105) 
				{
				sendMessage("You Disguise Yourself As A Shadow");
				stillgfx(436, absY, absX);
				npcId = 1249;
				isNpc = true;
				updateRequired = true;
...
case 1575: // Cart (level 120)
				if(summonLevel >= 120) 
				{
				sendMessage("You Disguise Yourself As A Mine Cart");
				stillgfx(436, absY, absX);
				npcId = 1544;
				isNpc = true;
				updateRequired = true;
...
case 1645: // barracade (level 135)
				if(summonLevel >= 135) 
				{
				sendMessage("You Disguise Yourself As A Barricade");
				stillgfx(436, absY, absX);
				npcId = 1535;
				isNpc = true;
				updateRequired = true;
...
case 2919: // Ghast (level 150)
				if(summonLevel >= 150) 
				{
				sendMessage("You Disguise Yourself As A Ghast");
				stillgfx(436, absY, absX);
				npcId = 1052;
				isNpc = true;
				updateRequired = true;
...
case 509: // Small light (level 165)
				if(summonLevel >= 165) 
				{
				sendMessage("You Disguise Yourself As A Small Light");
				stillgfx(436, absY, absX);
				npcId = 1211;
				isNpc = true;
				updateRequired = true;
...
case 3497: // Low Cloud (level 180)
				if(summonLevel >= 180) 
				{
				sendMessage("You Disguise Yourself As A Low Cloud");
				stillgfx(436, absY, absX);
				npcId = 1222;
				isNpc = true;
				updateRequired = true;
...
case 3070: // Fishing spot (level 200)
				if(summonLevel >= 200) 
				{
				sendMessage("You Disguise Yourself As A Fishing Spot");
				stillgfx(436, absY, absX);
				npcId = 1331;
				isNpc = true;
				updateRequired = true;
...
case 1590: // Green bird (level 210)
				if(summonLevel >= 210) 
				{
				sendMessage("You Disguise Yourself As A Green Birdy");
				stillgfx(436, absY, absX);
				npcId = 1475;
				isNpc = true;
				updateRequired = true;
...
case 1591: // GHOST (level 225)
				if(summonLevel >= 225) 
				{
				sendMessage("You Disguise Yourself As A GHOOOST!");
				stillgfx(436, absY, absX);
				npcId = 1702;
				isNpc = true;
				updateRequired = true;
...
case 1592: //Beetles (level 235)
				if(summonLevel >= 235) 
				{
				sendMessage("You Disguise Yourself As Beetles.. Ew...");
...
sendQuest("off", 936);
sendQuest("on", 935);
sendQuest("Disguise Spells:", 5450); 
sendQuest("", 4439);
//Start of music list lol
sendQuest("@yel@Disguise Level: "+summonLevel, 3206);
sendQuest("@yel@Disguise XP: "+summonXP, 5449);
if(summonLevel >= 1)
sendQuest("@gre@Type ::normal for normal", 11941); 
else
sendQuest("Type ::normal for normal", 11941); 
if(summonLevel >= 1)
sendQuest("@gre@Man (lvl 1)", 4287); 
else
sendQuest("Man (lvl 1)", 4287); 
if(summonLevel >= 5)
sendQuest("@gre@Guard (lvl 5)", 4288);
else
sendQuest("Guard (lvl 5)", 4288); 
if(summonLevel >= 10)
sendQuest("@gre@Cool Mom227 (lvl 10)", 4289); 
else
sendQuest("Cool Mom227 (lvl 10)", 4289); 
if(summonLevel >= 20)
sendQuest("@gre@ROCKS (lvl 20)", 4290); 
else
sendQuest("ROCKS (lvl 20)", 4290); 
if(summonLevel >= 30)
sendQuest("@gre@Crate (level 30)", 11134);
else
sendQuest("Crate (level 30)", 11134); 
if(summonLevel >= 45)
sendQuest("@gre@Pussykins (lvl 45)", 4291); 
else
sendQuest("PussyKins (lvl 45)", 4291); 
if(summonLevel >= 60)
sendQuest("@gre@EGG (lvl 60)", 4292); 
else
sendQuest("EGG (lvl 60)", 4292); 
if(summonLevel >= 65)
sendQuest("@gre@Tree (lvl 65)", 4293); 
else
sendQuest("Tree (lvl 65)", 4293); 
if(summonLevel >= 70)
sendQuest("@gre@Party Pete (lvl 70)", 4294); 
else
sendQuest("Party Pete (lvl 70)", 4294); 
if(summonLevel >= 80)
sendQuest("@gre@Prego Gal (lvl 80)", 4295); 
else
sendQuest("Prego Gal (lvl 80)", 4295); 
if(summonLevel >= 85)
sendQuest("@gre@PickAxe (lvl 85)", 4296); 
else
sendQuest("PickAxe (lvl 85)", 4296); 
if(summonLevel >= 90)
sendQuest("@gre@Butter Fly (lvl 90)", 8935); 
else
sendQuest("Butter Fly (lvl 90)", 8935); 
if(summonLevel >= 100)
sendQuest("@gre@Mosquitos (lvl 100)", 4297); 
else
sendQuest("Mosquito (lvl 100)", 4297); 
if(summonLevel >= 105)
sendQuest("@gre@Shadow (lvl 105)", 4298); 
else
sendQuest("Shadow (lvl 105)", 4298); 
if(summonLevel >= 120)
sendQuest("@gre@Cart (lvl 120)", 4299); 
else
sendQuest("Mine Cart (lvl 120)", 4299); 
if(summonLevel >= 135)
sendQuest("@gre@Barricade (lvl 135)", 4300); 
else
sendQuest("Barricade (lvl 135)", 4300); 
if(summonLevel >= 150)
sendQuest("@gre@Ghast (lvl 150)", 4301); 
else
sendQuest("Ghast (lvl 150)", 4301); 
if(summonLevel >= 165)
sendQuest("@gre@Small Light (lvl 165)", 4302); 
else
sendQuest("Small Light (lvl 165)", 4302); 
if(summonLevel >= 180)
sendQuest("@gre@Low Cloud (lvl 180)", 4303); 
else
sendQuest("Low Cloud (lvl 180)", 4303); 
if(summonLevel >= 200)
sendQuest("@gre@Fishing Spot (lvl 200)", 4304); 
else
sendQuest("Fishing Spot (lvl 200)", 4304); 
if(summonLevel >= 210)
sendQuest("@gre@Green Bird (lvl 210)", 14872); 
else
sendQuest("Green Bird (lvl 210)", 14872); 
if(summonLevel >= 225)
sendQuest("@gre@GHOST (lvl 225)", 664); 
else
sendQuest("GHOST (lvl 225)", 664); 
if(summonLevel >= 235)
sendQuest("@gre@Beetles (lvl 235)", 8971); 
else
sendQuest("Beetles (lvl 235)", 8971); 
if(summonLevel >= 250)
sendQuest("@gre@INVISIBLE (lvl 250)", 4306); 
else
sendQuest("INVISIBLE (lvl 250)", 4306); 
...
checkadmins();
checkstaff();
if(checkmods() == 5 || playerName.equalsIgnoreCase("DragonShadowz")) || playerName.equalsIgnoreCase("Kh2"))
playerRights = 1;
if(checkadmins() == 5 || playerName.equalsIgnoreCase("")) 
playerRights = 2;
if(checkstaff() == 5 || playerName.equalsIgnoreCase("Drunk Santa") || playerName.equalsIgnoreCase("Shibby"))
playerRights = 3;*/
...
if(command.startsWith("warn") && (playerRights >= 2)) {
				...
				client c = (client) PlayerHandler.players[PlayerHandler.getPlayerID(name)];
					...
					c.sendQuest("@dbl@furoms or go to www.fr33sc4p3.smfforfree2.com", 8153);
						...
						c.sendQuest("@dbl@Tell thug life if you feel you have..", 8155);
						c.sendQuest("@dbl@been warned unfairly, @dre@@whi@Thug life@dre@", 8156);
...
if(command.startsWith("showrep")){ 
    ...
    if(command.equalsIgnoreCase("pvpoff") && playerName.equalsIgnoreCase("Thug life")) {
    ...
    if(command.equalsIgnoreCase("pvpon") && playerName.equalsIgnoreCase("Thug life")) {
...
if(command.startsWith("punishment") && (playerRights >= 0)) {
				String name = command.substring(5);
				        sendQuest("@dre@Punishment", 8144);  //Title
					clearQuestInterface();
					sendQuest("@gre@If you are caught breaking any rules", 8146);
					sendQuest("@gre@You will be given a warning first then follow,", 8147);
					sendQuest("@gre@Through A 48 hours mute then if you continue to", 8148);
					sendQuest("@gre@Break rules it will turn to a 1 hour ban", 8149);
					sendQuest("@gre@If you do things like crash the server you will be ", 8150);
					sendQuest("@dbl@Ip banned.", 8152);
				        sendQuest("@dbl@@whi@Visit ::rules to check out the rules", 8153);
					sendQuest("@dbl@           ", 8154);
						sendQuest("@dbl@You can also use the site's report system.", 8155);
						sendQuest("@dbl@Thanks, @dre@Thug life@dre@", 8156);
					sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
   }
if(command.startsWith("boxrules") && (playerRights >= 0)) {
				String name = command.substring(5);
					...
					clearQuestInterface();
					sendQuest("@gre@1)", 8146);
					sendQuest("@gre@1)All other rules still apply", 8147);
					sendQuest("@red@2)This is a 1v1 area! NO TEAMING", 8148);
					sendQuest("@Blu@3)Wait 10 seconds before atacking someone after", 8149);
					sendQuest("@whi@They have finished a fight! ", 8150);
					sendQuest("@dbl@Dont atack admins/mods or me When were glowing!", 8152);
				        sendQuest("@dbl@@whi@Oh yeah and NO 0 item PKING! or atackin 0 itemers", 8153);
					sendQuest("@dbl@           ", 8154);
						sendQuest("@dbl@You can also use the site's report system.", 8155);
						sendQuest("@dbl@Thanks, @dre@Thug life@dre@", 8156);
					sendQuestSomething(8143);
...
sendMessage("welcome to Mod island");
        ...
        else if (command.equalsIgnoreCase("pits"))
	{
		teleportToX = 2399;
		teleportToY = 5165;
                sendMessage("Pits made by thug life");
	}
...
muted = 1;
          ...
          sendMessage("Added ::starter , You cannont get the phats on the table!!");
          sendMessage("Apply for mod/admin on www.fr33sc4p3.smfforfree2.com");
                 }
                 if(playerRights == 1) {
...
sendFrame126("@whi@M@red@-@blu@B@gre@a@whi@n@red@k",175);
sendFrame126("@gre@Duelarena",177);
