...
public static void ancientSpell(int castId, int casterY, int casterX, int offsetY, int offsetX, int angle, int speed, int movegfxID,int startHeight, int endHeight, int MageAttackIndex, int finishID, int enemyY, int enemyX) {
	for (int i = 0; i <= 5000; i++) { 
		if(GFXspot[i] == 0) { 
