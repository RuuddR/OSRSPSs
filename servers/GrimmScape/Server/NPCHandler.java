...
public class NPCHandler {
				...
				if (npcs[i].IsDead == false) {
					if (npcs[i].npcType == 1268 || npcs[i].npcType == 1266) {
						...
						npcs[i].updateRequired = true;
                                                ...
                                                if(npcs[i].npcType == 1645 || npcs[i].npcType == 509 || npcs[i].npcType == 1241 || npcs[i].npcType == 1246)
                                                AttackPlayerMage(i);
                                                else
						AttackPlayer(i);
	...
	if (npcs[i].npcType == 757) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I Gotta Stay Fly-y-y-y-y-y-y-y-y-y-y-y-y-y-y-y-y-y-y.";
						}
					}
					if (npcs[i].npcType == 79) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Till I Die-i-i-i-i-i-i-i-i-i-i-i-i.";
						}
					}
					if (npcs[i].npcType == 1223) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "DJ Paul Is A Dog One You Do Not Trust";
						}
					}
					if (npcs[i].npcType == 1220) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Leave Yo Green Round Me Nigga Yo Green Gunna Get Lit Up";
						}
					}
					if (npcs[i].npcType == 1225) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Leave Yo Gurl Around Me And Shes Bad She Gunna Get Stuck.";
						}
					}
					if (npcs[i].npcType == 230) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "TALK TO ME to buy your souvenoir!";
						}
					}
					if (npcs[i].npcType == 1274) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "YOU ****!";
						}
					}
					if (npcs[i].npcType == 1275) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Narvey the blood right from dem ol' cheez puffs!";
						}
					}
					if (npcs[i].npcType == 1276) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I love this band! Woohoo!";
						}
					}
					if (npcs[i].npcType == 1277) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "ZzZzZzZzZzZzZzZzZzZzZzZzZzZzZzZzZzZzZzZzZzZzZ";
						}
					}
if (npcs[i].npcType == 213) {
						if (misc.random2(25) <= 3) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "TYPE ::WOODWORKHELP FOR HELP";
						}
					}
					if (npcs[i].npcType == 261) {
						if (misc.random2(25) <= 3) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "TYPE ::HERBLOREHELP FOR HELP";
						}
					}
					if (npcs[i].npcType == 273) {
						if (misc.random2(25) <= 3) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "TYPE ::CONSTRUCTHELP FOR HELP";
						}
					}
					if (npcs[i].npcType == 1277) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Wheres me show?!?!";
						}
					}
					if (npcs[i].npcType == 1276) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Come On I Don't Have ALL DAY!";
						}
					}
					if (npcs[i].npcType == 1315) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I Sell Food!!! Gee Who Would Have Though!";
						}
					}
					if (npcs[i].npcType == 1282) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Rofl You WISH You Could Afford This Stuff";
						}
					}
					if (npcs[i].npcType == 1316) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I don't sell anything right now...";
						}
					}
					if (npcs[i].npcType == 1317) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "What's the point of us, no one is gunna attack...";
						}
					}
					if (npcs[i].npcType == 1283) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Enter the trap door if you dare. BWACK BWACK!!!.. I mean HaHa...";
						}
					}
					if (npcs[i].npcType == 1311) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "IM too sexxy for my shirt, too sexxy it hurts";
						}
					}
					if (npcs[i].npcType == 1281) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Shot your ass HMMKAY?";
						}
					}
					if (npcs[i].npcType == 1309) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "What is my purpose on this planet...";
						}
					}
					if (npcs[i].npcType == 1275) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Where is Michael Jackson, IT was supposed to strip for us!";
						}
					}
					if (npcs[i].npcType == 1274) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "This is sooo 1337 DUDE, Front Row Seats for MJ!";
						}
					}
					if (npcs[i].npcType == 1285) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "OOOOHHH Who lives in a pineapple under the SEA!";
						}
					}
					if (npcs[i].npcType == 1284) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Mrs. Bartender Sir, can I have just ONE more..";
						}
					}
					if (npcs[i].npcType == 1286) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "But Mom I don't want to go to churchhhh";
						}
					}
					if (npcs[i].npcType == 1294) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "This New Armor is KICK ASS";
						}
					}
					if (npcs[i].npcType == 1300) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "FUCK FUCK SHIT, WE OUTSTA BEER!!! ARGHHH";
						}
					}
					if (npcs[i].npcType == 2439) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Why Am I SO SHORT!";
						}
					}
					if (npcs[i].npcType == 1298) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Zzz Zzz Zzz Zzz Zzz Zzz Zzz Zzz...";
						}
					}
					if (npcs[i].npcType == 1299) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Zzz Zzz Zzz Zzz Zzz Zzz Zzz Zzz...";
					...
					if (npcs[i].npcType == 1308) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Im having chicken tonight!! Again...";
						}
					}
					if (npcs[i].npcType == 1306) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Laaalalalalalalalalalalala";
						}
					}
					if (npcs[i].npcType == 1314) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Dodododododododododododo";
						}
					}
					if (npcs[i].npcType == 1269) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Muhaahahhaahaha fear me God!";
						}
					}
					if (npcs[i].npcType == 1401) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Eat the nigger chicken, Dark meat is BETTER!";
						}
					}
					if (npcs[i].npcType == 1402) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Whats crackling home dizzle? Fuck Foo its my Egg Yo!";
						}
					}
					if (npcs[i].npcType == 1278) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Not without coups. Not without coups baby.--Dane Cook";
						}
					}
					if (npcs[i].npcType == 1268) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "You wouldn't want to attack ME...";
						}
					}
					if (npcs[i].npcType == 1267) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "HAHAHAHA I FOOLED YOU";
						}
					}
if (npcs[i].npcType == 1001) {
if (misc.random2(25) <= 3) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
if (PlayerHandler.isPlayerOn("grimm")){
npcs[i].textUpdate = "Awww Grimm is Offline...";
}
else{
npcs[i].textUpdate = "Yay! Grimm is Online";
}
}
}
    	if (npcs[i].npcType == 944) {//combat_instructor is default.
      if (misc.random2(20) == 1) {
      	npcs[i].updateRequired = true;
      	npcs[i].textUpdateRequired = true;
      	npcs[i].textUpdate = "Follow The Line Of Hero's!";//yeah
      }
    	}
                                        if (npcs[i].npcType == 31) {//Priest man is default.
      if (misc.random2(20) == 1) {
      	npcs[i].updateRequired = true;
      	npcs[i].textUpdateRequired = true;
      	npcs[i].textUpdate = "Fight Your Way Through!";//yeah
      }
    	}

                                        if (npcs[i].npcType == 639) {//romeo is default.
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Hello! Welcome to Grimms Rs2 Server type ::help for info!";//Welcome to Grimms Rs2!! type ::help for info.
						}
					}
                                        if (npcs[i].npcType == 550) {//romeo is default.
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Welcome to Lowe's Bow shop!";//random
						}
					}
			...
			if (npcs[NPCID].actionTimer == 0) {
				if (RingOfLife == true && EnemyHP <= (int)((double)((double)EnemyMaxHP / 10.0) + 0.5)) {
					...
					if (server.playerHandler.players[Player].IsDead == true) {
						...
						if (npcs[NPCID].npcType == 81 || npcs[NPCID].npcType == 397 || npcs[NPCID].npcType == 1766 || npcs[NPCID].npcType == 1767 || npcs[NPCID].npcType == 1768 || npcs[NPCID].npcType == 1592) {
							npcs[NPCID].animNumber = 0x03B; //cow attack
						} 
						if (npcs[NPCID].npcType == 82 || npcs[NPCID].npcType == 83 || npcs[NPCID].npcType == 84 || npcs[NPCID].npcType == 677 || npcs[NPCID].npcType == 752) {
