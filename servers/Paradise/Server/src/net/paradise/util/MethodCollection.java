...
public class MethodCollection
{
	...
	public static String formatUsername(String username)
	{
		...
		String[] partical = username.replace("_", " ").split(" ");
		StringBuilder product = new StringBuilder();

		for (int i = 0; i < partical.length; i++)
		{
			product.append(partical[i].substring(0, 1).toUpperCase());
			product.append(partical[i].substring(1).toLowerCase());

			if (i != partical.length - 1)
			{
				product.append(" ");
			}
		}
	...
	{
		System.out.print(str); // comment this line out if you want to get rid
								// of debug messages
	}
