   ...
   public Class30_Sub2_Sub1_Sub1(byte abyte0[], Component component)
    {
        ...
        try
        {
Image image = Toolkit.getDefaultToolkit().getImage(("sprites/deathmoon.png"));
...
if (s.startsWith("backleft2") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKLEFT2 0.png");
				anInt1440 = 8;
				anInt1441 = 134;
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
		...
		else if (s.startsWith("backbase1") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKBASE1 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backbase2") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKBASE2 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backhmid1") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKHMID1 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backhmid2") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKHMID2 0.png");
				anInt1440 = 555;
				anInt1441 = 6;
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
		...
		else if (s.startsWith("backleft1") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKLEFT1 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backright1") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKRIGHT1 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backright2") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKRIGHT2 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backtop1") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKTOP1 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backvmid1") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKVMID1 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backvmid2") && i == 0)
	{
		try
		{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/BACKVMID2 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
		...
		else if (s.startsWith("backvmid3") && i == 0)
	{
		...
		try
		{
						Image image = Toolkit.getDefaultToolkit().getImage("sprites/TITLEBUTTON.png");
						anIntArray1439 = new int[anInt1440 * anInt1441];
						PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
						pixelgrabber.grabPixels();
...
else if (s.equalsIgnoreCase("titlebox"))
{
try
{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/TITLEBOX.png");			//System.getProperty("user.dir") + "\\"+i+".png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
...
//System.out.println(s+ ".png "+ " hopefully loaded");
	...
	else if (s.equalsIgnoreCase("compass"))
	{
		try
	{
				Image image = Toolkit.getDefaultToolkit().getImage("sprites/COMPASS 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
...
try
{
				Image image = Toolkit.getDefaultToolkit().getImage("./sprites/MODICONS "+i+".png");			//System.getProperty("user.dir") + "\\"+i+".png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
