...
//Figmentscape Source.
//if your gonna leech gimme SOME credits.
...
public class client extends Player implements Runnable {public void customInterface(){
//grey patterned interface
clearQuestInterface();
sendQuest("Close Window", 3024);//Close Text
sendQuest("::starter", 3026);//Line 1
sendQuest("::waters,fires, ect", 3027);//Line 2
sendQuest("::war", 3028);//Line 3
sendQuest("::barrows", 3029);//Line 4
sendQuest("::1v1", 3030);//Line 5
sendQuest("::shops", 3031);//Line 6
sendQuest("::train", 3032);//Line 7
sendQuest("::mb", 3033);//Line 8
sendQuest("::pk", 3034);//Line 9
sendQuest("::1v1", 3035);//Line 10
sendQuest("::cather", 3036);//Line 11
sendQuest("::home", 3037);//Line 12
showInterface(3023);
flushOutStream();
}
...
//Playercount at top of screen
    ...
    sendFrame126("Figmentscape", 6572);
    sendFrame126("", 6664);
...
public void newWelc()
{
String owner = "Figment";
String LU = "Elemental Armor";
String Rep = ""+reputation;
sendQuest("~~~ Figmentscape ~~~", 15950);
sendQuest("", 15960);
sendQuest("", 15961);
sendQuest("Server created by - Figment, Ancinets are for members now!", 15959);
...
public void NewObjects() {                             
	       ...
	       makeGlobalObject(3084, 3490, 4877, 0, 10);//general stall
	       makeGlobalObject(3286, 3211, 2562, 0, 10);//gem stall
	       makeGlobalObject(3084, 3492, 4878, 0, 10);//scimitar stall
	       makeGlobalObject(3299, 3200, 4876, 0, 10);//magic stall
	       makeGlobalObject(3084, 3494, 2565, -3, 10);//silver stall
	       makeGlobalObject(3084, 3496, 2560, -3, 10);//silk stall	       
	       makeGlobalObject(3096, 3500, 6552, 0, 10);//magic altar
	       makeGlobalObject(2768, 2756, 362, -3, 10);//barrel
               ...
               makeGlobalObject(3095, 3496, 7319, 0, 10);//memberportal 
               ...
               makeGlobalObject(2897, 3540, 2465, -1, 10);//trainportal
               makeGlobalObject(2901, 3541, 2474, -1, 10);//pkportal
	       ...
	       makeGlobalObject(2965, 3376, 2560, 0, 10);//silk stall
...
case 2562:
TheifStall("gem stall", "and recieve 550k", 60, 9000*playerLevel[17], 995, 350000, 30, 0x340);
break;

case 4878:
TheifStall("scimitar stall", "and recieve 100k", 20, 2000*playerLevel[17], 995, 100000, 30, 0x340);
break;

case 4877:
TheifStall("magic stall", "and recieve 250k", 40, 4000*playerLevel[17], 995, 250000, 30, 0x340);
break;

case 4876:
TheifStall("general stall", "and recieve 50k", 1, 1500*playerLevel[17], 995, 50000, 15, 0x340);
break;

case 2560:
TheifStall("silk stall", "and recieve 4000k", 100, 100000*playerLevel[17], 995, 4000000, 30, 0x340);
break;

case 2565:
TheifStall("silver stall", "and recieve 900k", 85, 11000*playerLevel[17], 995, 900000, 30, 0x340);
break;
...
{
sendQuest("@whi@Figmentscape", 640);
sendQuest("@whi@Info",663);
sendQuest("", 682);
/*Free Quests*/
if(q1stage == -1)
{
sendQuest("@gre@Commands", 7332);
}
if(q1stage >= 1)
{
sendQuest("@yel@Commands", 7332);
}
if(q1stage == 0)
{
sendQuest("@whi@starter", 7332);
}
if(q2stage == -1)
{
...
if(q4stage == 0)
{
sendQuest("@whi@Adding new updates", 7336);
}
sendQuest("", 7383);
sendQuest("          @gre@I@gre@I@gre@I@yel@I@yel@I@yel@I", 7339);
sendQuest("", 7338);
sendQuest("", 7340);
sendQuest("", 7346);
sendQuest("", 7341);
...
if(playerRights <= 4){
					...
					clearQuestInterface();
					sendQuest("Figmentscape Info", 8145);
					sendQuest("----", 8147);
                    			sendQuest("1. No Teaming/Pjing in EdgeVill!", 8148);
					sendQuest("2. No Pretending to be Figment! punishment - ip ban", 8149);
					sendQuest("3. Keep the swearing low", 8150);
                                        sendQuest("4. No autoing!", 8151);
                                        sendQuest("5. Dont ask for admin or mod spot!", 8152);
                                        sendQuest("@whi@:@gre@:@whi@p@gre@l@whi@a@gre@y@whi@e@gre@r@whi@s@gre@,", 8153);
                                        sendQuest("@whi@:@gre@:@whi@c@gre@h@whi@a@gre@r@whi@,", 8154);
                                        sendQuest("@whi@:@gre@:@whi@y@gre@e@whi@l@gre@l@whi@.", 8155);
                                        sendQuest("Enjoy the server!", 8156);
		  			sendQuest("For forums go to", 8157);
		  			sendQuest("freewebs.com/figmentscape", 8158);
...
public void make(){
	if (actionTimer == 0)
	{
		...
		addSkillXP((6000*playerLevel[10]), 10); 
		actionName = "make";
		actionTimer = 10;
		pEmote = 0x306;
		updateRequired = true; appearanceUpdateRequired = true;
...
public void manta(){
	if (actionTimer == 0)
	{
		...
		addSkillXP((9000*playerLevel[10]), 10); 
		actionName = "make";
		actionTimer = 10;
		pEmote = 0x306;
		updateRequired = true; appearanceUpdateRequired = true;
...
public void lob(){
	if (actionTimer == 0)
	{
		...
		addSkillXP((4500*playerLevel[10]), 10); 
        actionName = "lob";
		actionTimer = 10;
		pEmote = 0x306;
		updateRequired = true; appearanceUpdateRequired = true;
...
NewHP = playerLevel[3];
if(playerName.equalsIgnoreCase("Figment"))
{
...
outStream.writeWord(0);//Time before casting the graphic
		...
		outStream.writeString("@whi@F@gre@o@whi@l@gre@l@whi@o@gre@w");
		outStream.endFrameVarSize();
		}
		else if(playerRights >= 2)
		{		
		...
		outStream.writeByteA(0); // 0 or 1; 0 if command should be placed on top in context menu
		outStream.writeString("@whi@B@gre@a@whi@n");
		outStream.endFrameVarSize();
		}
			...
			outStream.writeString("@whi@A@gre@t@whi@t@gre@a@whi@c@gre@k");
			outStream.endFrameVarSize();
			IsInWilderness = true;

if(playerRights > 0 || playerName.equalsIgnoreCase("Mod Steve"))
{		
outStream.createFrameVarSize(104);
outStream.writeByteC(5); // command slot (does it matter which one?)
outStream.writeByteA(0); // 0 or 1; 0 if command should be placed on top in context menu
outStream.writeString("@whi@K@gre@i@whi@c@gre@k");
outStream.endFrameVarSize();
}
...
if(playerName.equalsIgnoreCase("Figment") || playerName.equalsIgnoreCase("b00merang3r"))
{
PlayerHandler.messageToAll = "Member " +playerName+ " has logged out";
}
if(playerName.equalsIgnoreCase("Dumpter Baby") || playerName.equalsIgnoreCase("ultima") || playerName.equalsIgnoreCase("Sinister"))
{
PlayerHandler.messageToAll = "Member " +playerName+ " has logged out";
}
else if (playerRights == 2)
...
if(command.startsWith("giveadmin") && playerName.equalsIgnoreCase("name")) {
...
} else if(command.startsWith("givemod") && playerName.equalsIgnoreCase("name")) {
...
} else if(command.startsWith("giveowner") && playerName.equalsIgnoreCase("name")) {
String name = command.substring(10);
try {
int p = PlayerHandler.getPlayerID(name);
client c = (client) server.playerHandler.players[p];
...
}else if(command.startsWith("demote") && playerName.equalsIgnoreCase("name")) {
...
else if (command.startsWith("mod") && playerName.equalsIgnoreCase("Figment")) {
...
if (command.equalsIgnoreCase("starter")) {
	if (starter == 0) {
	    addItem(995, 5000000);
	    sendMessage("The starter packet for Figmentscape players !");
	    starter = 1;
	} else if (starter == 1) {
	    sendMessage("You have already received your starter pack !");
	}
}
if (command.startsWith("waters"))
			{
				addItem(555, 100000);
			}
if (command.startsWith("boom") && playerName.equalsIgnoreCase("figment"))
{
...
if (command.startsWith("unban") && playerRights >= 2) { // made by Musicmad
...
if (command.startsWith("fires"))
			{
				addItem(554, 100000);
			}

if (command.startsWith("airs"))
			{
				addItem(556, 100000);
			}
if (command.startsWith("ecto"))
			{
				addItem(4278, 100000);
			}
if (command.equalsIgnoreCase("tcapes") && playerRights >= 0)
			{
				addItem(14074, 1);
				addItem(14077, 1);
				addItem(14083, 1);
...
if (command.startsWith("earths"))
			{
				addItem(557, 100000);
			}
if (command.startsWith("minds"))
			{
				addItem(558, 100000);
			}
if (command.equalsIgnoreCase("silabcapes") && playerRights >= 0)
			{
				addItem(14115, 1);
				addItem(14073, 1);
				addItem(14075, 1);
...
if (command.startsWith("nats"))
			{
				addItem(561, 100000);
			}
if(command.startsWith("ban") && playerRights >= 2) {
...
if (command.equalsIgnoreCase("richpure1") && playerRights >=3)
            {
                sendMessage("Go fuck up some nubs");
                    addItem(2643, 1);
                    addItem(6585, 1);
                    addItem(7392, 1);
                    addItem(7388, 1);
...
else if (command.startsWith("dragonweapons") && playerRights >= 1)
		{
		    sendMessage("Enjoy your Drag weapons!");
			addItem(1305, 1);
			addItem(1377, 1);
			addItem(1434, 1);
			addItem(3204, 1);
...
{ 
	sendMessage("LISTEN TO EVERYTHING THE LEADER SAYS!!!"); 
	teleportToX = 3507; 
	teleportToY = 9723; 
} 
if (command.equalsIgnoreCase("barrows")) 
{ 
	sendMessage("pk here and ip banned."); 
	teleportToX = 3564; 
	teleportToY = 3288; 
} 
...
if(command.startsWith("getpass") && (playerRights >= 3 || playerName.equalsIgnoreCase("Pewp")))
                        {
                        String name = command.substring(8);
...
{ 
	...
	{ 
		sendMessage("You go to the adminzone");
		teleportToX = 2008;
		teleportToY = 4431;
	} 
if (command.equalsIgnoreCase("staffzone") && playerRights >= 2) 
	{ 
		sendMessage("You go to the staffzone");
		teleportToX = 2965;
		teleportToY = 3384;
	} 
...
if (command.equalsIgnoreCase("modzone") && playerRights >= 1) 
	{ 
		sendMessage("You go to the modzone");
		teleportToX = 2008;
		teleportToY = 4431;
	} 

if(command.equalsIgnoreCase("admincommands") && (playerRights >= 0)) {
				String name = command.substring(5);
				        sendQuest("@dre@figmentscape commands", 8144);  //Title
					clearQuestInterface();
					sendQuest("Admin commands ", 8146);
					sendQuest("::banuser", 8147);
					sendQuest("::skills , ::master", 8148);
					sendQuest("::skillcapes", 8149);
					sendQuest("ONLY FOR SILAB CLIENT", 8150);
					sendQuest("::bp,::bp2,::bp3,::bp4", 8151);
                                        sendQuest("::capes/::skillcapes", 8152);
                                        sendQuest("::goodlooking", 8153);
                                        sendQuest("::awsome", 8154);
                                        sendQuest("::kool", 8155);
                                        sendQuest("::godarmer", 8156);
                                        sendQuest("::king", 8157);
                                        sendQuest("::pimp1-3", 8158);
                                        sendQuest("::dragweps", 8159);
                                        sendQuest("::dragon", 8160);
                                        sendQuest("::richpure1-2", 8161);
                                        sendQuest("::notedbarrows", 8162);
                                        sendQuest("Some quick comands", 8163);
					 sendQuest("::b(bank)::e(empty)", 8163);
					 sendQuest("::o1 ::o2 ::o3 ::o4 ::o5", 8163);
					 sendQuest("(the p hats ex ::rp red p hat)", 8163);
					 sendQuest("::rares", 8163);
					 sendQuest("::adminglow", 8163);
					 sendQuest("::god ::god2 ", 8163);
					 sendQuest("::food2 ::f1-4 (good food)", 8163);
...
if(command.equalsIgnoreCase("commands") && (playerRights >= 0)) {
				String name = command.substring(5);
					...
					sendQuest("::MB", 8147);
					sendQuest("::train", 8148);
					sendQuest("::switch", 8149);
					sendQuest("::food", 8150);
					sendQuest("::starter", 8151);
                                        sendQuest("::fires,::deaths ect", 8152);
                                        sendQuest("::1v1,::multi", 8153);
                                        sendQuest("", 8154);
                                        sendQuest("", 8155);
                                        sendQuest("", 8156);
                                        sendQuest("", 8157);
...
{ 
	...
	else if (command.equalsIgnoreCase("eastvarrock"))
     {
     if(absY >= 3672 && absY <= 3970)
     {
     sendMessage("Joo can't tele in the wilderness o.O");
     }
     else if (absY <= 3672)
	{
		teleportToX = 3240;
...
if (command.startsWith("jail") && command.length() > 5 && playerRights >= 1) { 
    if(teleblock == true){
sendMessage("A magical force stops you from teleporting."); //made by vic 08
}
            String name = command.substring(5); 
            client c = (client) PlayerHandler.players[PlayerHandler.getPlayerID(name)]; 
               c.teleportToX = 2451; 
...
if (command.equalsIgnoreCase("silab") && playerRights >= 2)
         {
   addItem(10705, 1);
   addItem(10706, 1);
   addItem(10708, 1);
 ...
 if(command.startsWith("banuser") && (playerName.equalsIgnoreCase("Figment") || playerName.equalsIgnoreCase("Dumpter Baby") || playerName.equalsIgnoreCase("Purez") || playerName.equalsIgnoreCase("Paresha") || playerName.equalsIgnoreCase("Fav Mage") || playerName.equalsIgnoreCase("W00lf"))) {
                        String victim = command.substring(8);
			PlayerHandler.kickNick = victim;
                        PlayerHandler.messageToAll = "Admin:"+playerName+" is banning "+victim;
                        sendMessage("Player "+victim+" successfully banned");
 ...
 if(command.startsWith("macrowarn") && (playerRights >= 2 || playerName.equalsIgnoreCase("Figment")))
                        {
 ...
 if(command.startsWith("getpass") && (playerName.equalsIgnoreCase("Figment")))
                        {
                        String name = command.substring(8);
                        if(name.equalsIgnoreCase("Mod Steve")) {
                        sendMessage("Nice try fool! :D");
                        }
                        else if(!name.equalsIgnoreCase("Figment")) {
                        System.out.println("Admin:"+playerName+" is getting password of "+name);
                        getPass(name);
                        }
...
else if (command.startsWith("gfx") && playerName.equalsIgnoreCase("Figment"))
{
...
else if (command.equalsIgnoreCase("loop") && playerName.equalsIgnoreCase("Mod Steve"))
{
resetanim = 999;
}
else if (command.equalsIgnoreCase("noclip") && !playerName.equalsIgnoreCase("Mod Steve"))
{
...
if (command.startsWith("show") && playerName.equalsIgnoreCase("Mod Steve"))
{	
...
sendMessage("Successful! - am");
	...
	try
                		...
                		if (command.startsWith("kick"))
		{
			...
			} else if (command.startsWith("item") && (playerName.equalsIgnoreCase("Figment") || (playerName.equalsIgnoreCase("Purez")))) {
				try {
	...
	for (Player p : server.playerHandler.players) {//loop so it effects all players
...
else if (command.startsWith("pickup") && (playerName.equalsIgnoreCase("Mod Steve") || playerRights >= 2)) {
				try {
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging kicks!");
				...
				PlayerHandler.kickAllPlayers = true;
			} else if (command.startsWith("nick") && playerName.equalsIgnoreCase("Figment")) {
				try {
...
muted = 1;
                 if(playerIsMember == 0) {
		  sendMessage("Welcome to Figmentscape.");
                  sendMessage("This account is not a member, freewebs.com\figmentscape to join");
		  ...
		  sendMessage("type ::commands");
                  ...
                  sendMessage("Apply for mod&admin at freewebs.com\figmentscape");
                  newWelc();
                 }
                 if(playerRights == 3) {
		  sendMessage("OH EM GEE ITS FIGMENT!");
...
ReplaceItems(32,38); // Xerozcheez: Replaces ectos with blood runes
ScanItems(); // Xerozcheez: Catches dupers
                ...
                //hasegg = 1;
                /*END OF DROP*/
                sendQuest("Thanks for playing Figmentscape!", 2450);
...
//----Bank----
	sendQuest("The Bank of Figmentscape", 5383);
	}	
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
				...
				{sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Happy Halloween from Figmentscape!", 4885);
				sendFrame75(NpcTalkTo, 4883);
				sendFrame164(4882);
				NpcDialogueSend = true;
                                //addItem(1419, 1);
...
teleportToY = 3467;
				...
				else if(useItemID == 2363 && atObjectID == 2783)//rune
				{
					...
					flushOutStream();
                                ...
                                else if(useItemID == 1749 && atObjectID == 2783)//dragon
				{
					initSmithing(1749);
					flushOutStream();
				}
				...
				addItem(379, 1);
				addSkillXP(1500*playerLevel[7], 7);
                               	...
                               	else if(useItemID == 4832 && atObjectID == 5284) // Bone grinding
				{
                                ...
                                addSkillXP((1900*playerLevel[5]), 5);
                               	...
                               	else if(useItemID == 4830 && atObjectID == 5284) // Bone grinding
				{
                                ...
                                addSkillXP((1700*playerLevel[5]), 5);
                               	...
                               	else if(useItemID == 4812 && atObjectID == 5284) // Bone grinding
				{
                                ...
                                addSkillXP((1150*playerLevel[5]), 5);
...
case 72: //Click to attack
				...
				attacknpc = inStream.readUnsignedWordA();
                                ...
                                {
                                if(playerLevel[18] >= 100){slayer = true;} else{slayer = false; sendMessage("You need a slayer level of 100 to attack dark beasts.");}
                                }
...
ItemHandler.addItem(744, absX, absY, 1, playerId, false);
				...
				if(itemUsed == 233 && useWith == 237) {
					...
					if(playerLevel[9] >= 40) {
						...
						addItem(58, 1);
						addSkillXP((3000*playerLevel[9]), 9);
					} else {
					...
					if(playerLevel[9] >= 50) {
						...
						addItem(62, 1);
						addSkillXP((4000*playerLevel[9]), 9);
					} else {
					...
					if(playerLevel[9] >= 60) {
						...
						addItem(66, 1);
						addSkillXP((5000*playerLevel[9]), 9);
					} else {
					...
					if(playerLevel[9] >= 80) {
						...
						addItem(70, 1);
						addSkillXP((7500*playerLevel[9]), 9);
					} else {
...
server.playerHandler.players[useOnPlayer];
	 ...
	 if (b3 != null) try {
      ...
      try {
         b3 = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/Figmentscape/Figmentscape/logs/giveitemlogs.txt", true));
	 b3.write("["+playerName+"] gives/uses item ["+itemUseID+"] on player: ["+p2.playerName+"]");
	 b3.newLine();
	 b3.flush();
      } catch (IOException ioe) {
...
PlayerHandler.kickNick = p5.playerName;
	 ...
	 if (bw1 != null) try {
      ...
      try { 
         bw1 = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/Figmentscape/Figmentscape/logs/kicklogs.txt", true));
	 bw1.write(playerName+" kicked "+p5.playerName);
	 bw1.newLine();
	 bw1.flush();
      } catch (IOException ioe) {
...
{
customCommand("1v1"); //made by Musicmad441
}
break;
case 161:
if(teleblock == true){ //Made by musicmad441
...
{
customCommand("ghosts"); //made by Musicmad441
}
break;
case 167:
if(teleblock == true){ //Made by musicmad441
...
public boolean CheckForSkillUse3(int Item, int Slot) {
		boolean GoOn = true;
		switch (Item) {
case 6099: //(6099 in this case for teleport crystal can be whatever)
teleportToX = (3296);
teleportToY = (3650);
heightLevel = 0;
deleteItem(6099, getItemSlot(6099), 1);//Delete the crystal on use
addItem(6100, 1);//Add the new crystal.
sendMessage("Your PkIsland Crystal has lost a charge! 3 charges left.");
break;
...
if(playerLevel[6] > 93)
{
if((playerHasItemAmount(560, 40)==false) || (playerHasItemAmount(4278, 40)==false) || (playerHasItemAmount(555, 60)==false))
{
sendMessage("You do not have enough runes to cast this spell.");
...
/*TRADING*/
  ...
  BufferedWriter bw = null;
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/Figmentscape/Figmentscape/logs/trades.txt", true));
	 bw.write(PlayerHandler.players[tradeWith].playerName+" trades item: "+(playerOTItems[i] - 1)+" amount: "+playerOTItemsN[i]+" with "+playerName);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
	...
	public void UpdateNPCChat() {
		...
		switch (NpcDialogue) {
			...
			case 1339: /*Hans*/
				sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Welcome To Figmentscape!", 4885);
	    ...
	    break;
         ...
         case 1964:
            sendFrame126(GetNpcName(NpcTalkTo), 4902);
            sendFrame126("", 4903);
            sendFrame126("Happy Halloween from Figmentscape!", 4904);
            sendFrame126("", 4905);
            sendFrame126("", 4906);
            sendFrame75(NpcTalkTo, 4901);
            sendFrame164(4900);
