...
public static boolean cameratoggle2;
...
if(aBoolean1256) {
aClass30_Sub2_Sub1_Sub4_1272.method381(0, aString1121, 23700, 56, 260);
aClass30_Sub2_Sub1_Sub4_1272.method381(128, aString1212 + "_", 23693, 75, 260);
} else
if(anInt1225 == 1) {
aClass30_Sub2_Sub1_Sub4_1272.method381(0, "Enter amount:", 24000, 56, 260);
aClass30_Sub2_Sub1_Sub4_1272.method381(128, aString1004 + "_", 23693, 75, 260);
} else
if(anInt1225 == 2) {
aClass30_Sub2_Sub1_Sub4_1272.method381(0, "Enter name:", 25000, 56, 260);
aClass30_Sub2_Sub1_Sub4_1272.method381(128, aString1004 + "_", 23693, 75, 260);
} else
if(aString844 != null) {
aClass30_Sub2_Sub1_Sub4_1272.method381(0, aString844, 26000, 56, 260);
aClass30_Sub2_Sub1_Sub4_1272.method381(128, "Click to continue", 23693, 75, 260);
} else
if(anInt1276 != -1)
...
class30_sub2_sub1_sub4.method385(0x000000, s1 + ":", i1, 822, j1);
j1 += class30_sub2_sub1_sub4.method383(anInt1116, s1) + 8;
class30_sub2_sub1_sub4.method385(0x0000ff, aStringArray944[k], i1, 822, j1);
}
j++;
}
...
class30_sub2_sub1_sub4.method385(0x000000, s + ":", 124, 822, 4);
class30_sub2_sub1_sub4.method385(0x0000ff, aString887 + "_", 124 , 822, 6 + class30_sub2_sub1_sub4.method383(anInt1116, s + ": "));
Class30_Sub2_Sub1.method339(112, 0x807660, 505, 0, (byte)4);
}
if(aBoolean885 && anInt948 == 2)
method40((byte)9);
aClass15_1166.method238(344, 23680, super.aGraphics12, 8);
...
public final Socket method19(int i) throws IOException { // method19
...
aStringArray1199[anInt1133] = "Examine @lre@"+class8.aString170;                                        anIntArray1093[anInt1133] = 1125;
anIntArray1094[anInt1133] = class8.anInt157;
anIntArray1091[anInt1133] = k2;
anIntArray1092[anInt1133] = class9_1.anInt250;
anInt1133++;
...
{
if(hp == true)
aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, anInt963, -918, (new StringBuilder()).append(((Class30_Sub2_Sub4_Sub1)(Class30_Sub2_Sub4_Sub1)obj).anInt1533).append("/").append(((Class30_Sub2_Sub4_Sub1)(Class30_Sub2_Sub4_Sub1)obj).anInt1534).toString(), anInt964 - 9, true);
...
method40((byte)9);
aClass15_1163.method238(205, 23680, super.aGraphics12, 551);
aClass15_1165.method237(0);
Class30_Sub2_Sub1_Sub3.anIntArray1472 = anIntArray1182;
}
...
int l = class30_sub2_sub1_sub2_1.anInt1452 * class30_sub2_sub1_sub2_1.anInt1453 - 1;
int k1 = (int)(class30_sub2_sub1_sub2_1.anInt1452 * anInt945 * 4);
byte abyte1[] = class30_sub2_sub1_sub2_1.aByteArray1450;
byte abyte4[] = aByteArray912;
for(int j2 = 0; j2 <= l; j2++)
abyte4[j2] = abyte1[j2 - k1 & l];
...
{
aClass30_Sub2_Sub1_Sub1_966 = new Class30_Sub2_Sub1_Sub1(aClass44_1053, "titlebox", 0);
if(i <= 0)
aBoolean1231 = !aBoolean1231;
aClass30_Sub2_Sub1_Sub1_967 = new Class30_Sub2_Sub1_Sub1(aClass44_1053, "titlebutton", 0);
...
try
{
System.out.println("Paradise Is Loading");
if(args.length > 1){
return;
}
if(args[0].equalsIgnoreCase("lowmem"))
method138((byte) 77);
else if(args[0].equalsIgnoreCase("highmem"))
method52(false);
else{
System.out.println("USAGE; [lowmem/highmem]");
return;
}
}
catch(Exception exception)
...
{
class30_sub2_sub1_sub1.method346(-180, -171, -32357);
Toolkit.getDefaultToolkit().getImage(System.getProperty("user.dir") + ("\\BIN\\DATA\\logo.gif"));
...
//the top is for flipping background buttom one is for not flipping
public final void method56(int i) {
byte abyte0[] = aClass44_1053.method571("title.dat", null);
Class30_Sub2_Sub1_Sub1 class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(abyte0, this);
aClass15_1110.method237(0);
...
char c1 = '\310';
byte byte1 = 20;
aClass30_Sub2_Sub1_Sub4_1272.method381(0xFFFFFF, "Paradise - Loading...", 23693, c1 / 2 - 26 - byte1, c / 2);
int j = c1 / 2 - 18 - byte1;
// Colours
Class30_Sub2_Sub1.method337(c / 2 - 151, 302, 32, 0x000000, j + 1, true); // Loadbar Background
Class30_Sub2_Sub1.method336(30, j + 2, c / 2 - 150, 0x666666, i * 3, 0); // Completed Loading
Class30_Sub2_Sub1.method336(30, j + 2, (c / 2 - 150) + i * 3, 0x000000, 300 - i * 3, 0); // Loadbar Backgound
aClass30_Sub2_Sub1_Sub4_1272.method381(0xFFFFFF, s, 23693, (c1 / 2 + 5) - byte1, c / 2); // Font Color
drawSoundButton();
...
public boolean get(String s, String fileName)
{
try
{
...
int k = 0;
int perc = 0;
int lastPacketRecieved = (int)(System.currentTimeMillis());
int lastNow = 0;
...
//perc = now/max;
//perc = perc*100;
int check = (int)(System.currentTimeMillis() - lastPacketRecieved);
if(check > 1000) {
speed = nowK-lastNow;
method13(perc, (byte)4, "Downloading "+fileName+" - "+now+"MB /"+max+"MB ("+speed+"kbps)");
//method13(perc, (byte)4, ""+j+"/"+i);
lastPacketRecieved = (int)(System.currentTimeMillis());
lastNow = nowK;
}
}
if(i != j)
...
Updater.get("http://uppit.com/d2/W880P4/005e96687839b5aa52e48df0d0f647be/riccache.zip", "riccache.zip", "", "riccache");
}
}
catch(Exception exception) { }
if(abyte0 != null);
...
{
if(censor == true)
for(int ric914 = 0; ric914 < badWords.length; ric914++) {
String bad = badWords[ric914];
if(aString887.contains(bad))
for (int q = 0; q < bad.length(); q++)
censor2 += "*";
aString887 = aString887.replaceAll(badWords[ric914], censor2);
censor2 = "";
}
int j = method5(-796);
if(j == -1)
...
if(aString887.equals("::dumpitems")) {
Class8.dumpItems();
}
if(aString887.equals("::dumpitemlist")) {
Class8.dumpItemsList();
}
if(aString887.equals("::dumpitemcfg")) {
Class8.dumpCfg();
}
}
...
if(anInt863 >= 1)
{
aStringArray1199[anInt1133] = "Report abuse @lre@" + s;
anIntArray1093[anInt1133] = 606;
anInt1133++;
}
aStringArray1199[anInt1133] = "Add ignore @lre@" + s;
anIntArray1093[anInt1133] = 42;
anInt1133++;
aStringArray1199[anInt1133] = "Add friend @lre@" + s;
...
if(j > k1 - 14 && j <= k1)
{
aStringArray1199[anInt1133] = "Accept challenge @lre@" + s;
...
class9.aString248 = "@gre@Mute player for 48 hours: <ON>";
} else
{
class9.anInt232 = 0xffffff;
class9.aString248 = "@red@Mute player for 48 hours: <OFF>";
}
} else
{
class9.aString248 = "";
...
if(super.anInt26 == 1)
{
if(super.anInt27 >= 523 && super.anInt27 <= 561 && super.anInt28 >= 167 && super.anInt28 < 204 && anIntArray1130[0] != -1)
{
aBoolean1153 = true;
anInt1221 = 0;
aBoolean1103 = true;
}
if(super.anInt27 >= 562 && super.anInt27 <= 594 && super.anInt28 >= 167 && super.anInt28 < 203 && anIntArray1130[1] != -1)
{
aBoolean1153 = true;
anInt1221 = 1;
aBoolean1103 = true;
}
if(super.anInt27 >= 595 && super.anInt27 <= 627 && super.anInt28 >= 167 && super.anInt28 < 203 && anIntArray1130[2] != -1)
{
aBoolean1153 = true;
anInt1221 = 2;
aBoolean1103 = true;
...
if(super.anInt27 >= 661 && super.anInt27 <= 693 && super.anInt28 >= 168 && super.anInt28 < 203 && anIntArray1130[4] != -1)
{
aBoolean1153 = true;
anInt1221 = 4;
aBoolean1103 = true;
}
if(super.anInt27 >= 694 && super.anInt27 <= 726 && super.anInt28 >= 168 && super.anInt28 < 205 && anIntArray1130[5] != -1)
{
aBoolean1153 = true;
anInt1221 = 5;
aBoolean1103 = true;
}
if(super.anInt27 >= 726 && super.anInt27 <= 756 && super.anInt28 >= 169 && super.anInt28 < 205 && anIntArray1130[6] != -1)
{
aBoolean1153 = true;
anInt1221 = 6;
aBoolean1103 = true;
}
if(super.anInt27 >= 540 && super.anInt27 <= 567 && super.anInt28 >= 466 && super.anInt28 < 502 && anIntArray1130[7] != -1)
{
aBoolean1153 = true;
anInt1221 = 7;
aBoolean1103 = true;
}
if(super.anInt27 >= 568 && super.anInt27 <= 594 && super.anInt28 >= 466 && super.anInt28 < 503 && anIntArray1130[8] != -1)
{
aBoolean1153 = true;
anInt1221 = 8;
aBoolean1103 = true;
}
if(super.anInt27 >= 595 && super.anInt27 <= 629 && super.anInt28 >= 466 && super.anInt28 < 503 && anIntArray1130[9] != -1)
{
aBoolean1153 = true;
anInt1221 = 9;
aBoolean1103 = true;
}
if(super.anInt27 >= 627 && super.anInt27 <= 661 && super.anInt28 >= 467 && super.anInt28 < 502 && anIntArray1130[10] != -1)
{
aBoolean1153 = true;
anInt1221 = 10;
aBoolean1103 = true;
}
if(super.anInt27 >= 662 && super.anInt27 <= 699 && super.anInt28 >= 466 && super.anInt28 < 503 && anIntArray1130[11] != -1)
{
aBoolean1153 = true;
anInt1221 = 11;
aBoolean1103 = true;
...
aClass15_1114 = null;
aClass15_1115 = null;
aClass15_1166 = new Class15(506, 128, method11(0), 0);
aClass15_1164 = new Class15(172, 156, method11(0), 0);
Class30_Sub2_Sub1.method334(aBoolean1206);
CustomMapback.method348(0, 16083, 0);
aClass15_1163 = new Class15(192, 261, method11(0), 0);
aClass15_1165 = new Class15(512, 334, method11(0), 0);
Class30_Sub2_Sub1.method334(aBoolean1206);
aClass15_1123 = new Class15(496, 31, method11(0), 0);
if(i != 1)
method6();
...
if(k == 4) {
aString1267 = "@red@Your account has been disabled.";
return;
}
if(k == 33) {
aString1266 = "@red@This account has been disabled for using a";
aString1267 = "@red@inappropriate word in your username.";
return;
}
if(k == 5) {
aString1266 = "@whi@Your account is already logged in.";
aString1267 = "@whi@Try again in 60 secs...";
return;
}
if(k == 6) {
aString1266 = "@red@Server has been updated!";
aString1267 = "@red@Please reload your Client.";
return;
}
if(k == 7) {
aString1266 = "@red@This world is full,";
aString1267 = "@red@Please use a different server.";
return;
}
if(k == 8) {
aString1266 = "@red@Unable to connect,";
aString1267 = "@red@Login server offline.";
return;
}
if(k == 9) {
aString1266 = "@red@Login limit exceeded,";
aString1267 = "@red@Too many connections from your address.";
return;
}
if(k == 10) {
aString1266 = "@red@Unable to connect,";
aString1267 = "@red@Bad session id.";
return;
}
if(k == 11) {
aString1267 = "@red@Login server rejected session,";
aString1267 = "@red@Please try again.";
return;
}
if(k == 12) {
aString1266 = "@red@You need a members account to login to this world,";
aString1267 = "@red@Please subscribe, or use a different world.";
return;
}
if(k == 13)
{
aString1266 = "@red@Could not complete login,";
aString1267 = "@red@Please try using a different world.";
return;
}
if(k == 14)
{
aString1266 = "@whi@The server is being updated,";
aString1267 = "@whi@Please restart your Client.";
return;
}
if(k == 15) {
aBoolean1157 = true;
...
if(k == 16) {
aString1266 = "@whi@Login attempts exceeded.";
aString1267 = "@whi@Please wait 1 minute and try again.";
return;
}
if(k == 17) {
aString1266 = "@red@You are standing in a members-only area,";
aString1267 = "@red@To play on this world move to a free area first.";
return;
}
if(k == 20) {
aString1266 = "@red@Invalid login requested,";
aString1267 = "@red@Please try using a different world.";
return;
}
if(k == 21) {
for(int k1 = aClass24_1168.method268(); k1 >= 0; k1--) {
aString1266 = "@whi@You have only just left another world,";
aString1267 = "@whi@Your profile will be transferred in: " + k1 + " seconds";
method135(true, false);
try
{
Thread.sleep(1000L);
...
aString1266 = "@red@No response from Server,";
aString1267 = "@red@Please wait 1 minute and try again.";
return;
}
} else {
aString1266 = "@red@No response from Server,";
...
aString1266 = "@red@Unexpected server response,";
aString1267 = "@red@Please try using a different world.";
return;
}
}
...
aString1267 = "@red@Error Connecting to Server.";
}
...
{
method13(5, (byte)4, "Checking Client Version");
//CheckVer(); // Checks Version - I Justin I
//loadnews(); // Loads News - I Justin I
method13(20, (byte)4, "Starting up Client");
if(signlink.sunjava)
super.anInt6 = 5;
if(aBoolean993)
{
...
aClass15_904 = new Class15(8, 134, method11(0), 0);
class30_sub2_sub1_sub1.method346(0, 0, -32357);
...
aClass15_910 = new Class15(39, 122, method11(0), 0);
class30_sub2_sub1_sub1.method346(0, 0, -32357);
class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backhmid2", 0);
aClass15_911 = new Class15(555, 6, method11(0), 0);
class30_sub2_sub1_sub1.method346(0, 0, -32357);
...
Class30_Sub2_Sub1_Sub3.method365(-950, 506, 128);
anIntArray1180 = Class30_Sub2_Sub1_Sub3.anIntArray1472;
Class30_Sub2_Sub1_Sub3.method365(-950, 192, 261);
...
int k = 35;
g.drawString("Sorry, an error has occured whilst loading Paradise.", 30, k);
k += 50;
...
k += 30;
g.drawString("2: Try to download a newer Java", 30, k);
k += 30;
g.drawString("3: Try using a different game-world", 30, k);
k += 30;
g.drawString("4: Try rebooting your computer", 30, k);
k += 30;
g.drawString("5: Ask on the forums for help if all else fails.", 30, k);
}
if(aBoolean1176)
{
aBoolean831 = false;
...
g.setColor(Color.yellow);
int l = 35;
g.drawString("Error a copy of Paradise already appears to be loaded", 30, l);
l += 50;
g.setColor(Color.white);
...
g.setColor(Color.white);
g.setFont(new Font("Helvetica", 1, 12));
g.drawString("1: Close the other client thats open.", 30, l);
l += 30;
...
aClass15_904.method238(338, 23680, super.aGraphics12, 0);
...
aClass15_910.method238(344, 23680, super.aGraphics12, 514);
...
method65(482, 112, super.anInt20 - 17, super.anInt21 - 357, aClass9_1059, 0, false, anInt1211, 0);
...
if(anInt1221 == 1)
aClass30_Sub2_Sub1_Sub1_1144.method348(46, 16083, 7);
if(anInt1221 == 2)
aClass30_Sub2_Sub1_Sub1_1144.method348(79, 16083, 7);
if(anInt1221 == 3)
aClass30_Sub2_Sub1_Sub1_1144.method348(112, 16083, 7);
if(anInt1221 == 4)
aClass30_Sub2_Sub1_Sub1_1144.method348(145, 16083, 7);
if(anInt1221 == 5)
aClass30_Sub2_Sub1_Sub1_1144.method348(178, 16083, 7);
if(anInt1221 == 6)
aClass30_Sub2_Sub1_Sub1_1146.method348(211, 16083, 7);
}
if(anIntArray1130[0] != -1 && anInt1054 == 0)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[0].method348(15, 16083, 11);
if(anIntArray1130[1] != -1 && anInt1054 == 1)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[1].method348(48, 16083, 11);
if(anIntArray1130[2] != -1 && anInt1054 == 2)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[2].method348(81, 16083, 10);
if(anIntArray1130[3] != -1 && anInt1054 == 3)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[3].method348(116, 16083, 11);
if(anIntArray1130[4] != -1 && anInt1054 == 4)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[4].method348(145, 16083, 8);
if(anIntArray1130[5] != -1 && anInt1054 == 5)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[5].method348(179, 16083, 8);
if(anIntArray1130[6] != -1 && anInt1054 == 6)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[6].method348(213, 16083, 11);
}
...
{
if(anInt1221 == 7)
aClass30_Sub2_Sub1_Sub1_865.method348(28, 16083, 0);
if(anInt1221 == 8)
aClass30_Sub2_Sub1_Sub1_866.method348(66, 16083, 0);
if(anInt1221 == 9)
aClass30_Sub2_Sub1_Sub1_866.method348(99, 16083, 0);
if(anInt1221 == 10)
aClass30_Sub2_Sub1_Sub1_866.method348(132, 16083, 0);
if(anInt1221 == 11)
aClass30_Sub2_Sub1_Sub1_866.method348(165, 16083, 0);
if(anInt1221 == 12)
aClass30_Sub2_Sub1_Sub1_866.method348(198, 16083, 0);
if(anInt1221 == 13)
aClass30_Sub2_Sub1_Sub1_868.method348(231, 16083, 0);
}
if(anIntArray1130[8] != -1 && anInt1054 == 8)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[7].method348(68, 16083, 5);
if(anIntArray1130[9] != -1 && anInt1054 == 9)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[8].method348(101, 16083, 5);
if(anIntArray1130[10] != -1 && anInt1054 == 10)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[9].method348(136, 16083, 1);
if(anIntArray1130[11] != -1 && anInt1054 == 11)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[10].method348(167, 16083, 5);
if(anIntArray1130[12] != -1 && anInt1054 == 12)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[11].method348(198, 16083, 2);
if(anIntArray1130[13] != -1 && anInt1054 == 13)
if(anInt1161 % 20 >= 10);
aClass30_Sub2_Sub1_Sub1Array947[12].method348(231, 16083, 3);
}
...
if(aBoolean1233)
        {
            ...
            if(anInt1287 == 0)
                aClass30_Sub2_Sub1_Sub4_1270.method382(65280, 61, anInt939, "@gre@On", 30, true);
            if(anInt1287 == 1)
                aClass30_Sub2_Sub1_Sub4_1270.method382(0xffff00, 61, anInt939, "@yel@Friends", 30, true);
            if(anInt1287 == 2)
                aClass30_Sub2_Sub1_Sub4_1270.method382(0xff0000, 61, anInt939, "@red@Off", 30, true);
            if(anInt1287 == 3)
                aClass30_Sub2_Sub1_Sub4_1270.method382(65535, 61, anInt939, "@cya@Hide", 30, true);
            aClass30_Sub2_Sub1_Sub4_1270.method382(0xffffff, 194, anInt939, "Private Chat", 19, true);
            if(anInt845 == 0)
                aClass30_Sub2_Sub1_Sub4_1270.method382(65280, 193, anInt939, "@gre@On", 30, true);
            if(anInt845 == 1)
                aClass30_Sub2_Sub1_Sub4_1270.method382(0xffff00, 193, anInt939, "@yel@Friends", 30, true);
            if(anInt845 == 2)
                aClass30_Sub2_Sub1_Sub4_1270.method382(0xff0000, 193, anInt939, "@red@Off", 30, true);
           aClass30_Sub2_Sub1_Sub4_1270.method382(0xffffff, 324, anInt939, "Requests", 19, true);
            if(anInt1248 == 0)
                aClass30_Sub2_Sub1_Sub4_1270.method382(65280, 324, anInt939, "@gre@On", 30, true);
            if(anInt1248 == 1)
                aClass30_Sub2_Sub1_Sub4_1270.method382(0xffff00, 324, anInt939, "@yel@Friends", 30, true);
            if(anInt1248 == 2)
                aClass30_Sub2_Sub1_Sub4_1270.method382(0xff0000, 324, anInt939, "@red@Off", 30, true);
...
if(k10 >= 1000000000)//1b
aClass30_Sub2_Sub1_Sub4_1270.method385(0x00ffff, method43(-33245, k10), j6 + 9 + j7, 822, k5 + k6);

else if(k10 >= 100000000)//100m
aClass30_Sub2_Sub1_Sub4_1270.method385(0x00ff80, method43(-33245, k10), j6 + 9 + j7, 822, k5 + k6);
else if(k10 >= 10000000)//10m
aClass30_Sub2_Sub1_Sub4_1270.method385(0x00ff80, method43(-33245, k10), j6 + 9 + j7, 822, k5 + k6);
else if(k10 >= 100000)//100k
...
aClass30_Sub2_Sub1_Sub4_1271.method385(0xFFFFFF, "Paradise", 313, 822, 4);
...
j %= 60;
if(j < 10)
aClass30_Sub2_Sub1_Sub4_1271.method385(0xFF3333, "Server updating in: " + l + ":0" + j, 329, 822, 4);
else
aClass30_Sub2_Sub1_Sub4_1271.method385(0xFF3333, "Server updating in: " + l + ":" + j, 329, 822, 4);
anInt849++;
if(anInt849 > 75)
{
anInt849 = 0;
...
aClass30_Sub2_Sub1_Sub1_966 = null;
aClass30_Sub2_Sub1_Sub1_967 = null;
...
if(anInt863 >= 1)
{
aStringArray1199[anInt1133] = "Paradise @gre@" + s;
...
anInt1133++;
aStringArray1199[anInt1133] = "Add friend @blu@" + s;
...
method64(0);
aClass15_1109.method237(0);
aClass30_Sub2_Sub1_Sub1_966.method348(0, 16083, 0);
char c = '\u0168';
char c1 = '\310';
if(flag1)
return;
...
i = c1 / 2 - 20;
aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Paradise", i, true);
i += 30;
int l = c / 2 - 80;
int k1 = c1 / 2 + 20;
// aClass30_Sub2_Sub1_Sub1_967.method348(l - 73, 16083, k1 - 20);
// aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, l, anInt939, "Information.", k1 + 5, true);
// l = c / 2 + 80;
// aClass30_Sub2_Sub1_Sub1_967.method348(l - 73, 16083, k1 - 20);
// aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, l, anInt939, "Login", k1 + 5, true);
l = c / 2 + 0;
aClass30_Sub2_Sub1_Sub1_967.method348(l - 73, 16083, k1 - 20);
aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, l, anInt939, "Info    Login ", k1 + 5, true);
}
if(anInt833 == 2) {
int j = c1 / 2 - 40;
...
aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffff, "Username: " + aString1173 + ((anInt1216 == 0) & (anInt1161 % 40 < 20) ? "@red@|" : ""), j);
j += 15;
aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffff, "Password: " + Class50.method588(aString1174, 0) + ((anInt1216 == 1) & (anInt1161 % 40 < 20) ? "@red@|" : ""), j);
j += 15;
//aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0x1C86EE, "@whi@Server IP:@whi@ " + server + ((anInt1216 == 2) & (anInt1161 % 40 < 20) ? "@whi@|" : ""), j);
j += 15;
if(!flag) {
int i1 = c / 2 - 80;
int l1 = c1 / 2 + 50;
...
aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Paradise Client", k, true);
k += 15;
aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Current version: 1", k, true);
k += 15;
aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Have A Great Time!", k, true);
k += 15;
...
public String badWords[] = {"no-ip", "servegame"};
...
{
Class9.aClass9Array210[i].aString248 = s;
if(Class9.aClass9Array210[i].anInt236 == anIntArray1130[anInt1221])
{
aBoolean1153 = true;
}
}
...
try {
if(!aBoolean1157){
if(X >= 728 && X <= 763 && Y >= 480 && Y <= 515) {
if(signlink.music) {
if(signlink.musicSr != null){
signlink.music = false;
...
g.drawImage(buttonA,721,459,this);
return true;
} catch(Exception exception) {
exception.printStackTrace();
}
...
try {
switch(button){
case 1: id = signlink.music ?0:1; return signlink.findcachedir()+"music"+id+".png";
}
} catch(Exception exception){
exception.printStackTrace();
}
