...
public class TextHandler { //My First Handler..
...
p.sendQuest("@whi@", 949);
p.sendQuest("@whi@", 950);
p.sendQuest("@red@Players Online: @gre@"+PlayerHandler.getPlayerCount(), 174);
...
p.sendQuest("Longrange", 1778);
p.sendQuest("Attacking Style:", 1768);


//staff
p.sendQuest("@gre@Attacking Style:", 332);
p.sendQuest("@gre@Bash", 340);
p.sendQuest("@whi@Pound It!", 341);
p.sendQuest("@gre@ iFocus! - Block!", 342);
...
p.sendQuest("@gre@Lunge!", 2439);
p.sendQuest("@whi@Slash!", 2438);
p.sendQuest("@gre@Chop!", 2437);
p.sendQuest("@whi@Block!", 2440);
p.sendQuest("", 2441);
p.sendQuest("", 2442);
p.sendQuest("", 2443);
p.sendQuest("", 2444);
...
p.sendQuest("@gre@Ignore List", 5717);
p.sendQuest("@whi@Add Noob", 5070);
p.sendQuest("@gre@Del Noob", 5071);
p.sendQuest("@whi@Add Name", 5720);
p.sendQuest("@gre@Del Name", 5721);

//----Shop----
p.sendQuest("@whi@Right click to buy, Choose ammount you want, Click item for the price.", 3903);
...
p.sendFrame126("", 180);
p.sendFrame126("@red@Tzaar",181);
p.sendFrame126("@red@MB", 178);
p.sendFrame126("@blu@godwars",175);
p.sendFrame126("@red@1v1",177);
p.sendFrame126("@blu@Fish",185);
p.sendFrame126("@blu@Train",186);
p.sendFrame126("@blu@Barrow",173);
p.sendFrame126("@blu@Shops",179);
p.sendFrame126("@red@Multi",187);
p.sendFrame126("@blu@Cape",176);
p.sendFrame126("@blu@train",13371);
p.sendFrame126("@whi@MINI",13363);
...
p.sendFrame126("@whi@Walk",160 );
p.sendFrame126("@whi@Run",159 );
p.sendFrame126("@whi@Energy Left:",148);
p.sendFrame126("@gre@Move Speed",158 );
p.sendFrame126("@whi@Hit Back",155 );
p.sendFrame126("@blu@Stake",182 );
p.sendFrame126("@gre@Closewindow",3902 );
p.sendFrame126("@gre@On",157 );
p.sendFrame126("@gre@Off",156 );
...
p.sendQuest("@gre@Level 80 : bl00d Blitz", 12913);
p.sendQuest("@whi@A single target strong blood attack", 12914);
p.sendQuest("@gre@Level 82 : kyle Blitz", 12873);
...
p.sendQuest("@gre@Level 94 : Figment Barrage", 12893);
p.sendQuest("@whi@Dont Fucking Combo so much", 12894);
...
p.sendQuest("@gre@Level 80 : Vengance", 1636);
p.sendQuest("@whi@multi-target Rebounding damage", 1637);
