...
public class Class11
{
    ...
    public void method193(byte byte0, ByteStream byteStream)
    {
        aClass29_183 = new Class29();
        aClass29_183.method308(aByte181, byteStream);
        aClass29_184 = new Class29();
        aClass29_184.method308(aByte181, byteStream);
        int i = byteStream.method521();
        if(i != 0)
        {
            byteStream.caret--;
            aClass29_185 = new Class29();
            aClass29_185.method308(aByte181, byteStream);
            aClass29_186 = new Class29();
            aClass29_186.method308(aByte181, byteStream);
        }
        ...
        if(i != 0)
        {
            ...
            aClass29_187.method308(aByte181, byteStream);
            aClass29_188 = new Class29();
            aClass29_188.method308(aByte181, byteStream);
        }
        i = byteStream.method521();
        if(i != 0)
        {
            ...
            aClass29_189.method308(aByte181, byteStream);
            aClass29_190 = new Class29();
            aClass29_190.method308(aByte181, byteStream);
        }
        for(int k = 0; k < 10; k++)
        {
            int l = byteStream.method535();
            if(l == 0)
                break;
            anIntArray191[k] = l;
            anIntArray192[k] = byteStream.method534();
            anIntArray193[k] = byteStream.method535();
        }

        anInt194 = byteStream.method535();
        anInt195 = byteStream.method535();
        anInt198 = byteStream.method523();
        anInt199 = byteStream.method523();
        aClass36_196 = new Class36();
        aClass29_197 = new Class29();
        aClass36_196.method356(-954, aClass29_197, byteStream);
    }
