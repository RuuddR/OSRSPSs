...
public class Class46
{
    ...
    public Class46(int i, int j, int k)
    {
        aBoolean748 = false;
        anInt749 = -766;
        aBoolean750 = true;
    ...
    public boolean method422(int i, int j, boolean flag, int k, int l, int i1, int j1, 
            int k1)
    {
        int l1 = (k + i) - 1;
        int i2 = (j1 + i1) - 1;
        ...
        if(j >= k && j <= l1 && k1 >= j1 && k1 <= i2)
            return true;
        if(j == k - 1 && k1 >= j1 && k1 <= i2 && (anIntArrayArray757[j - anInt753][k1 - anInt754] & 8) == 0 && (l & 8) == 0)
            return true;
        if(j == l1 + 1 && k1 >= j1 && k1 <= i2 && (anIntArrayArray757[j - anInt753][k1 - anInt754] & 0x80) == 0 && (l & 2) == 0)
            return true;
        if(k1 == j1 - 1 && j >= k && j <= l1 && (anIntArrayArray757[j - anInt753][k1 - anInt754] & 2) == 0 && (l & 4) == 0)
            return true;
        return k1 == i2 + 1 && j >= k && j <= l1 && (anIntArrayArray757[j - anInt753][k1 - anInt754] & 0x20) == 0 && (l & 1) == 0;
    }
