...
public class Class50_Sub1_Sub4_Sub3_Sub2 extends Class50_Sub1_Sub4_Sub3
{
    ...
    public Class50_Sub1_Sub4_Sub4 method570(boolean flag)
    {
        ...
        for(int l = 0; l < 12; l++)
        {
            ...
            if(i1 >= 256 && i1 < 512)
            {
                Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4_1 = Class48.aClass48Array815[i1 - 256].method439(aBoolean1747);
                if(class50_sub1_sub4_sub4_1 != null)
                    aclass50_sub1_sub4_sub4[k++] = class50_sub1_sub4_sub4_1;
            }
            if(i1 >= 512)
            {
                Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4_2 = Class16.method212(i1 - 512).method219(true, anInt1755);
                if(class50_sub1_sub4_sub4_2 != null)
                    aclass50_sub1_sub4_sub4[k++] = class50_sub1_sub4_sub4_2;
            }
        }

        Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4 = new Class50_Sub1_Sub4_Sub4(k, aclass50_sub1_sub4_sub4, (byte)-89);
        if(!flag)
            throw new NullPointerException();
        for(int j1 = 0; j1 < 5; j1++)
            if(anIntArray1760[j1] != 0)
            {
                class50_sub1_sub4_sub4.method591(client.anIntArrayArray1008[j1][0], client.anIntArrayArray1008[j1][anIntArray1760[j1]]);
                if(j1 == 1)
                    class50_sub1_sub4_sub4.method591(client.anIntArray1268[0], client.anIntArray1268[anIntArray1760[j1]]);
            }
    ...
    public Class50_Sub1_Sub4_Sub4 method571(byte byte0)
    {
        if(aClass37_1757 != null)
        {
            ...
            if(super.anInt1624 >= 0 && super.anInt1627 == 0)
                i = Class14.aClass14Array293[super.anInt1624].anIntArray295[super.anInt1625];
            else
        ...
        if(super.anInt1624 >= 0 && super.anInt1627 == 0)
        {
            Class14 class14 = Class14.aClass14Array293[super.anInt1624];
        ...
        if(class50_sub1_sub4_sub4_1 == null)
        {
            ...
            for(int j2 = 0; j2 < 12; j2++)
            {
                ...
                if(k2 >= 256 && k2 < 512)
                {
                    Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4_3 = Class48.aClass48Array815[k2 - 256].method437((byte)2);
                    if(class50_sub1_sub4_sub4_3 != null)
                        aclass50_sub1_sub4_sub4[l1++] = class50_sub1_sub4_sub4_3;
                }
                if(k2 >= 512)
                {
                    Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4_4 = Class16.method212(k2 - 512).method213((byte)-98, anInt1755);
            ...
            for(int l2 = 0; l2 < 5; l2++)
                ...
                {
                    class50_sub1_sub4_sub4_1.method591(client.anIntArrayArray1008[l2][0], client.anIntArrayArray1008[l2][anIntArray1760[l2]]);
                    if(l2 == 1)
                        class50_sub1_sub4_sub4_1.method591(client.anIntArray1268[0], client.anIntArray1268[anIntArray1760[l2]]);
                }
        ...
        class50_sub1_sub4_sub4_2.method579(Class21.method239(aBoolean1762, j) & Class21.method239(aBoolean1762, k), class50_sub1_sub4_sub4_1, 1244);
        if(j != -1 && k != -1)
            class50_sub1_sub4_sub4_2.method586(k, 0, j, Class14.aClass14Array293[super.anInt1624].anIntArray299);
        else
        if(j != -1)
    ...
    public Class50_Sub1_Sub4_Sub4 method561(byte byte0)
    {
        ...
        if(super.anInt1614 != -1 && super.anInt1615 != -1)
        {
            ...
            Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4_2 = class27.method307();
            if(class50_sub1_sub4_sub4_2 != null)
            {
                Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4_3 = new Class50_Sub1_Sub4_Sub4(false, false, true, class50_sub1_sub4_sub4_2, Class21.method239(aBoolean1762, super.anInt1615));
        ...
        if(aClass50_Sub1_Sub4_Sub4_1746 != null)
        {
            ...
            if(client.anInt1325 >= anInt1764 && client.anInt1325 < anInt1765)
            {
                ...
                if(super.anInt1584 == 1024)
                {
                    class50_sub1_sub4_sub4_1.method588(true);
                    class50_sub1_sub4_sub4_1.method588(true);
                } else
                if(super.anInt1584 == 1536)
                    class50_sub1_sub4_sub4_1.method588(true);
    ...
    public void method572(ByteStream byteStream, int i)
    {
        byteStream.caret = 0;
        anInt1755 = byteStream.method521();
        anInt1756 = byteStream.method522();
        anInt1748 = byteStream.method522();
        aClass37_1757 = null;
        anInt1766 = 0;
        for(int j = 0; j < 12; j++)
        {
            ...
            {
                aClass37_1757 = Class37.method364(byteStream.method523());
                break;
            }
            if(anIntArray1752[j] >= 512 && anIntArray1752[j] - 512 < Class16.anInt335)
            {
                int l1 = Class16.method212(anIntArray1752[j] - 512).anInt332;
                if(l1 != 0)
                    anInt1766 = l1;
            }
        }
        ...
        super.anInt1634 = byteStream.method523();
        if(super.anInt1634 == 65535)
            super.anInt1634 = -1;
        super.anInt1635 = byteStream.method523();
        if(super.anInt1635 == 65535)
            super.anInt1635 = -1;
        super.anInt1619 = byteStream.method523();
        if(super.anInt1619 == 65535)
            super.anInt1619 = -1;
        super.anInt1620 = byteStream.method523();
        if(super.anInt1620 == 65535)
            super.anInt1620 = -1;
        super.anInt1621 = byteStream.method523();
        if(super.anInt1621 == 65535)
            super.anInt1621 = -1;
        super.anInt1622 = byteStream.method523();
        if(super.anInt1622 == 65535)
            super.anInt1622 = -1;
        super.anInt1629 = byteStream.method523();
        if(super.anInt1629 == 65535)
            super.anInt1629 = -1;
        aString1751 = Class25.method303(Class25.method300(byteStream.method527(-149), 0), (byte)7);
        anInt1753 = byteStream.method521();
        anInt1759 = byteStream.method523();
        aBoolean1758 = true;
        aLong1754 = 0L;
