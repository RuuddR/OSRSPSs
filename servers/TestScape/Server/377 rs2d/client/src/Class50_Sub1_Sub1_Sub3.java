...
public class Class50_Sub1_Sub1_Sub3 extends Class50_Sub1_Sub1
{
    ...
    public Class50_Sub1_Sub1_Sub3(Class2 class2, String s, int i)
    {
        ...
        anInt1522 = byteStream_1.method523();
        anInt1523 = byteStream_1.method523();
        int j = byteStream_1.method521();
        anIntArray1517 = new int[j];
        for(int k = 0; k < j - 1; k++)
            anIntArray1517[k + 1] = byteStream_1.method525();
        ...
        anInt1520 = byteStream_1.method521();
        anInt1521 = byteStream_1.method521();
        anInt1518 = byteStream_1.method523();
        anInt1519 = byteStream_1.method523();
        ...
        if(i1 == 0)
        {
            for(int k1 = 0; k1 < j1; k1++)
                aByteArray1516[k1] = byteStream.method522();
        ...
        if(i1 == 1)
        {
            for(int l1 = 0; l1 < anInt1518; l1++)
            {
                for(int i2 = 0; i2 < anInt1519; i2++)
                    aByteArray1516[l1 + i2 * anInt1518] = byteStream.method522();
    ...
    public void method490(int i, int j, int k)
    {
        ...
        int i1 = j + i * Class50_Sub1_Sub1.anInt1425;
        int j1 = 0;
        int k1 = anInt1519;
        int l1 = anInt1518;
        ...
        {
            int k2 = Class50_Sub1_Sub1.anInt1427 - i;
            k1 -= k2;
            i = Class50_Sub1_Sub1.anInt1427;
            j1 += k2 * l1;
            i1 += k2 * Class50_Sub1_Sub1.anInt1425;
        }
        if(i + k1 > Class50_Sub1_Sub1.anInt1428)
            k1 -= (i + k1) - Class50_Sub1_Sub1.anInt1428;
        ...
        {
            method491(j1, Class50_Sub1_Sub1.anIntArray1424, aByteArray1516, j2, anIntArray1517, k1, l1, i1, false, i2);
            return;
        }
    }

    public void method491(int i, int ai[], byte abyte0[], int j, int ai1[], int k, int l, 
