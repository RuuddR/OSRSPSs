...
public class Class16
{
    ...
    public static Class16 method212(int i)
    {
        ...
        aByteStream_373.caret = anIntArray342[i];
        class16.anInt363 = i;
        class16.method223();
        class16.method218(aByte347, aByteStream_373);
    ...
    {
        aByteStream_373 = new ByteStream(true, class2.method154("obj.dat", null));
        ByteStream byteStream = new ByteStream(true, class2.method154("obj.idx", null));
        anInt335 = byteStream.method523();
    ...
    public void method218(byte byte0, ByteStream byteStream)
    {
        if(byte0 != 6)
            aBoolean349 = !aBoolean349;
        do
        {
            ...
            if(i == 0)
                return;
            if(i == 1)
                anInt360 = byteStream.method523();
            else
            if(i == 2)
                aString329 = byteStream.readString();
            else
            if(i == 3)
                aByteArray328 = byteStream.method529(621);
            else
            if(i == 4)
                anInt369 = byteStream.method523();
            else
            if(i == 5)
                anInt359 = byteStream.method523();
            else
            if(i == 6)
                anInt356 = byteStream.method523();
            else
            if(i == 7)
            {
                anInt327 = byteStream.method523();
                if(anInt327 > 32767)
                    anInt327 -= 0x10000;
            } else
            if(i == 8)
            {
                anInt340 = byteStream.method523();
                if(anInt340 > 32767)
                    anInt340 -= 0x10000;
            } else
            if(i == 10)
                anInt372 = byteStream.method523();
            else
            if(i == 11)
                aBoolean371 = true;
            else
            if(i == 12)
                anInt345 = byteStream.method526();
            else
            if(i == 16)
                aBoolean377 = true;
            else
            if(i == 23)
            {
                anInt353 = byteStream.method523();
                aByte378 = byteStream.method522();
            } else
            if(i == 24)
                anInt331 = byteStream.method523();
            else
            if(i == 25)
            {
                anInt326 = byteStream.method523();
                aByte330 = byteStream.method522();
            } else
            if(i == 26)
                anInt355 = byteStream.method523();
            else
            if(i >= 30 && i < 35)
            {
                if(aStringArray338 == null)
                    aStringArray338 = new String[5];
                aStringArray338[i - 30] = byteStream.readString();
            ...
            if(i >= 35 && i < 40)
            {
                ...
                aStringArray348[i - 35] = byteStream.readString();
            } else
            if(i == 40)
            {
                ...
                for(int k = 0; k < j; k++)
                {
                    anIntArray364[k] = byteStream.method523();
                    anIntArray341[k] = byteStream.method523();
                }

            } else
            if(i == 78)
                anInt370 = byteStream.method523();
            else
            if(i == 79)
                anInt367 = byteStream.method523();
            else
            if(i == 90)
                anInt334 = byteStream.method523();
            else
            if(i == 91)
                anInt375 = byteStream.method523();
            else
            if(i == 92)
                anInt361 = byteStream.method523();
            else
            if(i == 93)
                anInt362 = byteStream.method523();
            else
            if(i == 95)
                anInt339 = byteStream.method523();
            else
            if(i == 97)
                anInt333 = byteStream.method523();
            else
            if(i == 98)
                anInt343 = byteStream.method523();
            else
            if(i >= 100 && i < 110)
            {
                ...
                anIntArray365[i - 100] = byteStream.method523();
                anIntArray376[i - 100] = byteStream.method523();
            } else
            if(i == 110)
                anInt366 = byteStream.method523();
            else
            if(i == 111)
                anInt357 = byteStream.method523();
            else
            if(i == 112)
                anInt368 = byteStream.method523();
            else
            if(i == 113)
                anInt354 = byteStream.method522();
            else
            if(i == 114)
                anInt358 = byteStream.method522() * 5;
            else
            if(i == 115)
                anInt332 = byteStream.method521();
        } while(true);
    }
        ...
        for(int l4 = 31; l4 >= 0; l4--)
        {
            for(int i4 = 31; i4 >= 0; i4--)
                if(class50_sub1_sub1_sub1_1.anIntArray1489[l4 + i4 * 32] == 0)
                    ...
                    if(i4 > 0 && class50_sub1_sub1_sub1_1.anIntArray1489[l4 + (i4 - 1) * 32] > 1)
                        class50_sub1_sub1_sub1_1.anIntArray1489[l4 + i4 * 32] = 1;
                    else
                    if(l4 < 31 && class50_sub1_sub1_sub1_1.anIntArray1489[l4 + 1 + i4 * 32] > 1)
                        class50_sub1_sub1_sub1_1.anIntArray1489[l4 + i4 * 32] = 1;
                    else
                    if(i4 < 31 && class50_sub1_sub1_sub1_1.anIntArray1489[l4 + (i4 + 1) * 32] > 1)
                        class50_sub1_sub1_sub1_1.anIntArray1489[l4 + i4 * 32] = 1;
            ...
            for(int i5 = 31; i5 >= 0; i5--)
            {
                for(int j4 = 31; j4 >= 0; j4--)
                    if(class50_sub1_sub1_sub1_1.anIntArray1489[i5 + j4 * 32] == 0)
                        ...
                        if(j4 > 0 && class50_sub1_sub1_sub1_1.anIntArray1489[i5 + (j4 - 1) * 32] == 1)
                            class50_sub1_sub1_sub1_1.anIntArray1489[i5 + j4 * 32] = i;
                        else
                        if(i5 < 31 && class50_sub1_sub1_sub1_1.anIntArray1489[i5 + 1 + j4 * 32] == 1)
                            class50_sub1_sub1_sub1_1.anIntArray1489[i5 + j4 * 32] = i;
                        else
                        if(j4 < 31 && class50_sub1_sub1_sub1_1.anIntArray1489[i5 + (j4 + 1) * 32] == 1)
                            class50_sub1_sub1_sub1_1.anIntArray1489[i5 + j4 * 32] = i;
    ...
    public int anInt372;
    public static ByteStream aByteStream_373;
