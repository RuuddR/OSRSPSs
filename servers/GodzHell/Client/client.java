...
public final class client extends Applet_Sub1 {
    ...
    private static final String method14(int i, int j) {
        ...
        if(s.length() > 4)
            s = "@gre@" + s.substring(0, s.length() - 4) + "K @gre@(" + s + ")";
        return " " + s;
    }
...
*/
    ...
    public final void method13(int i, byte byte0, String s)
    {
        ...
        char c1 = '\310';
        byte byte1 = 20;
        aClass30_Sub2_Sub1_Sub4_1272.method381(255, "GodzHell is loading - please wait...", 23693, c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
        // Colours
	...
	if(aString887.contains(bad))
		aString887 = aString887.replaceAll(badWords[james], "google");
	}
        i = 55 / i;
        do
        {
        ...
        for(int i1 = 0; i1 < 100; i1++)
        {
            ...
            if((j1 == 1 || j1 == 2) && (j1 == 1 || anInt1287 == 0 || anInt1287 == 1 && method109(false, s)))
            {
                if(j > k1 - 14 && j <= k1 && !s.equals(aClass30_Sub2_Sub4_Sub1_Sub2_1126.aString1703))
                {
                    ...
                    aStringArray1199[anInt1133] = "Add ignore " + s;
                    anIntArray1093[anInt1133] = 42;
                    anInt1133++;
                    aStringArray1199[anInt1133] = "Add friend " + s;
...
//clicking areas
    public final void method78(int i)
    {
        ...
        if(super.anInt26 == 1)
        {
            if(super.anInt27 >= 523 && super.anInt27 <= 559 && super.anInt28 >= 166 && super.anInt28 < 201 && anIntArray1130[0] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 0;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 562 && super.anInt27 <= 592 && super.anInt28 >= 166 && super.anInt28 < 201 && anIntArray1130[1] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 1;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 595 && super.anInt27 <= 625 && super.anInt28 >= 166 && super.anInt28 < 201 && anIntArray1130[2] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 2;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 628 && super.anInt27 <= 658 && super.anInt28 >= 166 && super.anInt28 < 201 && anIntArray1130[3] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 3;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 660 && super.anInt27 <= 691 && super.anInt28 >= 166 && super.anInt28 < 201 && anIntArray1130[4] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 4;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 694 && super.anInt27 <= 724 && super.anInt28 >= 166 && super.anInt28 < 201 && anIntArray1130[5] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 5;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 727 && super.anInt27 <= 763 && super.anInt28 >= 166 && super.anInt28 < 201 && anIntArray1130[6] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 6;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 521 && super.anInt27 <= 556 && super.anInt28 >= 467 && super.anInt28 < 502 && anIntArray1130[7] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 7;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 559 && super.anInt27 <= 589 && super.anInt28 >= 467 && super.anInt28 < 502 && anIntArray1130[8] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 8;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 592 && super.anInt27 <= 622 && super.anInt28 >= 467 && super.anInt28 < 502 && anIntArray1130[9] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 9;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 625 && super.anInt27 <= 655 && super.anInt28 >= 467 && super.anInt28 < 502 && anIntArray1130[10] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 10;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 658 && super.anInt27 <= 688 && super.anInt28 >= 467 && super.anInt28 < 502 && anIntArray1130[11] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 11;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 691 && super.anInt27 <= 726 && super.anInt28 >= 467 && super.anInt28 < 503 && anIntArray1130[12] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 12;
                aBoolean1103 = true;
            }
            if(super.anInt27 >= 724 && super.anInt27 <= 760 && super.anInt28 >= 467 && super.anInt28 < 502 && anIntArray1130[13] != -1)
            {
                aBoolean1153 = true;
                anInt1221 = 13;
                aBoolean1103 = true;
	...
	try {
		aPort = Integer.parseInt(port);
            ...
            if(k == 4) {
                ...
                aString1267 = "check your message-centre for details.";
                return;
            }
            if(k == 5) {
            ...
            if(k == 6) {
                aString1266 = "Server has been updated!";
                aString1267 = "Please reload this page.";
                return;
            }
            if(k == 7) {
                aString1266 = "This world is full.";
                aString1267 = "Please use a different server.";
                return;
            }
            if(k == 8) {
         ...
         if(k == 22) {
            aString1266 = "Your client is out of date!";
            aString1267 = "Please update your client.";
            return;
         }
            if(k == 21) {
    ...
    public final void method6()
    {
	    ...
	    System.out.println("godzhell official client");
...
//back sprite position
	...
	//redstone position
                ...
                {
                    if(anInt1221 == 0)
                        aClass30_Sub2_Sub1_Sub1_1143.method348(7, 16083, 6);
                    if(anInt1221 == 1)
                        aClass30_Sub2_Sub1_Sub1_1144.method348(45, 16083, 6);
                    if(anInt1221 == 2)
                        aClass30_Sub2_Sub1_Sub1_1144.method348(78, 16083, 6);
                    if(anInt1221 == 3)
                        aClass30_Sub2_Sub1_Sub1_1144.method348(111, 16083, 6);
                    if(anInt1221 == 4)
                        aClass30_Sub2_Sub1_Sub1_1144.method348(144, 16083, 6);
                    if(anInt1221 == 5)
                        aClass30_Sub2_Sub1_Sub1_1144.method348(177, 16083, 6);
                    if(anInt1221 == 6)
                        aClass30_Sub2_Sub1_Sub1_1146.method348(210, 16083, 6);
                }
	//sideicon position
                if(anIntArray1130[0] != -1 && anInt1054 == 0)
                    if(anInt1161 % 20 >= 10);
                aClass30_Sub2_Sub1_Sub1Array947[0].method348(14, 16083, 10);
                if(anIntArray1130[1] != -1 && anInt1054 == 1)
                    if(anInt1161 % 20 >= 10);
                aClass30_Sub2_Sub1_Sub1Array947[1].method348(47, 16083, 10);
                ...
                if(anIntArray1130[6] != -1 && anInt1054 == 6)
                    if(anInt1161 % 20 >= 10);
                aClass30_Sub2_Sub1_Sub1Array947[6].method348(212, 16083, 10);
            }
            ...
            if(anInt1189 == -1)
            {
	//bottom redstone position
                if(anIntArray1130[anInt1221] != -1)
                {
                    if(anInt1221 == 7)
                        aClass30_Sub2_Sub1_Sub1_865.method348(24, 16083, 1);
                    if(anInt1221 == 8)
                        aClass30_Sub2_Sub1_Sub1_866.method348(62, 16083, 1);
                    if(anInt1221 == 9)
                        aClass30_Sub2_Sub1_Sub1_866.method348(95, 16083, 1);
                    if(anInt1221 == 10)
                        aClass30_Sub2_Sub1_Sub1_866.method348(128, 16083, 1);
                    if(anInt1221 == 11)
                        aClass30_Sub2_Sub1_Sub1_866.method348(161, 16083, 1);
                    if(anInt1221 == 12)
                        aClass30_Sub2_Sub1_Sub1_866.method348(194, 16083, 1);
                    if(anInt1221 == 13)
                        aClass30_Sub2_Sub1_Sub1_868.method348(227, 16083, 1);
                }
...
//						Class30_Sub2_Sub1_Sub4_1271.method382(0xffffff, 55, anInt939, class30_sub2_sub1_sub4.method383(anInt1116, s + ": "), 28, true);
                ...
                if((k == 3 || k == 7) && (k == 7 || anInt845 == 0 || anInt845 == 1 && method109(false, s)))
                {
                    ...
                    if(super.anInt20 > 4 && super.anInt21 - 4 > l - 10 && super.anInt21 - 4 <= l + 3)
                    {
                        ...
                        if(super.anInt20 < 4 + i1)
                        {
                            if(anInt863 >= 1)
                            {
                                aStringArray1199[anInt1133] = "Kihomura's client " + s;
    ...
    public final void method135(boolean flag, boolean flag1) {
        ...
        if(anInt833 == 0) {
            ...
            i = c1 / 2 - 70;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, "@whi@Welcome to GodzHell", i, true);
            i = c1 / 2 - 50;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, "@whi@@ GodzHell.com", i, true);
            i = c1 / 2 - 20;
            ...
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, l, anInt939, "@whi@New User", k1 + 5, true);
            l = c / 2 + 80;
            aClass30_Sub2_Sub1_Sub2_967.method361(l - 73, 16083, k1 - 20);
        ...
        if(anInt833 == 2) {
            ...
            aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffFF, "@whi@Character Name: " + aString1173 + ((anInt1216 == 0) & (anInt1161 % 40 < 20) ? "@xxx@|" : ""), j);
            j += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffff, "@whi@Password: " + Class50.method588(aString1174, 0) + ((anInt1216 == 1) & (anInt1105 % 40 < 20) ? "|" : ""), j);
           j += 30;
           aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 160, 1048320, "@whi@New users enter a name and password to begin", j);
        ...
        if(anInt833 == 3) {
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "GodzHell", c1 / 2 - 60, true); //Text
            int k = c1 / 2 - 35;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Godzhell.com", k, true);
            k += 15;
...
//                method58(25106);
    ...
    public final void method140(boolean flag)
    {
        ...
        if(anInt833 == 0)
        {
            ...
            if(super.anInt26 == 1 && super.anInt27 >= i - 75 && super.anInt27 <= i + 75 && super.anInt28 >= l - 20 && super.anInt28 <= l + 20)
            {
                aString1266 = "@whi@Entern your name and password to begin";
                aString1267 = "";
                anInt833 = 2;
                anInt1216 = 0;
                return;
