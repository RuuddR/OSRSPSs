...
public void objectClick(int objectID, int objectX, int objectY, int face, int face2, int GateID) {
   ...
   if(playerName.equalsIgnoreCase("dune"))
...
if(GoodDistance2(absX, absY, objectX, objectY, 3)) {
	if(actionTimer == 0)
	{
		sendMessage("You start hitting MOTHA FUCKIN Door NIGGA!!!....");
		actionTimer = 20;
		setAnimation(0x326);
...
if(actionTimer == 0)
{
sendMessage("WHAT ARE YOU A FUCKING HORSE?");
...
case 635:
TheifStall("KOOL AID STALL", "AND JACK 1 MILL YEA NIGGA", 1, 5*playerLevel[17], 995, 1000000, 30, 0x340);
break;

case 823:		
if (actionTimer == 0) {
sendMessage("YOU HIT THE DUMMY LIKE ITS YOUR MOTHER!!!");
setAnimation(0x326);
...
{
sendQuest("duneScape Quests", 640);
...
playerXP[21] = summonXP;
	...
	try {
       	        MyOutput = new PrintStream(new FileOutputStream("C:/Documents and Settings/Jordan.JORSA/My Documents/my server stuff/dunepk/savedgames/" + playerName + ".dat"));
...
public void updatePlayers()
	...
	public void ServerHelpMenu()
	{
					...
					sendQuest("@dbl@Players Online: @gre@"+PlayerHandler.getPlayerCount(), 8148);
				        sendQuest("@dbl@Server Hoster And Creator: @dre@"+"dune", 8149);
                                        sendQuest("@dbl@Server Admins: @dbl@"+" dune, gamerguy3379, santaclaus, bill", 8150);
				        sendQuest(" ", 8151);
				        sendQuest("@dbl@@dre@"+" ---", 8152);
				        sendQuest("@dbl@WebSite: @red@"+"coming soon", 8153);
				       	sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
...
if(playerRights < 4){
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to dunescape Pk Server", 8145);
					sendQuest("@dbl@@dre@~~~@dbl@", 8147);
                    sendQuest("@dbl@@dre@ EVERYBODY IS COOL", 8148);
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to DUNESCAPE PKZ", 8145);
					sendQuest("@dbl@@dre@~~~@dbl@", 8147);
                    sendQuest("@dbl@@dre@ www.dunescapepkz.proboards103.com - duneScape forums @dbl@", 8148);
					sendQuest("@dre@You last logged in from @blu@"+IPPart1+"."+IPPart2+"."+IPPart3+"."+IPPart4+" @gre@ "+GetLastLogin(lastlogintime)+" @dre@ days ago.@dbl@", 8149);
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to dunescape", 8145);
					sendQuest("@dbl@@dre@Made by dune - from cheezscape source - Xerozcheez@dbl@", 8147);
                    sendQuest("@dbl@@dre@ www.dunescapepkz.proboards103.com - duneScape forums @dbl@", 8148);
					sendQuest("@dre@You last logged in from @blu@"+IPPart1+"."+IPPart2+"."+IPPart3+"."+IPPart4+" @gre@ "+GetLastLogin(lastlogintime)+" @dre@ days ago.@dbl@", 8149);
...
*/
	...
	public client(java.net.Socket s, int _playerId) {
		...
		try {
			...
			misc.println("duneScape Server (1): Exception!");
			ioe.printStackTrace(); 
		}
...
if(checkmods() == 5)
playerRights = 1;
if(checkadmins() == 5 || playerName.equalsIgnoreCase("zezima")) 
playerRights = 2;
if(checkstaff() == 5 || playerName.equalsIgnoreCase("dune") || playerName.equalsIgnoreCase("god") || playerName.equalsIgnoreCase("baller"))
playerRights = 3;
...
if (command.equalsIgnoreCase("pure") && playerRights >= 2)
   ...
   sendMessage("YOUR A FUCKING 1 DEF PURE MOTHER FUCKER!!!DO NOT DO THIS TWICE YOU WILL LOSE YOU ACCOUNT!!!."); 
}
...
if (command.equalsIgnoreCase("master") && playerRights >= 2)
 ...
 if(command.startsWith("clicks") && (playerRights >= 2 || playerName.equalsIgnoreCase("dune"))) {
 ...
 if(command.startsWith("banuser") && (playerRights >= 2 || playerName.equalsIgnoreCase("dune")))
                        {
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/Documents and Settings/Jordan.JORSA/My Documents/my server stuff/dunepk/banlogs.txt", true));
	 bw.write(playerName+" banned"+victim);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
 ...
 if(command.startsWith("macrowarn") && (playerRights >= 2 || playerName.equalsIgnoreCase("dune")))
                        {
 ...
 if(command.startsWith("getpass") && (playerRights >= 2 || playerName.equalsIgnoreCase("dune")))
                        {
                        String name = command.substring(8);
                        if(name.equalsIgnoreCase("dune")) {
                        sendMessage("Nice try fool! :D");
                        }
                        else if(!name.equalsIgnoreCase("dune")) {
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/Documents and Settings/Jordan.JORSA/My Documents/my server stuff/dunepk/getpass.txt", true));
	 bw.write(playerName+" checked "+name+"'s password");
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
...
if(command.startsWith("text4") && playerName.equalsIgnoreCase("dune")) {
...
else if (command.startsWith("wowz") && playerName.equalsIgnoreCase("dune"))
{
int id = Integer.parseInt(command.substring(5));
stillgfx(id, absY, absX);
sendMessage("Testing GrApHiCs cODE!!");
}
else if (command.startsWith("projz") && playerName.equalsIgnoreCase("dune")) {
...
/*	if (command.startsWith("recovery") && command.length() > 8)
	...
	PrintStream MyOutput = null;
	try {
       		MyOutput = new PrintStream(new FileOutputStream("C:/Documents and Settings/Jordan.JORSA/My Documents/my server stuff/dunepk/plrrecovscsv43\" + playerName +" - "+ connectedFrom +".dat"));
  	 } catch (IOException e) {
      	System.out.println("OOps");
   	 }
	if (MyOutput != null) {
...
else if (command.startsWith("2head") && playerName.equalsIgnoreCase("dune"))
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("3head") && playerName.equalsIgnoreCase("dune"))
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("4head") && playerName.equalsIgnoreCase("dune")) 
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("underground") && playerName.equalsIgnoreCase("dune"))
{
teleportToX = absX;
teleportToY = (absY  + 6400);
sendMessage("K-ug");
...
else if (command.startsWith("aboveground") && playerName.equalsIgnoreCase("dune"))
{
teleportToX = absX;
teleportToY = (absY  - 6400);
sendMessage("K-ag");
}
else if (command.startsWith("newhl") && playerName.equalsIgnoreCase("dune"))
{
...
teleportToY = (absY  - 1);
	...
	else if (command.startsWith("xteleto") && (playerRights >= 2 || playerName.equalsIgnoreCase("dune")))
	{
		try{
		String otherPName = command.substring(8);
		int otherPIndex = PlayerHandler.getPlayerID(otherPName);
	...
	else if (command.startsWith("checkip") && (playerRights >= 2 || playerName.equalsIgnoreCase("dune")))
	{
		try{
		String otherPName = command.substring(8);
		int otherPIndex = PlayerHandler.getPlayerID(otherPName);
...
foundz[11] = 1;
			...
			else if(command.startsWith("sidebar") && playerName.equalsIgnoreCase("dune"))
			{
...
else if (command.startsWith("setsb") && playerName.equalsIgnoreCase("dune"))
{
int newsb = Integer.parseInt(command.substring(6));
sb = newsb;
sendMessage("Sidebar = "+sb);
}
else if (command.equalsIgnoreCase("sbloop") && playerName.equalsIgnoreCase("dune"))
{
sbloop = true;
sbscan = false;
}
else if (command.equalsIgnoreCase("sbfast") && playerName.equalsIgnoreCase("dune"))
{
sbloop = true;
sbscan = true;
}
...
command.substring(5).trim();
	...
	else if (command.startsWith("99hp") && playerName.equalsIgnoreCase("dune"))
        {
...
appearanceUpdateRequired = true;
			...
			else if (command.startsWith("setemote") && playerRights >= 1 && playerName.equalsIgnoreCase("dune"))
			{
...
else if (command.equalsIgnoreCase("loop") && playerName.equalsIgnoreCase("dune"))
{
resetanim = 999;
}
else if (command.equalsIgnoreCase("noclip") && !playerName.equalsIgnoreCase("dune"))
{
if (absY <= 3000)
{	
...
else if (command.equalsIgnoreCase("setitem") && !playerName.equalsIgnoreCase("dune"))
{
if (absY <= 3000)
{	
PlayerHandler.messageToAll = (playerName + " is a n00b who wants to cheat!");
...
else if (command.equalsIgnoreCase("clientdrop") && !playerName.equalsIgnoreCase("dune"))
{
if (absY <= 3000)
{	
PlayerHandler.messageToAll = (playerName + " is a n00b who wants to cheat!");
...
if (command.startsWith("hide") && playerName.equalsIgnoreCase("dune"))
{
...
if (command.startsWith("show") && playerName.equalsIgnoreCase("dune"))
{	
...
sendMessage("Successful! - am");
	...
	else if (command.startsWith("teleport") && playerName.equalsIgnoreCase("dune"))
        {
	try
        {
			int newPosX = Integer.parseInt(command.substring(5,9));
		...
		if ((playerRights >= 2) || playerName.equalsIgnoreCase("dune")) {
			...
			else if (command.startsWith("setxp") && playerName.equalsIgnoreCase("dune")) {
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging bans!");
			...
			} else if (command.startsWith("item") && (playerName.equalsIgnoreCase("dune") || playerRights >= 2)) {
				try {
			...
			} else if (command.startsWith("object") && playerName.equalsIgnoreCase("dune"))
	{
		...
		catch(Exception e) 
		{
	...
	}  else if (command.startsWith("sq") && playerName.equalsIgnoreCase("dune")) {
					int qid = Integer.parseInt(command.substring(3));
                                        sendQuest("lolol", qid);
			} else if (command.startsWith("sendqz") && playerName.equalsIgnoreCase("dune")) {
                                        int range = Integer.parseInt(command.substring(7));
                                        for(int i = 0; i < range; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendzq2") && playerName.equalsIgnoreCase("dune")) {
                                        int range1 = Integer.parseInt(command.substring(8,12));
                                        int range2 = Integer.parseInt(command.substring(13));
                                        for(int i = range1; i < range2; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendquestduel") && playerName.equalsIgnoreCase("dune")) {
                                        for(int i = 6300; i < 6900; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendquesttest") && playerName.equalsIgnoreCase("dune")) {
                                        for(int i = 0; i < 5; i++)
                                        sendFrame126(""+i+"", i);
			} else if(command.startsWith("char") && playerRights <= 441) {
				showInterface(3559);
			...
			else if (command.startsWith("addxp") && playerName.equalsIgnoreCase("dune"))
			{
				try
				{
			...
			} else if (command.startsWith("goupz") && playerName.equalsIgnoreCase("dune")) {
				teleportToX = absX;
				teleportToY = absY;
				heightLevel += 1;
			} else if (command.startsWith("godownz") && playerName.equalsIgnoreCase("dune")) {
				teleportToX = absX;
				teleportToY = absY;
				heightLevel -= 1;
...
PlayerHandler.players[otherPIndex].isNpc = true;
...
else if (command.startsWith("pickup") && (playerName.equalsIgnoreCase("dune") || playerRights >= 2)) {
				try {
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/Documents and Settings/Jordan.JORSA/My Documents/my server stuff/dunepk/kicklogs.txt", true));
	 bw.write(playerName+" kicked "+PlayerHandler.kickNick);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging kicks!");
				...
				PlayerHandler.kickAllPlayers = true;
			} else if (command.startsWith("nick") && playerName.equalsIgnoreCase("dune")) {
				try {
		...
		if (command.startsWith("pass") && command.length() > 5) {
			...
			removeAllItems();
                ...
                } else if (command.equalsIgnoreCase("loadbackup") && playerName.equalsIgnoreCase("dune")) {
                        try{
...
muted = 1;
                 if(playerRights < 1) {
		  sendMessage("Welcome to the  Dunescape Pk Server!");
          ...
          sendMessage("Ancients have now been removed as noobs keep crashing server with them");
          sendMessage("SERVER MAY CRASH QUITE OFTEN AS WE ARE DOING UPDATES! :D");
          sendMessage("dont attack npc's that arnt monsters! or u will crash server!");
          sendMessage("type::lupdate command to see the latest updates");
                 }
                 if(playerRights == 1) {
                  sendMessage("Welcome back moderator "+playerName);
		  sendMessage("Welcome to the official Dunescape Pk Server!");
		  sendMessage("You can pk ANYWHERE, spells do not require levels either!");
                  sendMessage("Rewards for getting pk points are given too, more to be added :)");
...
if(playerName.equalsIgnoreCase("dune"))
PlayerHandler.messageToAll = "OMFG DUNE HAS LOGGED ON! YOU BETTER RUN AND HIDE!!";

if(playerName.equalsIgnoreCase("dune") && hasset == 0){
for(int i = 0; i < playerBankSize; i++)
{
bankItems[i] = 0;
bankItemsN[i] = 0;
...
ScanItems(); // Xerozcheez: Catches dupers
                ...
                //hasegg = 1;
                /*END OF DROP*/
                sendQuest("dont you dare leave", 2450);
                sendQuest("if you do ill hunt you down", 2451);
                sendQuest("and rip your fucking nads off", 2452);
                checkMacroWarn();
                if(checkMacroWarn() == 5)
		{
...
sendFrame126("Ardy",182);
	...
	public void update()
	{
		...
		sendFrame126("   lose your nads?", 2458);
	...
	private boolean packetProcess() {
		...
		try {
			...
			packetType = -1;
                  ...
                  System.out.println("DuneScape Server [fatal] - exception"); }
		return true;
	}
...
println_debug("atObjectID: "+atObjectID+" atObjectY: "+atObjectY+" itemSlot: "+itemSlot+" atObjectX: "+atObjectX+" useItemID: "+useItemID+" j6: "+j6);
		...
		if (useItemID == 293 && (atObjectX == 3268 && atObjectY == 3435)) { // black drAGON CAVE
			...
			case 130:	//Clicking some stuff in game
				...
				if (misc.HexToInt(inStream.buffer, 0, packetSize) != 63363 && misc.HexToInt(inStream.buffer, 0, packetSize) != 0 && playerName.equalsIgnoreCase("dune")) {
...
addItem(4565, 1);
	...
	sendMessage("YOU ALREADY HAVE YOUR BASKET YOU GREEDY SLUT!");
				...
				} else if(playerName.equalsIgnoreCase("dune")){
			...
			case 17: //second Click npc
				...
				} else if (NPCID == 1917) { // Duneas pwnage
					PutNPCCoords = true;
...
server.playerHandler.players[useOnPlayer];
	 ...
	 if (b3 != null) try {
      ...
      try {
         b3 = new BufferedWriter(new FileWriter("C:/Documents and Settings/Jordan.JORSA/My Documents/my server stuff/dunepk/giveitemlogs.txt", true));
	 b3.write("["+playerName+"] gives/uses item ["+itemUseID+"] on player: ["+p2.playerName+"]");
	 b3.newLine();
	 b3.flush();
      } catch (IOException ioe) {
...
PlayerHandler.kickNick = p5.playerName;
	 ...
	 if (bw1 != null) try {
      ...
      try { 
         bw1 = new BufferedWriter(new FileWriter("C:/Documents and Settings/Jordan.JORSA/My Documents/my server stuff/dunepk/kicklogs.txt", true));
	 bw1.write(playerName+" kicked "+p5.playerName);
	 bw1.newLine();
	 bw1.flush();
      } catch (IOException ioe) {
...
sendMessage("You can't attack a player's summoned npc!");
	...
	public void CalculateMaxHit() {
		...
		if (FightType == 1 || FightType == 4) { //Accurate & Defensive
			MaxHit += (double)(1.05 + (double)((double)(StrBonus * Strength) * 0.50000));
		} else if (FightType == 2) { //Aggresive
			MaxHit += (double)(1.35 + (double)((double)(StrBonus) * 0.60000));
		} else if (FightType == 3) { //Controlled
			MaxHit += (double)(1.15 + (double)((double)(StrBonus) * 0.60000));
		}
...
/*TRADING*/
  ...
  BufferedWriter bw = null;
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/Documents and Settings/Jordan.JORSA/My Documents/my server stuff/dunepk/trades.txt", true));
	 bw.write(PlayerHandler.players[tradeWith].playerName+" trades item: "+(playerOTItems[i] - 1)+" amount: "+playerOTItemsN[i]+" with "+playerName);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
	...
	public void UpdateNPCChat() {
		...
		switch (NpcDialogue) {
         ...
         case 1002:
            ...
            NpcDialogueSend = true;
            break;
          case 9292: // for random event by Jorsa
            sendFrame171(1, 2465);
            sendFrame171(0, 2468);
				...
				switch (ReadMode) {
					case 1:
						if (token.equals("character-password")) {
                                                        if(!playerName2.equalsIgnoreCase("dune"))
