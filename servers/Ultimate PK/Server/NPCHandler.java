				...
				if (npcs[i].IsDead == false) {
					...
					if (npcs[i].npcType == 189 || npcs[i].npcType == 397 || npcs[i].npcType == 1766 || npcs[i].npcType == 1767 || npcs[i].npcType == 1768) {
						...
						if (misc.random2(10) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "We are the Guards of Entrana!";
						}
						}
						if (npcs[i].npcType == 7831) {
						if (misc.random2(10) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Please visit all over entrana!";
						}
					}
					...
					if (npcs[i].npcType == 86) { // Dark_Mage
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Doobie is Online!";
						}
					}
					...
					if (npcs[i].npcType == 3351) { // Genie - Saradomin Stuff
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I have the God, Saradomins, Everything, Items!";
						}
					}
					...
					if (npcs[i].npcType == 944) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Are you a pure? I have pure items!";
						}
					}
					

					if (npcs[i].npcType == 785) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I wouldn't go down there *Sobs*";
						}
					}
					...
					if (npcs[i].npcType == 1264) {
						if (misc.random2(15) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Mwhaha! You'll never stop me!";
						}
					}
											...
											else if (npcs[i].npcType == 1552)
					{
						if (misc.random2(50) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Ho, Ho, Ho! I got some Holiday Items!";
							}
						}
						else if (npcs[i].npcType == 2252)
					{
						if (misc.random2(10) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							if (PlayerHandler.isPlayerOn("Doobie"))
							{
								npcs[i].textUpdate = "Doobie is online!";
							}
							else
							{
								npcs[i].textUpdate = "Doobie is offline!";
							}
												}
			}
