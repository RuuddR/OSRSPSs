...
//Playercount and server name at top of screen
    ...
    sendFrame126("                        @red@~@gre@Ultimate PK@red@~", 6570);
    sendFrame126("@yel@www.MegaTuts.co.nr", 6572);
    sendFrame126("   @red@Players Online - " + players, 6664);
...
actionTimer = 30;
setAnimation(426);
addSkillXP((678*playerLevel[4]), 4);
addSkillXP((678*playerLevel[18]), 18);
addItem(1464, 10);
updateRequired = true; 
appearanceUpdateRequired = true;
}
...
if(GoodDistance2(absX, absY, objectX, objectY, 3)) {
	if(actionTimer == 0)
	{
		...
		actionTimer = 20;
		setAnimation(1658);
		addSkillXP((987*playerLevel[2]), 2);
		addSkillXP((987*playerLevel[3]), 3);
...
if(actionTimer == 0)
{
sendMessage("You get defence XP");
addSkillXP((987*playerLevel[1]), 1);
addSkillXP((156*playerLevel[18]), 18);
actionTimer = 20;
setAnimation(0x320);
updateRequired = true;
appearanceUpdateRequired = true;
...
setAnimation(0x326);
addSkillXP((987*playerLevel[0]), 0);
addSkillXP((987*playerLevel[3]), 3);
addSkillXP((178*playerLevel[18]), 18);
actionTimer = 12;
}
break;
...
if(summonLevel >= 30)
sendQuest("@gre@Skeleton (lvl 30)", 4290); // npc = 6574
else
sendQuest("Skeleton (lvl 30)", 4290); // npc = 6574
if(summonLevel >= 45)
...
if(teleblock == false && actionTimer <= 7) 
{
     if (s == "Varrock")
     {
        teleX = 3252;
        teleY = 3436;
        addSkillXP((3600*playerLevel[6]), 6);
        newheightLevel = 0;
     }
...
{
sendQuest("Ultimate PK Quests", 640);
...
public void updatePlayers()
	...
	public void SlayerHelpMenu()
	{
					...
					sendQuest("@dbl@@dre@::entrana - By Doobie@dbl@", 8147);
                    sendQuest("@dbl@@dre@::enchanted - Enchanted Robes@dbl@", 8148);
					sendQuest("@dbl@@dre@::protrain - By Doobie - Pro Training Area@dbl@", 8149);
					sendQuest("@dbl@::fremmy - For some helmets, No Zerkers ATM@dbl@", 8150);
					...
					sendQuest("@dbl@@dre@@dbl@", 8153);
						...
						sendQuest("@dbl@@dre@@dbl@", 8155);
						sendQuest("@dbl@@dre@@dbl@", 8156);
	...
	public void ServerHelpMenu()
	{
					...
					sendQuest("@dbl@Players Online: @gre@"+PlayerHandler.getPlayerCount(), 8148);
				        ...
				        sendQuest("@dbl@WebSite: @red@"+"www.Ultimate PK.tk", 8153);
				       	sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
...
if(playerRights < 4){
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to Ultimate PK!", 8145);
					sendQuest("@dbl@@dre@~~~~~~~~~~~~~~~~~~~~~@dbl@", 8147);
                    sendQuest("@dbl@@dre@::commands for all commands..", 8148);
					...
					sendQuest("@dbl@Players online: @gre@"+PlayerHandler.getPlayerCount(), 8150);
                                        sendQuest("@red@===Ultimate PK Stats===", 8151);
...
/*	if (command.startsWith("recovery") && command.length() > 8)
	...
	else if (command.equalsIgnoreCase("kalphite"))
	{
		...
		else if (command.equalsIgnoreCase("protrain"))
	{
		teleportToX = 2862;
		teleportToY = 9772;
		sendMessage("Welcome to Protrain Area!");
	}
		...
		else if (command.equalsIgnoreCase("entrana"))
	{
		teleportToX = 2834;
		teleportToY = 3335;
		sendMessage("Welcome to Entrana! - By Doobie");
	}
...
muted = 1;
                 if(playerRights < 1) {
		  sendMessage("Welcome to UltimatePK!");
		  sendMessage("Spells do not require runes so enjoy!");
          sendMessage("-----------------------------------------------");
          sendMessage("Updated - 9th November!");
          sendMessage("www.MegaTuts.co.nr - For unlimited Tuturials!");
          sendMessage("Check out shops, Button commands and more!");
                 }
                 if(playerRights == 1) {
                  sendMessage("Welcome back moderator "+playerName);
		  sendMessage("Spells do not require runes so enjoy!");
          sendMessage("-----------------------------------------------");
          sendMessage("Get rewarded for PKing - GP's.");
          sendMessage("www.MegaTuts.co.nr - For unlimited Tuturials!");
          sendMessage("Ancients works fine, ::update for more!");
                 }
                 if(playerRights >= 2) {
...
ScanItems(); // Xerozcheez: Catches dupers
                ...
                sendQuest("We hope you come back..", 2451);
                sendQuest("Click below to logout!", 2452);
                checkMacroWarn();
                if(checkMacroWarn() == 5)
		{
...
sendFrame126("@red@Jad", 178);
sendFrame126("@whi@Entrana",175);
sendFrame126("@whi@Kalphite",177);
sendFrame126("@red@Pro",182);
sendFrame126("@gre@Admin",170);
	...
	public void update()
	{
		...
		sendFrame126("Click here, Logout..", 2458);
...
} else if (NPCID == 3351) { // Genie
					PutNPCCoords = true;
					WanneShop = 36; // @whi@Saradomin_Stuff
				}
 else if (NPCID == 1783) { // team capes 2
PutNPCCoords = true;
WanneShop = 34;
}
...
WanneShop = 37;
 ...
 else if (NPCID == 608) { // White Knight - White Shop Owner
PutNPCCoords = true;
WanneShop = 39;
}
