...
//			dagger			axe			mace			medium			sword			dart tips		nails				arrow heads		scimitar		long sword		full helmet		knives			square			warhammer		battle axe		chain			kite		claws				2-handed		skirt			legs			body				lantern/wire		studs
    ...
    static {
        ...
        try {
            ...
            Bot.log("Critical error while loading stackabledata! Trace:");
            e.printStackTrace();
        }
        ...
        try {
            ...
            Bot.log("Critical error while loading notedata! Trace:");
            e.printStackTrace();
        }
        ...
        try {
            ...
            Bot.log("Critical error while loading twohanded! Trace:");
            e.printStackTrace();
        }
        ...
        try {
            ...
            Bot.log("Critical error while loading tradeable! Trace:");
            e.printStackTrace();
        }
        ...
        try {
            ...
            Bot.log("Critical error while loading sellable! Trace:");
            e.printStackTrace();
        }
    }
