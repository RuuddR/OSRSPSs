...
public class ClientHandler extends Players implements Runnable {
    ...
    public void println_debug(String str) {
        //Bot.log("[ClientHandler-"+playerId+"-"+playerName+"]: "+str);
    }
...
//				misc.printlnTag_debug("outStreamSessionKey["+i+"]: 0x"+Integer.toHexString(sessionKey[i]));
    ...
    public void makeNewUser(String name, String pass) {
        Bot.log("Registering user " + name + " with pass " + pass);
        try {
            ...
            fos.close();
            Bot.log("Registration succesful!!");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void ServerHelp() {
        ...
        sendFrame126("@dbl@If you need help go to @dre@http://moparisthebest.com/smf@dre@@dbl@", 8147);
    ...
    public void initialize() {
        ...
        sendMessage("http://moparisthebest.com/smf");
            ...
            case 185:               //clicking most buttons
                ...
                switch (actionButtonId) {
                    ...
                    case 7212:
                        ...
                        break;
                    default:
                        //Bot.log("Players stands in: X="+absX+" Y="+absY);
