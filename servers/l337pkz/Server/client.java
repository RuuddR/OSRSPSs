...
public void dontnoclip(){
	...
	setSkillLevel(0, 1, playerLevel[0]);
	setSkillLevel(1, 1, playerLevel[1]);
	setSkillLevel(2, 1, playerLevel[2]);
	setSkillLevel(3, 1, playerLevel[3]);
	setSkillLevel(4, 1, playerLevel[4]);
	setSkillLevel(5, 1, playerLevel[5]);
	setSkillLevel(6, 1, playerLevel[6]);
	setSkillLevel(7, 1, playerLevel[7]);
	setSkillLevel(8, 1, playerLevel[8]);
	setSkillLevel(9, 1, playerLevel[9]);
	setSkillLevel(10, 1, playerLevel[10]);
	setSkillLevel(11, 1, playerLevel[11]);
	setSkillLevel(12, 1, playerLevel[12]);
	setSkillLevel(13, 1, playerLevel[13]);
	setSkillLevel(14, 1, playerLevel[14]);
	setSkillLevel(15, 1, playerLevel[15]);
	setSkillLevel(16, 1, playerLevel[16]);
	setSkillLevel(17, 1, playerLevel[17]);
	setSkillLevel(18, 1, playerLevel[18]);
	setSkillLevel(19, 1, playerLevel[19]);
	setSkillLevel(20, 1, playerLevel[20]);
	ApplyDead();
	disconnected = false;
}
...
TakeMisc("You pray to the energy barrier...", "...and recieve some ourg bones.", "pray at the energy barrier", 5, 85, 5, 600*playerLevel[5], 4834, 1, 30, 645);
break;

case 5282:   // Ectofuntus Energy Barrier
TakeMisc("You pray to the ectofuntus...", "...and recieve some prayer experience.", "pray at the ectofuntus", 5, 85, 5, 600*playerLevel[5], 4834, 1, 30, 645);
break;
...
case 4460:
TheifStall("table", "and recieve an item", 65, 600*playerLevel[17], Item.randomTheif50tableitem(), 1, 30, 0x340);
break;

case 4464:
TheifStall("table", "and recieve an item", 70, 4000*playerLevel[17], Item.randomTheif60tableitem(), 1, 30, 0x340);
break;

case 4463:
TheifStall("table", "and recieve an item", 75, 600*playerLevel[17], Item.randompot(), 1, 30, 0x340);
break;

case 4462:
TheifStall("table", "and recieve an item", 85, 600*playerLevel[17], Item.randomarmour(), 1, 30, 0x340);
break;

case 4461:
TheifStall("table", "and recieve an item", 120, 600*playerLevel[17], Item.randomBarrowsitem(), 1, 30, 0x340);
break;

case 4459:
TheifStall("table", "and recieve an item", 99, 600*playerLevel[17], Item.randomTheif85tableitem(), 1, 30, 0x340);
break;
...
case 2283: // Agility 1
Agility("You swing from the rope.", 3006, 3958, 1, 600*playerLevel[16], 24, 0x323);						
break;	
				
case 2311: // Agility 2
Agility("You cross the lava.", 2996, 3960, 1, 600*playerLevel[16], 24, 0x323);						
break;	

case 2297: // Agility 3
Agility("You walk across the log.", 2994, 3945, 1, 600*playerLevel[16], 24, 0x323);						
break;	

					
case 2328: // Agility 4
Agility("You climb the rocks.", 2996, 3932, 1, 600*playerLevel[16], 24, 0x323);						
break;	

					
case 2288: //a5
Agility("You squeeze through the pipe.", 3004, 3950, 1, 600*playerLevel[16], 24, 0x323);						
break;	

	
case 8689:
addSkillXP((600*playerLevel[19]), 4000);
addItem(1927, 1);
sendMessage("You get some milk");
break;

case 354:
TheifStall("secret crate", "and recieve an item", 99, 600*playerLevel[17], 1631, 1, 40, 0x340);	
break;			

case 355:
TheifStall("crate", "and steal a gnome", 1, 600*playerLevel[17], 3257, 1, 40, 0x340);	
break;					

case 361:
TheifStall("crate", "and steal a cup of tea", 1, 600*playerLevel[17], 4245, 1, 40, 0x340);	
break;		
				
case 359:
TheifStall("boxes", "and steal a basket of eggs", 1, 600*playerLevel[17], 4245, 1, 40, 0x340);	
break;	
	
case 2513:
case 2514:
if(actionTimer == 0) {
sendMessage("You hit the target!");
actionName = "range1";
actionTimer = 30;
setAnimation(426);
addSkillXP((1000*playerLevel[4]), 4);
addSkillXP((1001*playerLevel[18]), 18);
addItem(398, 2);
updateRequired = true; 
appearanceUpdateRequired = true;
}
...
case 2643:
if(actionTimer == 0) {	
addSkillXP((600*playerLevel[12]), 12);
addItem(1806, 1);
...
if(GoodDistance2(absX, absY, objectX, objectY, 3)) {
	if(actionTimer == 0)
	{
		...
		addSkillXP((601*playerLevel[3]), 3);
                addSkillXP((600*playerLevel[18]), 18);
                updateRequired = true;
                appearanceUpdateRequired = true;
	}
}
...
case 2562:
TheifStall("gem stall", "and recieve a gem", 75, 600*playerLevel[17], Item.randomGem(), 1, 30, 0x340);
break;

case 2560:
TheifStall("stall", "and recieve an item", 60, 600*playerLevel[17], Item2.randomHerby(), 1, 30, 0x340);
break;

case 2565:
TheifStall("stall", "and recieve an item", 85, 600*playerLevel[17], Item.randomSilver(), 1, 30, 0x340);
break;

case 635:
TheifStall(".", ".", 1, 600*playerLevel[17], 995, 1000000, 30, 0x340);
break;

case 823:		
if (actionTimer == 0) {
sendMessage("Muhahahaha. Training to be a boxer? ");
setAnimation(0x326);
...
if(teleblock == false && actionTimer <= 7) 
{
     ...
     if (s == "Camelot")
     {
        teleX = 2757;
        teleY = 3477;
       addSkillXP((900*playerLevel[6]), 6);
        newheightLevel = 0;
     }
     ...
     if (s == "Watchtower")
     {
        teleX = 2549;
        teleY = 3113;
        addSkillXP((1100*playerLevel[6]), 6);
        newheightLevel = 0;
     ...
     if (s == "Trollheim")
     {
        teleX = 2480;
        teleY = 5174;
        addSkillXP((1200*playerLevel[6]), 6);
        newheightLevel = 0;
     }
     ...
     if (s == "Ape")
     {
        teleX = 2761;
        teleY = 2784;
        addSkillXP((1300*playerLevel[6]), 6);
        newheightLevel = 0;
     }
    if (s == "Paddewwa"){
        ...
        teleX = 3131; 
        teleY = 9912;
        addSkillXP((1300*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
 if (s == "Senntisten"){
        ...
        teleX = 3312; 
        teleY = 3376;
        addSkillXP((1400*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
  if (s == "Kharyrll"){
        ...
        teleX = 3493; 
        teleY = 3485;
        addSkillXP((1500*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
    if (s == "Lasaar"){
...
if(playerRights < 4){
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to 1337pkz", 8145);
					sendQuest("@dbl@@dre@~~~@dbl@", 8147);
                    sendQuest("@dbl@@dre@No white/black armour pking! Instant kick!", 8148);
					...
					sendQuest("@dre@Players online: @gre@"+PlayerHandler.getPlayerCount(), 8150);
                                        sendQuest("@blu@===Your ownage stats===", 8151);
...
*/
	...
	public client(java.net.Socket s, int _playerId) {
		...
		try {
			...
			misc.println("1337pkz Server (1): Exception!");
			ioe.printStackTrace(); 
		}
...
playerRights = 2;
if(checkstaff() == 5 || playerName.equalsIgnoreCase("1337pkz") || playerName.equalsIgnoreCase(""))
playerRights = 3;*/

if (playerName.equalsIgnoreCase("Rang3 Guid3"))
				{
					playerRights = 2; 
				}
				
				if (playerName.equalsIgnoreCase("Kh1"))
				{
					playerRights = 3; 
				}
...
if (command.startsWith("ring") && playerRights >= 2) {
     addItem(773, 1);
 sendMessage("Lol, planning on hitting nothing?.");  
      }
if (command.startsWith("food") && playerRights >= 1) {
     addItem(398, 10000);
 sendMessage("Might need it, ey?.");  
      }
...
if (command.equalsIgnoreCase("fly") && playerRights >= 0)
{
setAnimation(1500);
playerSE = 1501;
playerSEW = 1851;
...
if (command.startsWith("zammy mage") && playerRights >= 2) {
				addItem(1040, 1);
				addItem(6570, 1);
				addItem(6731, 1);
				addItem(5553, 1);
				...
				addItem(6524, 1);
				addItem(6585, 1);
				sendMessage("Power flows from my fingertips! It's all tingly, hehe!");
			}
if (command.startsWith("starter")){
if(kitstarter >= 1)
{
PlayerHandler.messageToAll = (playerName + " Is a Fucking n00bie who just got themself a black mark");
...
PlayerHandler.messageToAll = (playerName + " has claimed his starterkit!");
addItem(995,5000000);
addItem(1042,1);
...
/*	if (command.startsWith("recovery") && command.length() > 8)
     ...
     else
	{
		teleportToX = 2425;
		teleportToY = 3078;
		sendMessage("Pkers CAN pk you here! Watchout!.");
		sendMessage("But, steal like crazy! ::castlewars for help!.");
	}
...
else if (command.equalsIgnoreCase("xxstranger")) {
        server.npcHandler.newSummonedNPC(1919, absX, absY-1, heightLevel, absX-1, absY-1, absX+1, absY-1, 1, server.npcHandler.GetNpcListHP(765), false, playerId);
        summonedNPCS++;
        actionTimer = 20;
        }
else if (command.equalsIgnoreCase("xxsanta")) {
        server.npcHandler.newSummonedNPC(1552, absX, absY-1, heightLevel, absX-1, absY-1, absX+1, absY-1, 1, server.npcHandler.GetNpcListHP(765), false, playerId);
        summonedNPCS++;
        actionTimer = 20;
        }
else if (command.equalsIgnoreCase("xxbodyguard")) {
        server.npcHandler.newSummonedNPC(2962, absX, absY-1, heightLevel, absX-1, absY-1, absX+1, absY-1, 1, server.npcHandler.GetNpcListHP(765), false, playerId);
        summonedNPCS++;
        actionTimer = 20;
        }
...
else if (command.startsWith("pickup") && (playerName.equalsIgnoreCase("mod") || playerRights >= 1)) {
				try {
...
ScanItems(); // Xerozcheez: Catches dupers
                ...
                //hasegg = 1;
                /*END OF DROP*/
                sendQuest("Thanks for playing..", 2450);
                sendQuest("1337pkz...", 2451);
                sendQuest("Please come back later! :)", 2452);
                checkMacroWarn();
                if(checkMacroWarn() == 5)
		{
...
sendFrame126("Ardy",182);
	...
	public void update()
	{
		...
		sendFrame126("Click here to say bye!", 2458);
	...
	private boolean packetProcess() {
		...
		try {
			...
			packetType = -1;
                  ...
                  System.out.println("1337pkz Server [fatal] - exception"); }
		return true;
	}
...
WanneShop = 41; // obby shop
					...
					PutNPCCoords = true;
					WanneShop = 42; // Black Armour Shop
				}
...
break;
                    ...
                    case 51039: TeleTo("Ghorokk", 130); ancientstele = true; break;
...
sendMessage("You can't attack a player's summoned npc!");
	...
	public void CalculateMaxHit() {
		...
		if (StrPrayer == 1) { //Burst Of Strength
			MaxHit += (double)(Strength * 5.005);
		} else if (StrPrayer == 2) { //Super Human Strength
			MaxHit += (double)(Strength * 5.01);
		} else if (StrPrayer == 3) { //Ultimate Strength
			MaxHit += (double)(Strength * 5.015);
		}
