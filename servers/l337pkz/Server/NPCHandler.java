...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
if (PlayerHandler.isPlayerOn("zammy mage")){
npcs[i].textUpdate = "Owner zammy mage is Online! Wooo!";
}
else{
npcs[i].textUpdate = "Owner zammy mage is offline..damit";
}
}
}
if (npcs[i].npcType == 636) {
if (misc.random2(30) <= 3) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "We love 1337pkz!";
}
}
if (npcs[i].npcType == 636) {
if (misc.random2(30) <= 3) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "We love Zammy Mage so much!";
}
}
						...
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Tele to varrock"; //MADE 
						}
						}
						...
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Tele to varrock"; //BY
						}
						}
						...
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Tele to tzhaar caves"; //Zammy mage
						}
					}
					...
					if (npcs[i].npcType == 535) { // fairy - white armour shop keper
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Weapons here!";
						}
					}
					if (npcs[i].npcType == 209) { // nulodian - black armour shopkeeper
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "THANKS FOR JOINING!";
						}
					}
					...
					if (npcs[i].npcType == 1199) {
						...
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Tele to the monkey playboy mansion";
						}
					}
						...
						if (misc.random2(50) >= 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Welcome to 1337pkz";
						}
					}
						...
						if (misc.random2(50) >= 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Get ya Stuff here!";
						}
					}
											else if (npcs[i].npcType == 1552)
					{
						if (misc.random2(50) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "You believe in me. OMG";
							}
						}
						else if (npcs[i].npcType == 8724)
					{
						if (misc.random2(10) <= 5) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							if (PlayerHandler.isPlayerOn("zammy mage"))
							{
								npcs[i].textUpdate = "zammy mage is ONLINE :)";
							}
							else
							{
								npcs[i].textUpdate = "zammy mage is OFFLINE :(";
							}
												}
			}
					...
					if (npcs[i].actionTimer == 0 && npcs[i].DeadApply == false && npcs[i].NeedRespawn == false) {
						...
						npcs[i].actionTimer = 10;
  						...
  						MonsterDropItem(i);
						npcs[i].NeedRespawn = true; //COPYRIGHT
						...
						for (int j = 1; j < server.playerHandler.maxPlayers; j++) {
							if (server.playerHandler.players[j] != null) {
								server.playerHandler.players[j].RebuildNPCList = true; //JOSH MUST BE ADMIN
							}
						}
                                                if(npcs[i].Respawns) {
