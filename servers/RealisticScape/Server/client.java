...
Danieb
Miss Silabsoft
www.moparscape.com/smf
--Insert People I Forgot Here--
...
public class client extends Player implements Runnable
{
	...
	public void writePlayers()
	{
		...
		sendFrame126("@red@                     .-'@whi@RealisticScape@red@'-.", 6570);
	...
	public boolean Has2hWeapon()
	{
		int id = playerEquipment[playerWeapon];
		if (id == 1307 || id == 1309 || id == 1311 || id == 1313 || id == 1315 || id == 1317 || id == 1319 || id == 6609 || id == 7158 || id == 4718 || id == 4726 || id == 4747 || id == 4755)
		return true;
		return false;
	}
...
//Start Creating Magic Graphics
	public void createProjectile(int casterY, int casterX, int offsetY, int offsetX, int angle, int speed, int gfxMoving, int startHeight, int endHeight)
	{
		outStream.createFrame(85);
		outStream.writeByteC((casterY - (mapRegionY * 8)) - 2);
		outStream.writeByteC((casterX - (mapRegionX * 8)) - 3);
		outStream.createFrame(117);
		outStream.writeByte(angle); // Defines the starting position of the missile.
		outStream.writeByte(offsetY - (mapRegionX * 8)); // Destination of the missile relative the starting position.
		outStream.writeByte(offsetX - (mapRegionX * 8)); // OffsetX in relevance from the first player.
		outStream.writeWord(MageAttackIndex); // Makes sure the missle hits the opponent. If missleLockedOn is > 0, it uses NPC masterlist. Otherwise, it uses player masterlist.
		outStream.writeWord(gfxMoving); // Magic Moving Graphic ID
		outStream.writeByte(startHeight);// Cast Height or Start Height.
		outStream.writeByte(endHeight); // Height of the opponent.
		outStream.writeWord(51);
		outStream.writeWord(speed); // Missle Speed.
		outStream.writeByte(16);
		outStream.writeByte(64);
	}
//End Creating Magic Graphics
...
//Start Smithing
	...
	{
//Bronze
		if(removeID == 1205 || removeID == 1351 || removeID == 1103 || removeID == 1139 || removeID == 819 || removeID == 1277 || removeID == 1422 || removeID == 1075 || removeID == 1155 || removeID == 39 || removeID == 1321 || removeID == 1337 || removeID == 1087 || removeID == 1173 || removeID == 864 || removeID == 1291 || removeID == 1375 || removeID == 1117 || removeID == 1189 || removeID == 1307 || removeID == 3095 || removeID == 4819)
		{
			return 2349;
		}
//Iron
		if(removeID == 1203 || removeID == 1349 || removeID == 1420 || removeID == 1137 || removeID == 1279 || removeID == 820 || removeID == 4820 || removeID == 1323 || removeID == 40 || removeID == 1293 || removeID == 1153 || removeID == 863 || removeID == 1175 || removeID == 1335 || removeID == 1363 || removeID == 1101 || removeID == 4540 || removeID == 1191 || removeID == 3096 || removeID == 1309 || removeID == 1067 || removeID == 1081 || removeID == 1115)
		{
			return 2351;
		}
//Steel
		if(removeID == 1207 || removeID == 3097 || removeID == 1353 || removeID == 1424 || removeID == 1141 || removeID == 1281 || removeID == 1325 || removeID == 1295 || removeID == 1157 || removeID == 1177 || removeID == 1339 || removeID == 1365 || removeID == 1105 || removeID == 1193 || removeID == 1069 || removeID == 1083 || removeID == 1311 || removeID == 1119 || removeID == 1539 || removeID == 821 || removeID == 41 || removeID == 2 || removeID == 2370 || removeID == 865 || removeID == 4544)
		{
			return 2353;
		}
//Mith
		if(removeID == 1209 || removeID == 3099 || removeID == 1355 || removeID == 1428 || removeID == 1143 || removeID == 1285 || removeID == 1329 || removeID == 1299 || removeID == 1159 || removeID == 1181 || removeID == 1343 || removeID == 1369 || removeID == 1109 || removeID == 1197 || removeID == 1071 || removeID == 1085 || removeID == 1315 || removeID == 1121 || removeID == 822 || removeID == 4822 || removeID == 42 || removeID == 42 || removeID == 866)
		{
			return 2359;
		}
//Addy
		if(removeID == 1211 || removeID == 3100 || removeID == 1430 || removeID == 1145 || removeID == 1287 || removeID == 1331 || removeID == 1301 || removeID == 1161 || removeID == 1183 || removeID == 1371 || removeID == 1111 || removeID == 1073 || removeID == 1091 || removeID == 1317 || removeID == 1123 || removeID == 823 || removeID == 4823 || removeID == 43 || removeID == 867 || removeID == 1199)
		{
			return 2361;
		}
//Rune
		if(removeID == 1213 || removeID == 3101 || removeID == 1432 || removeID == 1147 || removeID == 1289 || removeID == 1333 || removeID == 1303 || removeID == 1163 || removeID == 1185 || removeID == 1347 || removeID == 1373 || removeID == 1113 || removeID == 1201 || removeID == 1079 || removeID == 1093 || removeID == 1319 || removeID == 1127 || removeID == 824 || removeID == 4824 || removeID == 44 || removeID == 868)
		{
			return 2363;
		}
		return 0;
...
// Menus
	...
	{
		sendQuest("RealisticScape Quests", 640);
...
// Unknown ID
	...
	{
		sendQuest("@dre@Help Menu", 8144);  //Title
		clearQuestInterface();
		sendQuest("@bla@Welcome to RealisticScape", 8145);
		sendQuest("@dbl@Designed and Coded By:@dre@ Alexia@dbl@", 8147);
		sendQuest("@dbl@Original Source:@dre@ TestScape@dbl@", 8148);
		...
		sendQuest("@dbl@Reputation Points:@dre@ " +totalqp , 8150);
		sendQuest("@bla@Command List:", 8152);
		sendQuest("@whi@::appearance @whi@@dre@This changes your appearance.@dre@", 8153);
		sendQuest("@whi@::bank @whi@@dre@Lets you bank.@dre@", 8154);
		sendQuest("@whi@::rep NAME @whi@@dre@Gives a reputation point to someone.@dre@", 8155);
		sendQuest("@dre@*Must have at least 5 reputation before you can give@dre@", 8156);
		sendQuest("@dre@reputation points to others.*@dre@", 8157);
		sendQuest("@whi@::checkrep @whi@@dre@Tells you your current amount of reputation@dre@", 8158);
		sendQuest("@dre@points. *You can also look where it used to tell you your@dre@", 8159);
		sendQuest("@dre@quest points.*@dre@", 8160);
		sendQuest("@whi@::showrep NAME@whi@@dre@Tells you how many reputation points somebody@dre@", 8161);
		sendQuest("@dre@else has. *They must be logged on when you type this code.*@dre@", 8162);
		sendQuest("@whi@::yell MESSAGE @whi@@dre@Tells everyone a message you send.@dre@", 8163);
		sendQuest("@whi@::varrock @whi@@dre@Teleports you to the Varrock square.@dre@", 8164);
		sendQuest("@whi@::falador @whi@@dre@Teleports you to the center of Falador.@dre@", 8165);
		sendQuest("@whi@::wildtrain @whi@@dre@A good place for low levels to train.@dre@", 8166);
		sendQuest("@whi@::druidcircle @whi@@dre@Teleports you to the Druid Circle in@dre@", 8167);
		sendQuest("@dre@north-Travlery.@dre@", 8168);
		sendQuest("@whi@::druidtrain @whi@@dre@Teleports you to the center of the@dre@", 8169);
		sendQuest("@dre@Travlery Druids.@dre@", 8170);
		sendQuest("@whi@::duel @whi@@dre@Teleports you to the duel arena.@dre@", 8171);
		sendQuest("@whi@::empty @whi@@dre@Clears your inventory.@dre@", 8172);
		sendQuest("@whi@::farm1 @whi@@dre@Takes you to a place to start farming.@dre@", 8173);
		sendQuest("@whi@::female @whi@@dre@Turns you into a female.@dre@", 8174);
		sendQuest("@whi@::male @whi@@dre@Turns you into a male.@dre@", 8175);
		sendQuest("@whi@::fish @whi@@dre@Teleports you to the fountain in east-Varrock.@dre@", 8176);
		sendQuest("@whi@::startmine1 @whi@@dre@A good place to mine.@dre@", 8177);
		sendQuest("@whi@::minerune @whi@@dre@Teleports you to the rune rocks in the wilderness.@dre@", 8178);
		sendQuest("@whi@::playerkill @whi@@dre@Teleports you to the Greater Demons by the@dre@", 8179);
		sendQuest("@dre@King Black Dragon ladder.@dre@", 8180);
		sendQuest("@whi@::spiderhill @whi@@dre@Teleports you to the Spider Hill in the wilderness.@dre@", 8181);
		sendQuest("@whi@::runecraft @whi@@dre@Takes you to a good place to Runecraft.@dre@", 8182);
		sendQuest("@whi@::pass @whi@@dre@ Sets a new password for your account.@dre@", 8183);
		sendQuest("@whi@::crystalchest @whi@@dre@ Teleports you to the crystal chest.@dre@", 8184);
		sendQuest("@whi@::travlerydungeon @whi@@dre@ Teleports you to the Travlery Dungeon.@dre@", 8185);
		sendQuest("@whi@::whiteknight @whi@@dre@ Teleports you to the White Knights.@dre@", 8186);
		sendQuest("@bla@Other Menus:", 8188);
		sendQuest("@whi@::help @whi@@dre@Returns you to this menu.@dre@", 8189);
		sendQuest("@bla@Staff:", 8190);
		sendQuest("@dbl@Owner:@dre@ Alexia", 8191);
		sendQuest("@dbl@Admins:@dre@ Alexia, Rich, Muren", 8192);
		sendQuest("@dbl@Player Mods:@dre@ --", 8193);
		sendQuestSomething(8143);
		showInterface(8134);
		flushOutStream();
	}
	...
	public void disclaimer()
	{
		...
		sendQuest("@bla@I, Owner of RealisticScape, am not responsible for the", 8150);
		...
		sendQuest("@bla@I, Owner of RealisticScape, am not responsible for the", 8159);
		...
		sendQuest("@bla@Article Four: Basic Rules of RealisticScape", 8171);
		...
		sendQuest("@bla@on RealisticScape. If you find a bug please report", 8177);
		sendQuest("@bla@it to a Gold Crowned player or Me, Alexia.", 8178);
		sendQuest("@bla@Rule 3: Do not complain about things that", 8179);
		sendQuest("@bla@RealisticScape does not have (i.e. Spawning).", 8180);
	...
	public void SlayerHelpMenu()
	{
		...
		sendQuest("@dbl@@dre@Requirements: 99 slayer@dbl@", 8162);
	...
	public void FishingHelpMenu()
	{
		...
		sendQuest("@dbl@Big Fishing net fishes bass.@dbl@", 8155);
		sendQuest("@dbl@To get fishing equipment, please type ::tools.@dbl@", 8156);
		sendQuestSomething(8143);
		showInterface(8134);
		flushOutStream();
	}
	...
	public void runecraftHelp()
	{
		...
		clearQuestInterface();
		sendQuest("@blu@To start use the @red@::runecraft@blu@ command to", 8147);
		sendQuest("@blu@be teleported to the abyss. Then, click the @red@air rift@red@", 8148);
		sendQuest("@blu@to go to the @red@air altar@. Once there, use @red@Rune Essence@red@ on", 8149);
		sendQuest("@blu@the @red@air altar@red@.", 8150);
		sendQuest("@whi@YOU DO NOT NEED TALISMANS AT THIS MOMENT!", 8152);
		sendQuestSomething(8143);
		showInterface(8134);
		flushOutStream();
	}
	...
	public void combatMenu()
	{
		...
		sendQuest("@bla@FightType@cya@. NPC's are located all over RealisticScape!", 8149);
		sendQuestSomething(8143);
		showInterface(8134);
		flushOutStream();
	}
...
// Start Skill Voids
	public void Woodcutting()
	{
		...
		{
			addSkillXP((120*playerLevel[8]),8);
			addItem(1515, 1);
		}
		...
		{
			addSkillXP((180*playerLevel[8]),8);
			addItem(1513, 1);
		}
	...
	public void Mining() // 2090-2111 2119-2140 2704 3042 3043 3431 4676 6943-6948
	{
		...
		if (actionName.equalsIgnoreCase("minelimestone"))
		{
		...
		{
			addSkillXP((70*playerLevel[14]),14);
			addItem(440, 1);
		}
		...
		{
			addSkillXP((800*playerLevel[14]),14);
			addItem(449, 1);
		}
	...
	public void hitdoor()
	{
		addSkillXP((4*playerLevel[2]), 2);
		addSkillXP((1*playerLevel[3]), 3);
	}
	...
	{
		addSkillXP((80*playerLevel[17]), 17);
		addItem(3257, 1);
	}

	public void theving3()
	{
		addSkillXP((120*playerLevel[17]), 17);
		addItem(4245, 1);
	}
...
// End Bones and Food
	...
	public client(java.net.Socket s, int _playerId)
	{
		...
		{
			misc.println("RealisticScape Server (1): Exception!");
			ioe.printStackTrace(); 
		}
	...
	{
		if(mySock == null) return; // Already Shut Down
		try
		{
...
// Start Mod/Admin/Owner List / 1 = Mod / 2 = Admin / 3 = Admin/Owner
			if (playerName.equalsIgnoreCase("Alexia"))
			{
				playerRights = 3;
			}
			else if (playerName.equalsIgnoreCase("Rich"))
			{
				playerRights = 2;
			}
// End Mod/Adming/Owner List
	...
	{
		sendFrame126("@dre@RealisticScape Helpmenu", 8144); //Helpmenu title
		clearQuestInterface();
		sendFrame126("", 8145);
		sendFrame126("@dbl@Welcome to @dre@RealisticScape@dre@ Helpmenu@dbl@", 8146);
		sendFrame126("@dbl@If you need help go to @dre@http://z10.invisionfree.com/RealisticScape@dre@@dbl@", 8147);
...
// Start Commands
		...
		else if (command.startsWith("alexia"))
		{
			sendMessage("You now have a fabolous new look..."); 
			playerLook[0]=1;
			pHead=48;
			pTorso=60;
			pArms=61;
		...
		else if (command.startsWith("smithbronze"))
		{
			addItem(2350,20);
			addItem(1266,1);
			sendMessage("This should get you started.");
		}
		else if (command.startsWith("switchmagic") && command.length() > 6)
		{
		...
		else if (command.equalsIgnoreCase("kalphitequeen"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		...
		else if (command.equalsIgnoreCase("kingblackdragon"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		...
		else if (command.equalsIgnoreCase("tzhaar"))
		{
			teleportToX = 2446;
			teleportToY = 5178;
			sendMessage("Welcome the Tzhaar city!");
			sendMessage("Enjoy your visit");
		}
		else if (command.equalsIgnoreCase("playerkill"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		...
		else if (command.equalsIgnoreCase("chaoselemental"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		...
		else
		{
			...
			heightLevel = 0;
			inwildy = false;
			sendMessage("Run Away!");
		}
		else if (command.equalsIgnoreCase("druidtrain"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		...
		else if (command.equalsIgnoreCase("druidcircle"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		else
		{
			...
			teleportToY = 3485;
			heightLevel = 0;
			sendMessage("Welcome to the druid circle.");
		}
		else if (command.equalsIgnoreCase("travlerydungeon"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		else
		{
			...
			teleportToY = 9798;
			inwildy = false;
			sendMessage("Welcome to the Travely Cave.");
		}
		else if (command.equalsIgnoreCase("travlerydungeon2"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		...
		else if (command.equalsIgnoreCase("runecraft"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		else
		{
			teleportToX = 3039;
			teleportToY = 4856;
			sendMessage("Welcome to the Runecrafting area!");
		}
		else if (command.equalsIgnoreCase("varrtrain"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		...
		else if (command.equalsIgnoreCase("spiderhill"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		else
		{
			...
			teleportToY = 3887;
			heightLevel = 0;
			sendMessage("Creepy, eh?");
		}
		else if (command.equalsIgnoreCase("whiteknight"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
		...
		else if (command.equalsIgnoreCase("getout"))
		{
			teleportToX = 3216;
			teleportToY = 3426;
			heightLevel = 0;
		}
		else if (command.equalsIgnoreCase("brimhavendungeon"))
		{
			teleportToX = 2713;
			teleportToY = 9564;
		}
		...
		else if(command.startsWith("appearance"))
		{
				showInterface(3559);
		}
		...
		else if (command.startsWith("yell") && command.length() > 5)
		{
			if(playerRights == 0)
			{
				PlayerHandler.messageToAll = playerName+" ("+totalqp+" Rep): "+command.substring(5);
			}
			if(playerRights == 1)
			{
				PlayerHandler.messageToAll = "Mod "+playerName+" ("+totalqp+" Rep): "+command.substring(5);
			}
			if(playerRights == 2)
			{
				PlayerHandler.messageToAll = "Admin "+playerName+" ("+totalqp+" Rep): "+command.substring(5);
			}
			if(playerRights == 3)
			{
				PlayerHandler.messageToAll = "Owner "+playerName+" ("+totalqp+" Rep): "+command.substring(5);
			}
		}
		...
		else if (command.equalsIgnoreCase("noclip"))
		{
			...
			else 
			{
				...
				sendMessage("Trying to cheat noob");
				sendMessage("Trying to cheat noob");
				PlayerHandler.messageToAll = (playerName + " is trying to use ::noclip :0");
				disconnected = true;
			}
		}
		if ((playerRights >= 2) || playerName.equalsIgnoreCase("Alexia"))
		{
		...
		else if (command.startsWith("object") && playerName.equalsIgnoreCase("Alexia"))
		{
			try
			{
		...
		else if (command.startsWith("guards"))
		{
		...
		else if (command.startsWith("mod") && playerRights == 3)
		{
			try
			{
		...
		else if (command.equalsIgnoreCase("reboot") && playerRights >= 2) // This will save all player profiles before logging them off.
		{
			PlayerHandler.kickAllPlayers = true;
		}
		else if (command.startsWith("addxp") && playerName.equalsIgnoreCase("Alexia"))
		{
			try
			{
		...
		else if (command.startsWith("goupone")) // Moves you up a height level.
		{
			teleportToX = absX;
			teleportToY = absY;
			heightLevel += 1;
		} 
		else if (command.startsWith("godownone")) // Moves you down a height level.
		{
			teleportToX = absX;
			teleportToY = absY;
			heightLevel -= 1;
	...
	public void initialize()
	{
		...
		if (logcount == 0)
		{
			...
			WriteBonus();
			Poisoned = false;
			PlayerHandler.messageToAll = playerName+" has just logged in.";
			sendMessage("Before playing please read ::disclaimer");
			sendMessage("Admins: Alexia, Rich, Chris");
			sendMessage("PLEASE DON'T ASK TO BECOME A PLAYER MOD OR ADMIN!!!");
			sendMessage("Type ::help for help!");
			sendMessage("Welcome to RealisticScape, "+playerName+"!");
			playerLastConnect = connectedFrom;
		}
		else if (logcount >=1 )
		{
			...
			sendMessage("PLEASE DON'T ASK TO BECOME A PLAYER MOD OR ADMIN!!!");
			sendMessage("Type ::help for help!");
			sendMessage("Welcome back to RealisticScape, "+playerName+"!");
			savemoreinfo();
		}
		for(int i = 0; i < playerBankSize; i++)
		{
		...
		sendQuest("To Leave RealisticScape,", 2450);
		sendQuest("click the logout button.", 2451);
		sendQuest("Thanks for playing.", 2452);
		if (playerName.equalsIgnoreCase("_"))
		{
			sendMessage("You have been caught cheating. You have one more chance.");
			sendMessage("If you are caught cheating again, your account may be");
			sendMessage("banned or reset.");
		}
	...
	public boolean process() // Being called regularily every 500ms
	{
		writePlayers();
		savecounter++;
		...
		if ((Has2hWeapon()) && (playerEquipment[playerShield] > 0))
		{
			remove(playerEquipment[playerShield], 3);
		}
		hpTimer -= 1;
		if(hpTimer < 0 && playerLevel[3] < getLevelForXP(playerXP[3]))
		{
			hpTimer = 70;
		}	
		if(hpTimer == 0 && playerLevel[3] < getLevelForXP(playerXP[3]))
		{
			playerLevel[3] += 1;
			addSkillXP(0, 3); // Makes HP Update Every Time You Heal
		}
		if (healingTimer > 0)
		{
			healingTimer -= 1;
...
//start quest 1 - invisible armour
...
//end quest 1 - invisible armour
		...
		if (actionName.equalsIgnoreCase("choptree") || actionName.equalsIgnoreCase("chopoak") || actionName.equalsIgnoreCase("chowillow") || actionName.equalsIgnoreCase("chopmaple") || actionName.equalsIgnoreCase("chopyew") || actionName.equalsIgnoreCase("chophollow") || actionName.equalsIgnoreCase("chopmagic") || actionName.equalsIgnoreCase("chopachey") || actionName.equalsIgnoreCase("chopevergreen"))
		{
			Woodcutting();
			actionName = "";
		}
		if (actionName.equalsIgnoreCase("mineclay") || actionName.equalsIgnoreCase("mineessence") || actionName.equalsIgnoreCase("minecopper") || actionName.equalsIgnoreCase("minetin") || actionName.equalsIgnoreCase("mineblurite") || actionName.equalsIgnoreCase("minelimestone") || actionName.equalsIgnoreCase("mineiron") || actionName.equalsIgnoreCase("mineiron") || actionName.equalsIgnoreCase("minesilver") || actionName.equalsIgnoreCase("minecoal") || actionName.equalsIgnoreCase("minegold") || actionName.equalsIgnoreCase("minegems") || actionName.equalsIgnoreCase("minemithril") || actionName.equalsIgnoreCase("mineadamant") || actionName.equalsIgnoreCase("minerunite") || actionName.equalsIgnoreCase("mineelemental"))
		{
			Mining();
			actionName = "";
		}
...
// Npc Talking
		...
		if (isKicked)
		{
			disconnected = true; outStream.createFrame(109);
		};
		...
		switch(packetType)
		{
			...
			case 192:
					...
					else if (lob  == 12599) // Varrock Founation X=3240,3435 item lobster pot slot 1
					{
						...
						{
							sendMessage("You need to be lvl 40 fishing to catch lobster.");
						}
						else
						{
							lob();
...
// Making Darts
					...
					else if(useItemID == 621 && atObjectID == 8926)
					{
                        sendMessage("You board the viking boat...");
                       	sendMessage("and travel back to Relleka.");
                       	deleteItem(621,getItemSlot(621), 1);
                       	teleportToX = 2620;
                       	teleportToY = 3685;
					}
// Bones to feathers
...
// Start Of Runecrafting
					else if (useItemID == 1436 && atObjectID == 2478) // Air Rune
					{
						sendMessage("You craft some air runes!");
						setAnimation(791);
						addItem(556,27);
						addSkillXP(50, 20);
					}
					else if (useItemID == 1436 && atObjectID == 2479) // Mind Rune
					{
						if((playerLevel[20]) < 5)
						{
								sendMessage("You need to be level 5 To Craft Mind Runes");
						}
						else if((playerLevel[20]) >= 5)
						{
							sendMessage("You craft some mind runes!");
							setAnimation(791);
							addItem(558,27);
							addSkillXP(80, 20);
						}
					}
					else if (useItemID == 1436 && atObjectID == 2480) // Water Runes
					{
						if((playerLevel[20]) < 7)
						{
							sendMessage("You need to be level 7 To Craft Water Runes");
						}
						else if((playerLevel[20]) >= 7)
						{
							sendMessage("You craft some water runes!");
							setAnimation(791);
							addItem(555,27);
							addSkillXP(100, 20);
						}
                    }
					else if (useItemID == 1436 && atObjectID == 2481) // Earth Runes
					{
						if((playerLevel[20]) < 11)
						{
							sendMessage("You need to be level 11 To Craft Earth Runes");
						}
						else if((playerLevel[20]) >= 11)
						{
							sendMessage("You craft some earth runes!");
							setAnimation(791);
							addItem(557,27);
							addSkillXP(120, 20);
						}
                   	}
					else if (useItemID == 1436 && atObjectID == 2482) // Fire Runes
					{
						if((playerLevel[20]) < 16)
						{
							sendMessage("You need to be level 16 To Craft Fire Runes");
						}
						else if((playerLevel[20]) >= 16)
						{
							sendMessage("You craft some fire runes!");
							setAnimation(791);
							addItem(554,27);
							addSkillXP(160, 20);
						}
					}
					else if (useItemID == 1436 && atObjectID == 2483) // Body Runes
					{
						if((playerLevel[20]) < 20)
						{
							sendMessage("You need to be level 20 To Craft Body Runes");
						}
						else if((playerLevel[20]) >= 20)
						{
							sendMessage("You craft some body runes!");
							setAnimation(791);
							addItem(559,27);
							addSkillXP(190, 20);
						}
					}
					else if (useItemID == 1436 && atObjectID == 2486) // Nature Runes
					{
						if((playerLevel[20]) < 50)
						{
							sendMessage("You need to be level 50 To Craft Nature Runes");
						}
						else if((playerLevel[20]) >= 50)
						{
							sendMessage("You craft some nature runes!");
							setAnimation(791);
							addItem(561,27);
							addSkillXP(220, 20);
						}
					}
					else if (useItemID == 1436 && atObjectID == 2485) // Law Runes
					{
						if((playerLevel[20]) < 60)
						{
							sendMessage("You need to be level 60 To Craft Law Runes");
						}
						else if((playerLevel[20]) >= 60)
						{
							sendMessage("You craft some law runes!");
							setAnimation(791);
							addItem(563,27);
							addSkillXP(300, 20);
						}
...
//Start Of Cooking
					else if(useItemID == 2134 && atObjectID == 2728) // Raw Rat Meat
					{
						sendMessage("You cook the raw rat meat.");
						addSkillXP((30*playerLevel[7]), 7);
						deleteItem(2134,getItemSlot(2134), 1);
						addItem(2142, 1);
					}
					else if(useItemID == 2138 && atObjectID == 2728) // Raw Chicken
					{
						sendMessage("You cook the raw chicken.");
						addSkillXP((30*playerLevel[7]), 7);
						deleteItem(2138,getItemSlot(2138), 1);
						addItem(2140, 1);
					}
					else if(useItemID == 2132 && atObjectID == 2728) // Raw Bear meat
					{
						sendMessage("You cook the raw bear meet.");
						addSkillXP((30*playerLevel[7]), 7);
						deleteItem(2132,getItemSlot(2132), 1);
						addItem(2142, 1);
					}
					else if(useItemID == 317 && atObjectID == 2728) // Raw shrimps
					{
						sendMessage("You cook the raw shrimps.");
						addSkillXP((30*playerLevel[7]), 7);
						deleteItem(317,getItemSlot(317), 1);
						addItem(315, 1);
					}
					else if(useItemID == 321 && atObjectID == 2728) // Raw Anchovies
					{
						sendMessage("You cook the raw anchovies.");
						addSkillXP((30*playerLevel[7]), 7);
						deleteItem(321,getItemSlot(321), 1);
						addItem(319, 1);
					}
					else if(useItemID == 327 && atObjectID == 2728) // Raw Sardine
					{
						sendMessage("You cook the raw sardine.");
						addSkillXP((40*playerLevel[7]), 7);
						deleteItem(327,getItemSlot(327), 1);
						addItem(325, 1);
					}
					else if(useItemID == 345 && atObjectID == 2728) // Raw Herring
					{
						if((playerLevel[7]) <= 4)
						{
							sendMessage("You need to be level 5 cooking to cook raw herring.");
						}
						else if((playerLevel[7]) >= 5)
						{
							sendMessage("You cook the raw herring.");
							addSkillXP((30*playerLevel[7]), 7);
							deleteItem(345,getItemSlot(345), 1);
							addItem(347, 1);
						}
					}
					else if(useItemID == 363 && atObjectID == 2728) // Raw Bass
					{
						if((playerLevel[7]) <= 42)
						{
							sendMessage("You need to be level 5 cooking to cook raw herring.");
						}
						else if((playerLevel[7]) >= 43)
						{
							sendMessage("You cook the raw bass.");
							addSkillXP((130*playerLevel[7]), 7);
							deleteItem(363,getItemSlot(363), 1);
							addItem(365, 1);
						}
					}
					else if(useItemID == 377 && atObjectID == 2728) // Raw Lobbies
					{
						if((playerLevel[7]) <= 39)
						{
							sendMessage("You need to be level 40 cooking to cook raw lobsters.");
						}
						else if((playerLevel[7]) >= 40)
						{
							sendMessage("You cook the raw lobster.");
							addSkillXP((80*playerLevel[7]), 7);
							deleteItem(377,getItemSlot(377), 1);
							addItem(379, 1);
						}
					}
					else if(useItemID == 383 && atObjectID == 2728) // Raw Shark
					{
						if((playerLevel[7]) <= 79)
						{
							sendMessage("You need to be level 80 cooking to cook shark.");
						}
						else if((playerLevel[7]) >= 80)
						{
							sendMessage("You cook the raw shark.");
							addSkillXP((120*playerLevel[7]), 7);
							deleteItem(383,getItemSlot(383), 1);
							addItem(385, 1);
						}
					}
					else if(useItemID == 395 && atObjectID == 2728) // Raw Sea Turtle
					{
						if((playerLevel[7]) <= 89)
						{
							sendMessage("You need to be level 90 cooking to cook sea turtles.");
						}
						else if((playerLevel[7]) >= 90)
						{
							sendMessage("You cook the raw sea turtle.");
							addSkillXP((210*playerLevel[7]), 7);
							deleteItem(395,getItemSlot(395), 1);
							addItem(397, 1);
						}
					}
					else if(useItemID == 389 && atObjectID == 2728) // Raw Manta Ray
					{
						if((playerLevel[7]) <= 97)
						{
							sendMessage("You need to be level 98 cooking to cook manta rays.");
						}
						else if((playerLevel[7]) >= 98)
						{
			...
			case 130:	//Clicking some stuff in game
					...
					if (misc.HexToInt(inStream.buffer, 0, packetSize) != 63363 && misc.HexToInt(inStream.buffer, 0, packetSize) != 0 && playerName.equalsIgnoreCase("Alexia"))
					{
			...
			case 155: //first Click npc
					...
					else if(playerName.equalsIgnoreCase("Alexia"))
					{
...
if (objectID == 7139)   // Air rift
				{
					...
					if (actionTimer == 0)
					{
                          ...
                          {
                               sendMessage("You have to wait before you can teleport.");
                          }                                          
				    }
			    }
	      	if (actionName.equalsIgnoreCase("airs"))
		{
			sendMessage("You teleport to the air rift.");
			teleportToX = 2845;
			teleportToY = 4832;
			actionName = "";
		}
		if (objectID == 7140)   // Mind rift
				{
					...
					if (actionTimer == 0)
					{
                          if((playerLevel[20]) < 5)
                          {
                               sendMessage("You need to be level 5 runecrafting to craft mind runes.");
                          }
	      ...
	      if (actionName.equalsIgnoreCase("mind"))
		{
			sendMessage("You teleport to the mind altar.");
			teleportToX = 2796;
			teleportToY = 4818;
			actionName = "";
		}
		if (objectID == 7137)   // Water rift
				{
					...
					if (actionTimer == 0)
					{
                          if((playerLevel[20]) < 7)
                          {
                               sendMessage("You need to be level 7 runecrafting to craft water runes.");
                          }
		...
		{
			sendMessage("You teleport to the water altar.");
			teleportToX = 2713;
			teleportToY = 4836;
			actionName = "";
		}
	if (objectID == 7129)   // Fire rift
				{
					...
					if (actionTimer == 0)
					{
                          if((playerLevel[20]) < 16)
                          {
                               sendMessage("You need to be level 16 runecrafting to craft fire runes.");
                          }
		...
		{
			sendMessage("You teleport to the fire altar.");
			teleportToX = 2584;
			teleportToY = 4836;
			actionName = "";
		}
...
if (objectID == 7131)   // Body rift
				{
					...
					if (actionTimer == 0)
					{
                          if((playerLevel[20]) < 20)
                          {
                               sendMessage("You need to be level 20 runecrafting to craft body runes.");
                          }
		...
		{
			sendMessage("You teleport to the body altar.");
			teleportToX = 2527;
			teleportToY = 4833;
			actionName = "";
		}
		if (objectID == 7133)   // Nature rift
				{
					...
					if (actionTimer == 0)
					{
                          if((playerLevel[20]) < 50)
                          {
                               sendMessage("You need to be level 50 runecrafting to craft nature runes.");
                          }
		...
		{
			sendMessage("You teleport to the nature altar.");
			teleportToX = 2398;
			teleportToY = 4841;
			actionName = "";
		}
		if (objectID == 7130)   // Earth rift
				{
					...
					if (actionTimer == 0)
					{
                          if((playerLevel[20]) < 11)
                          {
                               sendMessage("You need to be level 11 runecrafting to craft earth runes.");
                          }
		...
		if (objectID == 7135)   // Law rift
				{
					...
					if (actionTimer == 0)
					{
                          if((playerLevel[20]) < 60)
                          {
                               sendMessage("You need to be level 60 runecrafting to craft law runes.");
                          }
		...
		{
			sendMessage("You teleport to the law altar.");
			teleportToX = 2464;
			teleportToY = 4834;
			actionName = "";
		}
		...
		{
			sendMessage("You craft some runes.");
			addSkillXP((280*playerLevel[20]), 20);
			addItem(564, 27);
			actionName = "";
		}
...
if (objectID == 7141)   // Blood rift
		...
		{
			sendMessage("You craft some runes.");
			addSkillXP((450*playerLevel[20]), 20);
			addItem(566, 27);
			actionName = "";
		}
...
if (objectID == 7136)   // Death rift
		...
		{
			sendMessage("You craft some runes.");
			addSkillXP((420*playerLevel[20]), 20);
			addItem(560, 27);
			actionName = "";
		}
...
//QUEST_1 OBJECTS
				...
				if (objectID == 2430)
			{
				...
				if (objectID == 13)
			{
				sendMessage("You have left the goblin caves");
				teleportToX = 2622;
				teleportToY = 3392;
			}
				if (objectID == 2)
			{
				sendMessage("You have entered the goblin caves");
				teleportToX = 2620;
				teleportToY = 9796;
			}
				...
				if (objectID == 5103)
			{
				sendMessage("You cut the vines, theres no going back");
				teleportToX = 2689;
				teleportToY = 9564;
			}
				if (objectID == 5104)
			{
				...
				if (objectID == 5100)
			{
				sendMessage("You squeeze along the pipe, theres no going back");
				teleportToX = 2655;
				teleportToY = 9566;
			}
				if (objectID == 5110)
			{
				sendMessage("You jump the stepping stones, theres no going back");
				teleportToX = 2647;
				teleportToY = 9557;
			}
				if (objectID == 5106)
				...
				if (objectID == 5099)
			{
				...
				if (objectID == 5090)
			{
				sendMessage("You walk along the log, theres no going back");
				teleportToX = 2682;
				teleportToY = 9506;
			}
				if (objectID == 5105)
...
if (objectID == 8929)   // for more ids make it (objectID == ** || objectID == **)
                {
sendMessage("You enter the cave of horrors...");
teleportToX = 2442;
teleportToY = 10146;
                }
if (objectID == 8966)   // for more ids make it (objectID == ** || objectID == **)
                {
sendMessage("You crawl back to the surface...");
teleportToX = 2525;
teleportToY = 3739;
                }
if (objectID == 10177)   // for more ids make it (objectID == ** || objectID == **)
                {
sendMessage("You climb back to the surface...");
teleportToX = 2525;
teleportToY = 3739;
                }
if ((objectID == 8958) || (objectID == 8959) || (objectID == 8960))
{
sendMessage("You proceed further...");
sendMessage("But theres no turning back.");
				teleportToX = absX += 2;
				teleportToY = absY;
}
...
if ((objectID == 1568) || (objectID == 1569) || (objectID == 1570) || (objectID == 1571) ||
			  ...
			  if (objectID == 2466) // Mind Temple Portal
                          {
                          teleportToX = 3038;
                          teleportToY = 4845;
			  }
			  ...
			  if (objectID == 2473) // Nature Temple Portal
                          {
                          teleportToX = 3038;
                          teleportToY = 4845;
			  }
			  if (objectID == 2470) // Body Temple Portal
                          {
                          teleportToX = 3038;
                          teleportToY = 4845;
			  }
			  if (objectID == 2469) // Fire Temple Portal
                          {
                          teleportToX = 3038;
                          teleportToY = 4845;
			  }
			  if (objectID == 2468) // Earth Temple Portal
                          {
                          teleportToX = 3038;
                          teleportToY = 4845;
                          }
			  if (objectID == 2467) // Water Temple Portal
                          {
                          teleportToX = 3038;
                          teleportToY = 4845;
                          }
...
if (objectID == 2912)   // Legends quest ancient door, 2809,9332
				{
					...
					if (actionTimer == 0)
					{
                          if((playerLevel[18]) <= 98)
                          {
                               sendMessage("You need to be level 99 slayer to attack the ancient door.");
                          }

                          else if((playerLevel[18]) >= 99)
                          {
...
{
sendMessage("You are banned, sorry.");
}
...
/*Equipment level checking*/
	...
	public int GetCLDefence(int ItemID) {
		...
		} else if (ItemName.startsWith("Ahrims") ||  ItemName.startsWith("Karil") || ItemName.startsWith("Torag") || ItemName.startsWith("Verac") || ItemName.startsWith("Guthan") || ItemName.startsWith("Dharok")) {
				...
				switch (ReadMode) {
					case 1:
						if (token.equals("character-lastlogin")) {
						    ...
						    ancients = Integer.parseInt(token2);
						} else if (token.equals("character-logcount")) {
						    logcount = Integer.parseInt(token2);
