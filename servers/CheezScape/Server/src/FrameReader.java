 ...
 * Frame Reader
 *
 * Class for reading several datatypes from a frame.
 *
 */
 
import java.io.*;

public class FrameReader extends ByteArrayInputStream {

	public FrameReader(int t, byte b[]) {
		super(b);
		type = t;
	}

	public FrameReader(int t, int s, byte b[]) {
		super(b);
		type = t;
		size = s;
	}
