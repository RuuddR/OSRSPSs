...
public abstract class Player {	
  public int correctPin = 0; public int bankSet = 0;
	...
	public Player(int _playerId) {
		...
		//Giving the player a unique look, change the -1s to the ID of the item!
		playerEquipment[playerHat]=		-1;
		playerEquipment[playerCape]=		1052;
		playerEquipment[playerAmulet]=		1725;
		playerEquipment[playerChest]=		544;
...
*/
		...
		teleportToX = 3182;//3182;
		teleportToY = 3442;//3442;
