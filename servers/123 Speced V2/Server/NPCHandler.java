				...
				if (npcs[i].IsDead == false) {
					if (npcs[i].npcType == 1268 || npcs[i].npcType == 1266) {
						...
						AttackPlayer(i);
                                                ...
                                                if(npcs[i].npcType == 1645 || npcs[i].npcType == 1241 || npcs[i].npcType == 1246)
                                                AttackNPCMage(i);
                                                else                                                
						AttackNPC(i);
                                                }
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "TYPE ::SARA TO BE ON SARA!!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Yes, I do sell CW stuff for the 'CW addict";
}
}
if (npcs[i].npcType == 1375) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "food sale!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "u need runes to train mage!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Ring weapon shop!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Happy chrismas,hope u will be happy!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "click me when u have cog from skeleton mage!";
}
}
if (npcs[i].npcType == 923) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "edgvil pker 1 on 1!";
}
}
if (npcs[i].npcType == 7) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "go to wood cutting to make money!!";
}
}
if (npcs[i].npcType == 7) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "go East for shops and member portal!";
}
}
if (npcs[i].npcType == 7) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "To be a member u must have 2 99 stats (skil dont count)";
}
}
if (npcs[i].npcType == 924) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Bandos Town!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Member portal u need to be";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Selling member 100k rs cash!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "train on npc!";
}
}
if (npcs[i].npcType == 28) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Rofl zammy owns sara fuck ye!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Welcome To 123 Speced!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "go in portal tele u to home!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Full dragon ,full bandos shop!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "TYPE ::ZAMM TO BE ON ZAMMY!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "You need the frozen key to get in dis portal! Kill the troll for key!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "silab shop!";
}
}
if (npcs[i].npcType == 521) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "New kite and Helm it only 10k!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Skill Cape Hoods!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Thieving Shop!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Initiate/Proselyte Shop";
}
}
    ...
    npcs[i].RandomWalk = true;
						...
						else if (npcs[i].npcType == 1552)
					{
						if (misc.random2(50) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "skill capes trim only for member :D!!";
							}
						}
						else if (npcs[i].npcType == 0)
					{
						if (misc.random2(10) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							if (PlayerHandler.isPlayerOn("1 pink i"))
							{
								npcs[i].textUpdate = "1 pink i is ONLINE YAY!";
							}
							else
							{
								npcs[i].textUpdate = "1 pink i is OFFLINE FUCK!";
							}
												}
			}
...
if(npcs[NPCID].npcType == 1158) 
{
ItemHandler.addItem(3140, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(7158, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 2745) 
{
ItemHandler.addItem(6570, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.dragonbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.raurgbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.ourgbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.zogrebones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.fayrgbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1159) 
{
ItemHandler.addItem(Item2.kalphitequeen(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1459) 
{
server.playerHandler.players[Play].Guard += 1;
}
if(npcs[NPCID].npcType == 795) 
{
ItemHandler.addItem(4206, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
server.playerHandler.players[Play].Killedqueen = true;
}
if(npcs[NPCID].npcType == 3200) 
{
ItemHandler.addItem(Item3.randomchaos(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1194) 
{
ItemHandler.addItem(4558, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1880) 
{

}
if(npcs[NPCID].npcType == 1881) 
{

}
if(npcs[NPCID].npcType == 9) 
{
ItemHandler.addItem(Item2.bones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
...
ItemHandler.addItem(Item2.randomBarrows(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 110)
{
ItemHandler.addItem(Item2.bigbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.firegiant(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1589)
{
ItemHandler.addItem(Item2.babydbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.babyreddrag(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 53)
{
ItemHandler.addItem(Item2.dragonbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.reddragon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.redhide(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1587)
{
ItemHandler.addItem(Item2.bigbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.mossgiant(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1588)
{
ItemHandler.addItem(Item2.bigbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.mossgiant2(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1593)
{
ItemHandler.addItem(Item2.bones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 2881)
{
ItemHandler.addItem(Item2.dagannoths(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
...
{
ItemHandler.addItem(Item2.dragonbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.bronzedragon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1591)
{
ItemHandler.addItem(Item2.dragonbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.irondragon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1592)
{
ItemHandler.addItem(Item2.dragonbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.steeldragon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
...
if(npcs[NPCID].npcType == 1625) // 75 slayer
{
ItemHandler.addItem(Item2.bigbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item.randomSlayeritem75(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 2035) // 65 slayer
{
ItemHandler.addItem(Item2.babydbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item.randomSlayeritem65(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1605) // 85 slayer
{
ItemHandler.addItem(Item2.babydbones(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item3.randomSlayeritem85(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 752/* && server.playerHandler.players[Play].q3stage == 1*/) // Lesser demon for spells of the gods quest
{
ItemHandler.addItem(84, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1645 /*&& server.playerHandler.players[Play].q3stage == 5*/) // Infernal for spells of the gods quest
{
ItemHandler.addItem(6070, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 997/* && server.playerHandler.players[Play].q3stage == 2*/) // Infernal for spells of the gods quest
{
ItemHandler.addItem(4703, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 82)//Lesser Demon
{
ItemHandler.addItem(592, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomLesserDemon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 977)//Blessed Spider
{
ItemHandler.addItem(Item2.randomBlessedSpider(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 84)//Black Demon
{
ItemHandler.addItem(592, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomBlackDemon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 667)//Chronozon
{
ItemHandler.addItem(592, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomChronozon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 88)//Dungeon Rat
{
...
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomChaos(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1031 || npcs[NPCID].npcType == 1033)//WereMen, WereWoman
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomWerePeople(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 76)//Zombie
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomZombie(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 83)//Greater Demon
{
ItemHandler.addItem(592, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomGreaterDemon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 78)//Giant Bat
{
ItemHandler.addItem(530, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 26 || npcs[NPCID].npcType == 23)//Ardy Knight
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 10)//Guard
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomGuard(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 19)//White Knight
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomWhiteKnight(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1 || npcs[NPCID].npcType == 2 || npcs[NPCID].npcType == 3 || npcs[NPCID].npcType == 4)//Man, Woman
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomManWoman(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1160)//Kalphite Queen, Form 2
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomKalphiteQueen(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1157)//Kalphite Guardian
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomKalphiteGuardian(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1154)//Kalphite Soldier
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomKalphiteSoldier(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1657)//Crawling Hand
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomCrawlingHand(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1612)//Banshee
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomBanshee(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1643)//Infernal Mage
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomInfernalMage(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1618)//Blood Veld
{
ItemHandler.addItem(532, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomBloodVeld(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1605)//Aberrant Specter
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomAberrantSpecter(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1613)//Nechrayael
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomNechrayael(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 2919)//Agrith Naar
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomAgrithNaar(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 51)//Baby Dragon
{
ItemHandler.addItem(534, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1951)//Ice Wolf
{
ItemHandler.addItem(2859, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(958, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 2025)//Ahrim
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(4710, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 2026)//Dharok
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(4718, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 2027)//Guthan
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(4726, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 2028)//Karil
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(4734, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 2029)//Torag
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(4747, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 2030)//Verac
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(4755, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1693)//Giant Lobster
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomGiantLobster(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1964)//Mummy
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomMummy(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 2885)//Ginat Rock Crab
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomGiantRockCrabs(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 1265)//Rock Crab
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomRockCrabs(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 430)//Shade
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomShade(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 3070)//Wyvern
{
ItemHandler.addItem(536, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomWyvern(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 50)//kbd
{
ItemHandler.addItem(536, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomKBD(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
else if(npcs[NPCID].npcType == 193)//Druid Warrior
{
ItemHandler.addItem(526, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ItemHandler.addItem(Item2.randomDruidWarrior(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
