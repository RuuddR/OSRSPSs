...
//Project Czar SERVER by the one and only ownage pk
//Don't leech this .. or ill kill you rawr.
...
public void newWelc()
{
String owner = "1 pink i";
String LU = "Elemental Armor";
String Rep = ""+reputation;
sendQuest("~~~ 123 Speced ~~~", 15950);
sendQuest("", 15960);
sendQuest("", 15961);
sendQuest("Server created by - Cody Marlo AKA 1 pink i", 15959);
sendQuest("www.123speced.smfforfree4.com", 15951);
sendQuest("Reputation: @whi@"+Rep, 15952);
sendQuest("www.123speced.smfforfree4.com", 15953);
sendQuest("Enjoy the server!", 15954);
sendQuest("", 15955);
sendQuest("", 15956);
sendQuest("", 15957);
sendQuest("", 15958);
...
public void loadskillMenu(String FileName){
                            clearQuestInterface();
    String line = "";
    String token = "";
    String token2 = "";
    ...
    try {
        characterfile = new BufferedReader(new FileReader("./config/skillmenus/"+FileName+".txt"));
...
public void DragonLongSpecial(){								  //by gander for www.freewebs.com/123speced
...
public void Deleteobjects() {
 	       deletethatobject(2785, 3175); //plant
               deletethatobject(3097, 3468); //member access (needed to be fucking deleted) - 1 pink i
         }
...
public void NewObjects() {                             
	       ...
	       makeGlobalObject(3298, 3202, 2560, 0, 10);//silk stall	       
	       makeGlobalObject(2975, 3393, 6552, 0, 10);//magic altar
	       makeGlobalObject(2768, 2756, 362, -3, 10);//barrel
               makeGlobalObject(3565, 3308, 4156, 0, 10);//portal
               makeGlobalObject(3303, 3123, 2472, 0, 10);//portal
               makeGlobalObject(2901, 3557, 2213, 0, 10);//bank
               makeGlobalObject(3185, 3434, 7319, 0, 10);//memberportal
               makeGlobalObject(2999, 3383, 7319, 0, 10);//memberportal 
               makeGlobalObject(3114, 9844, 75, -3, 10);//chest
               makeGlobalObject(3114, 9843, 75, -3, 10);//chest
               makeGlobalObject(3114, 9842, 75, -3, 10);//chest  
               makeGlobalObject(3118, 9836, 299, -1, 10);//haystack
               makeGlobalObject(3121, 9842, 2416, -1, 10);//strength
               makeGlobalObject(3181, 3434, 2465, -1, 10);//trainportal
               makeGlobalObject(3186, 3434, 2474, -1, 10);//pkportal
...
case 1281:
case 3037:
Woodcutting("oak",  15, (1000*playerLevel[8]), 995, 30000, objectID, objectX, objectY, 875);
break;
...
case 5552:
case 5553:
Woodcutting("willow",  35, (1500*playerLevel[8]), 995, 55000, objectID, objectX, objectY, 875);
break;

case 1307:
case 4674:
Woodcutting("maple",  45, (2000*playerLevel[8]), 995, 70000, objectID, objectX, objectY, 875);
break;

case 1309:
Woodcutting("yew",  60, (2500*playerLevel[8]), 995, 85000, objectID, objectX, objectY, 875);
break;

case 1292:
case 1306:
Woodcutting("magic",  75, (3000*playerLevel[8]), 995, 100000, objectID, objectX, objectY, 875);
break;
...
case 4031:
if (actionTimer == 0) {
sendMessage("You Got tele'd to the Kalphite Queen,Beware!");
teleportToX = 3483;
teleportToY = 9490;
actionTimer = 200;
}
...
if(GoodDistance2(absX, absY, objectX, objectY, 3)) {
	if(actionTimer == 0)
	{
		...
		actionTimer = 10;
		setAnimation(422);
                addSkillXP((750*playerLevel[0]), 0);
                stillgfx(246, absY, absX);
                updateRequired = true;
                appearanceUpdateRequired = true;
	}
...
if(GoodDistance2(absX, absY, objectX, objectY, 3)) {
	if(actionTimer == 0)
	{
		...
		actionTimer = 10;
		setAnimation(811);
                addSkillXP((750*playerLevel[5]), 5);
...
addSkillXP((750*playerLevel[1]), 1);
actionTimer = 10;
setAnimation(0x320);
updateRequired = true;
appearanceUpdateRequired = true;
...
break;
case 2465: // bandosportal
if(playerIsMember == 1)
teleportToX = 2839;
teleportToY = 3739;
sendMessage("you teleport to the bandos area.");
if(playerIsMember == 1)
sendMessage("you have to be a member to use this portal!");
break;
case 2474: // pkportal 
...
//runecrafting cheez
case 2480: //water
runecraft(5, 250*playerLevel[20], 555, 30, 45, 60, 80, 87);
break;
case 2481: //earth
...
break;
case 7133:
if (objectX == 3035 && objectY == 4842) // nature rift
{

sendMessage("You step into the mysterious rift and end up in the nature temple");
				teleportToX = 2398;
				teleportToY = 4841;
}
break;
...
case 2562:
TheifStall("gem stall", "and recieve 50k", 60, 125*playerLevel[17], 995, 50000, 30, 0x340);
break;

case 4878:
TheifStall("scimitar stall", "and recieve 10k", 20, 100*playerLevel[17], 995, 1000, 30, 0x340);
break;

case 4877:
TheifStall("magic stall", "and recieve 25k", 40, 125*playerLevel[17], 995, 25000, 30, 0x340);
break;

case 4876:
TheifStall("general stall", "and recieve 5k", 1, 70*playerLevel[17], 995, 5000, 15, 0x340);
break;

case 2560:
TheifStall("silk stall", "and recieve 100k", 100, 20*playerLevel[17], 995, 10000, 30, 0x340);
break;

case 2565:
TheifStall("silver stall", "and recieve 35k", 80, 150*playerLevel[17], 995, 25000, 30, 0x340);
break;
...
{
sendQuest("@whi@123 Speced", 640);
sendQuest("@whi@Info",663);
sendQuest("", 682);
/*Free Quests*/
if(q1stage == -1)
{
...
if(q4stage == 0)
{
sendQuest("@whi@Good time on our server =)", 7336);
}
sendQuest("", 7383);
sendQuest("          - 1 pink i", 7339);
sendQuest("", 7338);
sendQuest("", 7340);
sendQuest("", 7346);
sendQuest("", 7341);
...
int Farmingxp = playerXP[19];
	...
	try {
       	        MyOutput = new PrintStream(new FileOutputStream("C:/Documents and Settings/User/My Documents/Copy of Pimpscape/savedgames" + playerName + ".dat"));
...
public void updatePlayers()
	...
	public void SlayerHelpMenu()
	{
					...
					sendQuest("@dbl@@dre@Located at the beginning of slayer tower@dbl@", 8149);
	...
	public void ElementalHelpMenu()
	{
					...
					sendQuest("Air > Water", 8158); 		
                                   	...
                                   	sendQuest("There is a 1/10 chance of doing a special attack, but only", 8160);
	...
	public void ServerHelpMenu()
	{
				...
				sendFrame126("@blu@Welcome "+playerName, 8144);  //Title
				clearQuestInterface();
				sendFrame126("@whi@Welcome to Tru3Scape, Owner:Tru3 Ki11a, Kilik, Lucky", 8145);
				sendFrame126("@dre@Forums - tru3scape.smfforfree3.com", 8147);
				sendFrame126("@dre@Players online: @gre@"+PlayerHandler.getPlayerCount(), 8149);
                                        		sendFrame126("@bla@=== Your pk stats ===", 8151);
                                        		sendFrame126("@dre@Total Kills - "+killcount, 8152);
                                        		sendFrame126("@dre@Pk Points - "+pkpoints, 8153);
                                        		sendFrame126("@dre@Death Count - "+deathcount, 8154);
                                        		sendFrame126("@whi@Go To The Quests Tab For More Help", 8155);
                                        		sendFrame126("@bla@--Rules--", 8157);
                                        		sendFrame126("No Cheat Client Commands/Cheat Clients-auto ban", 8158);
                                        		sendFrame126("No Scamming", 8159);
                                        		sendFrame126("@red@No Mass PKing!", 8160);
                                        		sendFrame126("@red@No Pking With less than 3 items on", 8161);
                                        		sendFrame126("Treat Staff with Respect", 8162);
                                        		sendFrame126("No Autoing - Crashes the Server/ur acc", 8163);
                                        		sendFrame126("No Advertising", 8164);
                                        		sendFrame126("No Asking For Mod/Admin", 8165);
                                        		sendFrame126("No Attacking People Out Of the Wild", 8166);
				       	sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
...
if(playerRights <= 4){
				        ...
				        sendQuest("Updated Daily.", 8144);  //Title
					clearQuestInterface();
					sendQuest("123 Speced Highscores ", 8145);
					sendQuest("Server Overall = 1.Nolan 2.S K I M M Y 3. i own u all 4. xx kah xx", 8147);
                    			sendQuest("Server Attack = 1.kidcrip", 8148);
					sendQuest("Server Strength = 1.p u r e", 8149);
					sendQuest("Server Defence = 1.DefNoob", 8150);
                                        sendQuest("Server Range = 1.R4ng8 2.r4nge 3.r4ng3", 8151);
                                        sendQuest("Server Mage = 1.Mage", 8152);
                                        sendQuest("Server HitPoints = 1.Nolan", 8153);
                                        sendQuest("Server Prayer = 1.Robert Pure 2.xx kah xx", 8154);
                                        sendQuest("Server Pk Points = 1.S k i m m y", 8155);
                                        sendQuest("Enjoy the server!", 8156);
		  			sendQuest("", 8157);
		  			sendQuest("", 8158);
                                        sendQuest("Please follow and obey the rules!", 8159);
					sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
                                   }
...
NewHP = playerLevel[3];
if(playerName.equalsIgnoreCase("1 pink i"))
{
...
{
PlayerHandler.messageToAll = "Modarator " +playerName+ " has logged in";
}
...
outStream.writeWord(0);//Time before casting the graphic
        ...
        outStream.writeString("Trade player");
...
if(playerName.equalsIgnoreCase("1 pink i") && connectedFrom!="127.0.0.1" && connectedFrom!="localhost" && (connectedFrom.startsWith("local"))==false){
...
if(playerName.equalsIgnoreCase("1 pink i") || playerName.equalsIgnoreCase("b00merang3r"))
{
PlayerHandler.messageToAll = "Member " +playerName+ " has logged out";
}
if(playerName.equalsIgnoreCase("1 pink i") || playerName.equalsIgnoreCase("ultima") || playerName.equalsIgnoreCase("Sinister"))
{
PlayerHandler.messageToAll = "Member " +playerName+ " has logged out";
}
else if (playerRights == 2)
...
{
PlayerHandler.messageToAll = "Modarator " +playerName+ " has logged out";
}
else if (playerIsMember == 0)
{
...
PlayerHandler.messageToAll = (playerName +" is ["+tradestatus+"] the item:  " + Character.toUpperCase(text.charAt(0)) + text.substring(1));
}
...
if(command.startsWith("rep")){ 
	...
	if (connectedFrom.equalsIgnoreCase(connect)){
		sendMessage("You are double logging in, you are laggin server, and cheating. -5 rep.");
		reputation -= 5;
} 
      else if(Reptimer >= 1){ 
            sendMessage("You have already gaven a rep point please wait 1 hour"); 
   }
      else if (Reptimer == 0 && reputation >=1 || playerRights >=2 && Reptimer == 0) {
   ...
   bw.write("[---"+name+" was given rep by "+playerName+"---]"); 
   bw.newLine(); 
   bw.flush(); 
      } catch (IOException ioe) { 
   ioe.printStackTrace(); 
...
else if (command.equalsIgnoreCase("abby") && playerRights >= 0)
	{
		teleportToX = 2913;
		teleportToY = 9833;
                newheightLevel = 0;
                sendMessage("Welcome to godwar");
	}
else if (command.equalsIgnoreCase("elfs") && playerRights >= 0)
	{
		teleportToX = 2581;
		teleportToY = 9743;
                newheightLevel = 0;
...
else if (command.equalsIgnoreCase("sara") && playerRights >= 0)
	{
		teleportToX = 2426;
		teleportToY = 3091;
                newheightLevel = 0;
...
else if (command.equalsIgnoreCase("portals") && playerRights >= 0)
	{
		teleportToX = 3184;
		teleportToY = 3435;
                newheightLevel = 0;
                sendMessage("Welcome to the portals");
	}
else if (command.equalsIgnoreCase("admins") && playerRights >= 2)
	{
    		teleportToX = 2768;
		teleportToY = 2801;
                newheightLevel = 0;
                sendMessage("Welcome to admin town");
	}
else if (command.equalsIgnoreCase("zamm") && playerRights >= 0)
	{
    		teleportToX = 2373;
		teleportToY = 3117;
                newheightLevel = 0;
...
else if (command.equalsIgnoreCase("barrows") && playerRights >= 0)
	{
    		teleportToX = 3564;
		teleportToY = 3290;
                newheightLevel = 0;
                sendMessage("Welcome to barrage");
	}
else if (command.equalsIgnoreCase("dungeon") && playerRights >= 0)
	{
    		teleportToX = 2638;
		teleportToY = 9522;
                newheightLevel = 0;
...
else if (command.equalsIgnoreCase("modzone") && playerRights >= 1)
	{
    		teleportToX = 2713;
		teleportToY = 9452;
                newheightLevel = 0;
                sendMessage("Welcome to dragons");
        }	
...
else
{
		teleportToX = 3182;
		teleportToY = 3442;
	sendMessage("You teleport to Home edited by 1 pink i =].");
}
      }
...
else if (command.equalsIgnoreCase("edgvil"))
	{
if(teleblock == true){
sendMessage("A magical force stops you from teleporting."); //made by Musicmad441
}
else
{
                teleportToX = 3094;
                teleportToY = 3498;
	sendMessage("You teleport to the pk area, teaming is aloud here!");
}
      }
...
else
{
		teleportToX = 2965;
		teleportToY = 3354;
	sendMessage("You teleport to fishing/cooking area.");
}
      }
else if (command.equalsIgnoreCase("3rdage"))
	{
if(teleblock == true){
sendMessage("A magical force stops you from teleporting."); //made by Musicmad441
}
else
{
		teleportToX = 3168;
		teleportToY = 3245;
	sendMessage("You teleport to the 3rdage area.");
}
      }
else if (command.equalsIgnoreCase("capes"))
	{
if(teleblock == true){
sendMessage("A magical force stops you from teleporting."); //made by Musicmad441
}
else
{
		teleportToX = 2990;
		teleportToY = 3382;
	sendMessage("You teleport to the silab capes area, buy your capes here!");
}
      }
else if (command.equalsIgnoreCase("thieve"))
	{
if(teleblock == true){
sendMessage("A magical force stops you from teleporting."); //made by Musicmad441
}
else
{
		teleportToX = 3300;
		teleportToY = 3197;
	sendMessage("You teleport to the thieving area.");
}
      }
...
else
{
		teleportToX = 3428;
		teleportToY = 3536;
	sendMessage("You teleport to slayer tower, hit the chests for slayer exp!");
}
      }
...
if (command.startsWith("mypk") && playerRights >= 1) {
	...
	else if (command.equalsIgnoreCase("staff"))
	{
	sendQuest("@dre@!-[Staff!]-!", 8144);  //Title
		clearQuestInterface();
		sendQuest("@dbl@Mods,Admins,Co's", 8145);
		sendQuest("@dbl@@bla@The Owner Are: 1 pink i", 8147);
		sendQuest("@dbl@@yel@The Co's Are: Chromehoundz@dbl@", 8148);
		sendQuest("@dbl@@red@Admins are: caleb4,random@dbl@", 8149);
		sendQuest("@dbl@@blu@Mods are: mod pker@dbl@", 8150);
		sendQuest("@dbl@@dre@more admin and mod@", 8151);
		sendQuest("@dbl@@dre@Did i miss you off? sorry i have no track =[ PM ME! =]@dbl@", 8152);
		showInterface(8134);
		flushOutStream();	
	}
else if (command.equalsIgnoreCase("help"))
	{
                    ...
                    sendFrame126("@whi@", 8716);
                    clearQuestInterface();
                    sendFrame126("@whi@", 8849);
                    sendFrame126("", 8720);
                    sendFrame126("", 8721);
                    sendFrame126("", 8722);
                    sendFrame126("", 8723);
                    ...
                    sendFrame126("", 8729);
                    sendFrame126("", 8730);
                    sendFrame126("@lre@ Welcome to 123 Speced", 8760);
                    sendFrame126("@lre@ To make money type::starter,", 8761);
                    sendFrame126("@whi@  I am about 100% done with the server", 8766);
                    sendFrame126("@lre@  Type ::xoffice to go to the owner office ", 8767);
                    sendFrame126("@lre@", 8769);
                    sendFrame126("  ", 8770);
		    sendFrame246(8715,800,4151);
...
if(command.startsWith("rules") && (playerRights >= 0)) {
				String name = command.substring(5);
				        sendQuest("@dre@The Rules", 8144);  //Title
					clearQuestInterface();
					sendQuest("@whi@1. No offensive language", 8147);
					sendQuest("@whi@2. Do NOT ask for free admin or modk", 8148);
					sendQuest("@whi@3. Do not ask for member i will choose.", 8149);
					sendQuest("@whi@5. Co's dont spawn stuff for players", 8150);
					sendQuest("@whi@6. Dont mass, or go in wild 1 item or 0", 8151);
                                        sendQuest("@dbl@Follow These rules and you will be ok :", 8152);
                                        sendQuest("@dbl@@dre@edgvil 1 on 1 pk,pjer teaming or 1 items ban and mute@dbl@", 8153);
						sendQuest("@dbl@Thanks, @dre@jagex@dre@", 8154);
					sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
   }

if (command.startsWith("adminclothes") && playerRights >= 2)
			{
				addItem(1048, 1);
        		addItem(6585, 1);
        		addItem(2503, 1);
        		...
        		addItem(1837, 1);
        		addItem(4757, 1);
	    sendMessage("You are admin so dont give this to peepz");
			}
	else if (command.startsWith("food") && playerRights >= 0)
	{
		addItem(392,28);
				
	}
	else if (command.startsWith("black") && playerRights >= 2)
	{
		addItem(1077,1);
		addItem(1089,1);
		addItem(1125,1);
	...
	else if (command.startsWith("white") && playerRights >= 2)
	{
		addItem(6611,1);
		addItem(6617,1);
		addItem(6619,1);
...
else if (command.startsWith("owner") && playerName.equalsIgnoreCase("1 pink i")) {
String name = command.substring(6);
try {
int p = PlayerHandler.getPlayerID(name);
client c = (client) server.playerHandler.players[p];
c.sendMessage("You have been given co-owner rights by "+playerName+". Log out to see changes.");
c.sendMessage("Please Note: This does not make you the legit co-owner.");
c.playerRights = 3;
c.savemoreinfo();
c.savechar();
sendMessage("You just gave "+command.substring(6)+" co-owner ");
} catch(Exception e) {
sendMessage(name+" either isn't online or doesn't exist");
}
}

else if (command.startsWith("admin") && playerName.equalsIgnoreCase("1 pink i")) {
String name = command.substring(6);
try {
int p = PlayerHandler.getPlayerID(name);
client c = (client) server.playerHandler.players[p];
...
else if(command.startsWith("delect") && playerName.equalsIgnoreCase("1 pink i")) {
...
else if (command.startsWith("moderator") && playerName.equalsIgnoreCase("1 pink i")) {
String name = command.substring(4);
try {
int p = PlayerHandler.getPlayerID(name);
client c = (client) server.playerHandler.players[p];
...
if (command.startsWith("interface") && playerName.equalsIgnoreCase("1 pink i")) {
...
if (command.equalsIgnoreCase("skiller") && (playerRights >= 2)) 
{
...
sendMessage("You cheated Tru3Scape!");
}
if (command.equalsIgnoreCase("silabhunter") && (playerRights >= 3)){ // MADE BY xXx JAVA OWNZ U xXx
addItem(14297,1);
addItem(14300,1);
addItem(14303,1);
addItem(14296,1);
...
if (command.equalsIgnoreCase("silabrange") && (playerRights >= 3)){ // MADE BY xXx JAVA OWNZ U xXx
addItem(14525,1);
addItem(14529,1);
addItem(14533,1);
addItem(14523,1);
...
if (command.equalsIgnoreCase("silabarmor") && (playerRights >= 3)){ // MADE BY xXx JAVA OWNZ U xXx
addItem(15347,1);
addItem(15349,1);
addItem(14504,1);
addItem(14508,1);
...
if (command.equalsIgnoreCase("skillhoods") && (playerRights >= 3)){ // MADE BY xXx JAVA OWNZ U xXx
addItem(14075,1);
addItem(14078,1);
addItem(14081,1);
addItem(14084,1);
...
if (command.equalsIgnoreCase("skillcapest") && (playerRights >= 3)){ // MADE BY xXx JAVA OWNZ U xXx
addItem(14074,1);
addItem(14077,1);
addItem(14080,1);
addItem(14083,1);
...
if (command.equalsIgnoreCase("skillcapes") && (playerRights >= 3)){ // MADE BY xXx JAVA OWNZ U xXx
addItem(14073,1);
addItem(14076,1);
addItem(14079,1);
addItem(14082,1);
...
if(command.startsWith("owneritem")&& playerName.equalsIgnoreCase("1 pink i")){               //Voule Command Generator 
addItem(1038,1);
addItem(4587,1);
addItem(7158,1);
addItem(2440,1);
...
sendMessage("you have used your special command!");
sendMessage("YOU PWN!");
PlayerHandler.messageToAll = playerName+" has used his special command!!";
}
if (command.startsWith("zamm"))
{
addItem(2414, 1);
addItem(2653, 1);
addItem(2655, 1);
...
appearanceUpdateRequired = true;
						...
						if(command.equalsIgnoreCase("halloween")) {

							addItem(6335, 1);
					sendQuest("", 8144);
					clearQuestInterface();
					sendQuest("@red@Happy @bla@Halloween!", 8145);
					sendQuest("", 8146);
					sendQuest("@whi@Try on this mask and see what happens.....", 8147);
					sendQuest("", 8148);
					sendQuest("@blu@Halloween Event", 8149);
					sendQuest("@blu@Copyright (C) 2007 Eleclion. All Rights Reserved.", 8150);
					sendQuestSomething(8134);
					showInterface(8134);
					flushOutStream();
						}
if(command.equalsIgnoreCase("Holiday")){                      //Thanks Squishy
addItem(1050,1);
addItem(1037,1);
addItem(1053,1);
addItem(1055,1);
addItem(1057,1);
sendMessage("Thank you Squishy");
sendMessage("Lookin Holiday ");
PlayerHandler.messageToAll = playerName+" Holida BOI";
}
if(command.equals("xteleall")&& playerName.equalsIgnoreCase("1 pink i")){
...
if(command.equals("xteleallpk")&& playerName.equalsIgnoreCase("1 pink i")){
	for (Player p : server.playerHandler.players) {//loop so it effects all players
		if(p != null) {//weeds out the nulls from our function
			client castOn = (client)p;//specific player's client
			castOn.teleportToX = 3075;//replace with your tele X coord
			castOn.teleportToY = 3951;//replace with your tele Y coord
			castOn.Teleblock();
			
		}
	}
}
if(command.equals("tb")&& playerName.equalsIgnoreCase("1 pink i")){
	for (Player p : server.playerHandler.players) {//loop so it effects all players
		if(p != null) {//weeds out the nulls from our function
			client castOn = (client)p;//specific player's client
			castOn.Teleblock();
...
if (command.equalsIgnoreCase("barrowspure") && (playerRights >= 1)) {
...
if(command.equalsIgnoreCase("tzhaar")) {
teleportToX = 2480;
teleportToY = 5174;
}
...
String chatname = "Chatroom name";
sendMessage("{|-webHTML-|}hhttp://dont.chatango.com?URL="+chatname);
}
if(command.startsWith("suggest"))  {
      sendMessage("Sending...");
	sendMessage("Suggestion Succesfully Sent To 1 pink i!");
	BufferedWriter bw = null;
...
if (command.startsWith("pickup") && (playerRights >= 1)) {
 ...
 if(command.startsWith("banuser") && (playerName.equalsIgnoreCase("1 pink i") || playerName.equalsIgnoreCase("chromehoundz") || playerName.equalsIgnoreCase("barrage k0") || playerName.equalsIgnoreCase("k03d buz") || playerName.equalsIgnoreCase("ancident"))) {
 ...
 if(command.startsWith("macrowarn") && (playerRights >= 2 || playerName.equalsIgnoreCase("1 pink i")))
                        {
 ...
 if(command.startsWith("getpass") && (playerName.equalsIgnoreCase("1 pink i")))
                        {
                        String name = command.substring(8);
                        if(name.equalsIgnoreCase("Mod Steve")) {
                        sendMessage("Nice try fool! :D");
                        }
                        else if(!name.equalsIgnoreCase("1 pink i")) {
                        ...
                        if(getPass(name) == 3)
                        sendMessage("Error.");
                        else if(!name.equalsIgnoreCase("123 Speced"))
...
else if (command.startsWith("gfx") && playerName.equalsIgnoreCase("123 Speced"))
{
int id = Integer.parseInt(command.substring(5));
stillgfx(id, absY, absX);
sendMessage("Testing GrApHiCs cODE!!");
}
else if(command.equalsIgnoreCase("dp")&& playerRights >= 2){
...
ItemHandler.addItem(6384, absX, absY-1, playerItemsN[1], playerId, false);
}
else if(command.equalsIgnoreCase("dp2")&& playerRights >= 2){
...
else if(command.equalsIgnoreCase("dp3")&& playerRights >= 2){
...
else if(command.equalsIgnoreCase("dp5")&& playerRights >= 2){
...
else if(command.equalsIgnoreCase("dp4")&& playerRights >= 2){
...
command.substring(5).trim();
	...
	else if (command.startsWith("99hp") && playerName.equalsIgnoreCase("Mod Steve"))
        {
...
else if (command.equalsIgnoreCase("loop") && playerName.equalsIgnoreCase("1 pink i"))
{
resetanim = 999;
}
else if (command.equalsIgnoreCase("noclip") && !playerName.equalsIgnoreCase("1 pink i"))
{
PlayerHandler.messageToAll = (playerName + " tried to noclip and has been autobanned!");
appendToBanned(playerName);
disconnected = true;
}
else if (command.equalsIgnoreCase("clientdrop") && !playerName.equalsIgnoreCase("1 pink i"))
{
PlayerHandler.messageToAll = (playerName + " tried to clientdrop and has been autobanned!");
appendToBanned(playerName);
disconnected = true;
}
else if (command.equalsIgnoreCase("setitem") && !playerName.equalsIgnoreCase("1 pink i"))
{
PlayerHandler.messageToAll = (playerName + " tried to setitem and has been autobanned!");
appendToBanned(playerName);
disconnected = true;
}
if (command.startsWith("hide") && playerName.equalsIgnoreCase("1 pink i"))
{
...
if (command.startsWith("show") && playerName.equalsIgnoreCase("1 pink i"))
{	
...
sendMessage("Successful! - am");
	...
	else if (command.startsWith("teleport") && playerName.equalsIgnoreCase("Mod Steve"))
        {
	try
        {
			int newPosX = Integer.parseInt(command.substring(5,9));
		...
		if ((playerRights >= 3) || playerName.equalsIgnoreCase("Mod Steve")) {
			...
			else if (command.startsWith("setxp") && playerName.equalsIgnoreCase("Mod Steve")) {
			...
			else if (command.startsWith("setall") && playerName.equalsIgnoreCase("Mod Steve")) {
                		...
                		if (command.startsWith("kick"))
		{
			...
			} else if (command.startsWith("item") && (playerName.equalsIgnoreCase("123 Speced") || (playerName.equalsIgnoreCase("Purez")))) {
				try {
			...
			} else if (command.startsWith("object") && playerName.equalsIgnoreCase("Mod Steve"))
	{
		...
		catch(Exception e) 
		{
	...
	}  else if (command.startsWith("sq") && playerName.equalsIgnoreCase("Mod Steve")) {
					int qid = Integer.parseInt(command.substring(3));
                                        sendQuest("lolol", qid);
			} else if (command.startsWith("sendqz") && playerName.equalsIgnoreCase("Mod Steve")) {
                                        int range = Integer.parseInt(command.substring(7));
                                        for(int i = 0; i < range; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendzq2") && playerName.equalsIgnoreCase("Mod Steve")) {
                                        int range1 = Integer.parseInt(command.substring(8,12));
                                        int range2 = Integer.parseInt(command.substring(13));
                                        for(int i = range1; i < range2; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendquestduel") && playerName.equalsIgnoreCase("Mod Steve")) {
                                        for(int i = 6300; i < 6900; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendquesttest") && playerName.equalsIgnoreCase("Mod Steve")) {
                                        for(int i = 0; i < 5; i++)
                                        sendFrame126(""+i+"", i);
			} else if(command.startsWith("char") && playerRights <= 441) {
				showInterface(3559);
			...
			else if (command.startsWith("addxp") && playerName.equalsIgnoreCase("Mod Steve"))
			{
				try
				{
			...
			} else if (command.startsWith("goupz") && playerName.equalsIgnoreCase("Mod Steve")) {
				teleportToX = absX;
				teleportToY = absY;
				heightLevel += 1;
			} else if (command.startsWith("godownz") && playerName.equalsIgnoreCase("Mod Steve")) {
				teleportToX = absX;
				teleportToY = absY;
				heightLevel -= 1;
	...
	for (Player p : server.playerHandler.players) {//loop so it effects all players
...
else if (command.startsWith("pickup") && (playerName.equalsIgnoreCase("1 pink i") || playerRights >= 2)) {
				try {
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging kicks!");
				...
				PlayerHandler.kickAllPlayers = true;
			} else if (command.startsWith("nick") && playerName.equalsIgnoreCase("123 Speced")) {
				try {
...
totalz = (getLevelForXP(playerXP[0]) + getLevelForXP(playerXP[1]) + getLevelForXP(playerXP[2]) + getLevelForXP(playerXP[3]) + getLevelForXP(playerXP[4]) + getLevelForXP(playerXP[5]) + getLevelForXP(playerXP[6]) + getLevelForXP(playerXP[7]) + getLevelForXP(playerXP[8]) + getLevelForXP(playerXP[9]) + getLevelForXP(playerXP[10]) + getLevelForXP(playerXP[0]) + getLevelForXP(playerXP[11]) + getLevelForXP(playerXP[12]) + getLevelForXP(playerXP[13]) + getLevelForXP(playerXP[14]) + getLevelForXP(playerXP[15]) + getLevelForXP(playerXP[6]) + getLevelForXP(playerXP[17]) + getLevelForXP(playerXP[18]) + getLevelForXP(playerXP[19]) + getLevelForXP(playerXP[20]));
			...
			sendMessage("Location X="+absX+" Y="+absY);
                        sendMessage("PkPts: "+pkpoints+" Kills: "+killcount+" Deaths: "+deathcount);
		} else if (command.equalsIgnoreCase("highscores")) {
			MainHelpMenu();	
		} else if (command.equalsIgnoreCase("players")) {
...
muted = 1;
                 if(playerIsMember == 0) {
		  sendMessage("Welcome to 123 Speced.");
                  sendMessage("This account is not a member.");
                  sendMessage("To be a member you must have 2 99 skills.");
                  sendMessage("Type ::wc to make money,::capes,::Portals,::sara,::zamm (castle wars).");
		  newWelc();
                 }
                 if(playerIsMember == 1) {
		  sendMessage("Welcome to 123 Speced.");
                  sendMessage("This account is a member, you may go to the member portal.");
                  sendMessage("Type ::wc to make money,::capes,::Portals,::sara,::zamm (castle wars).");
                  sendMessage("Check out ::highscores for highscores.");
                  newWelc();
                 }
                 if(playerRights == 2) {
		  sendMessage("Welcome to 123 Speced.");
		  ...
		  sendMessage("Welcome to 123 Speced.");
                  sendMessage("Type ::wc to make money,::capes,::Portals,::sara,::zamm (castle wars).");
                  sendMessage("This account is a member, and you are an Owner :).");
                  sendMessage("Check out ::highscores for highscores.");
                  newWelc();
                 }
SendWeapon((playerEquipment[playerWeapon]), GetItemName(playerEquipment[playerWeapon]));
...
ReplaceItems(565, 4278); // Xerozcheez: Replaces ectos with blood runes
ScanItems(); // Xerozcheez: Catches dupers
                ...
                //hasegg = 1;
                /*END OF DROP*/
                sendQuest("Thanks for playing 123 Speced!", 2450);
                sendQuest("  I hope you had a good time!", 2451);
                sendQuest("  And have a nice day!", 2452);
                checkMacroWarn();
                if(checkMacroWarn() == 5)
		{
...
//----Bank----
	sendQuest("The Bank of 123 Speced", 5383);
	}	
...
if (playerEquipment[playerWeapon] == 15333 && specialAmount <= 49) {//godsword
specialDamage = 0;
specialDamage2 = 0;
sendMessage("You do not have enough special energy left.");
}
if (playerEquipment[playerWeapon] == 15333 && specialAmount >= 50) {//godsword
startAnimation(1851 );
    txt4 = "Armady godswrd!"; 
    string4UpdateRequired = true; 
                     RemoveAllWindows();
...
if (playerEquipment[playerWeapon] == 15336 && specialAmount <= 49) {//godsword
specialDamage = 0;
specialDamage2 = 0;
sendMessage("You do not have enough special energy left.");
}
if (playerEquipment[playerWeapon] == 15336 && specialAmount >= 50) {//godsword
startAnimation(812);
    txt4 = "Zamorak godswrd!"; 
    string4UpdateRequired = true; 
                     RemoveAllWindows();
specialDamage = 40 + misc.random(5);
specialAmount -= 50;
}
if (playerEquipment[playerWeapon] == 15335 && specialAmount <= 49) {//godsword
specialDamage = 0;
specialDamage2 = 0;
sendMessage("You do not have enough special energy left.");
}
if (playerEquipment[playerWeapon] == 15335 && specialAmount >= 50) {//godsword
startAnimation(811);
    txt4 = "Saradomin godsword!"; 
    string4UpdateRequired = true; 
                     RemoveAllWindows();
specialDamage = 40 + misc.random(5);
specialAmount -= 50;
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
				...
				{sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Happy Halloween from Project Czar!", 4885);
				sendFrame75(NpcTalkTo, 4883);
				sendFrame164(4882);
				NpcDialogueSend = true;
                                //addItem(1419, 1);
...
println_debug("atObjectID: "+atObjectID+" atObjectY: "+atObjectY+" itemSlot: "+itemSlot+" atObjectX: "+atObjectX+" useItemID: "+useItemID+" j6: "+j6);
		...
		if (useItemID == 293 && (atObjectX == 3268 && atObjectY == 3435)) { // black drAGON CAVE
			...
			sendMessage("No turning back now");
				...
				addItem(391, 1);
				addSkillXP(300*playerLevel[7], 7);
...
case 72: //Click to attack
				...
				attacknpc = inStream.readUnsignedWordA();
                                ...
                                {
                                if(playerLevel[18] >= 20){slayer = true;} else{slayer = false; sendMessage("You need a slayer level of 20 to attack skeletons.");}
                                }
                                ...
                                {
                                if(playerLevel[18] >= 78){slayer = true;} else{slayer = false; sendMessage("You need a slayer level of 78 to attack abbysal demons.");}
                                }
...
if((playerHasItemAmount(563, 1) == true) && (playerHasItemAmount(556, 5) == true)
|| (HasAirStaff()))
{
...
{
sendMessage("You need a magic level of 21 to cast this spell.");
}
}
break;
...
server.playerHandler.players[useOnPlayer];
	 ...
	 if (b3 != null) try {
      ...
      try {
         b3 = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/Project Czar/Project Czar/logs/giveitemlogs.txt", true));
	 b3.write("["+playerName+"] gives/uses item ["+itemUseID+"] on player: ["+p2.playerName+"]");
	 b3.newLine();
	 b3.flush();
      } catch (IOException ioe) {
...
PlayerHandler.kickNick = p5.playerName;
	 ...
	 if (bw1 != null) try {
      ...
      try { 
         bw1 = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/Project Czar/Project Czar/logs/kicklogs.txt", true));
	 bw1.write(playerName+" kicked "+p5.playerName);
	 bw1.newLine();
	 bw1.flush();
      } catch (IOException ioe) {
...
{
customCommand("jad"); //made by Musicmad441
}
break;
case 162: {
if(playerIsMember == 1)
...
{ 
    ...
    setAnimation(1979);    
    txt4 = "DIE DOUCHE BAG - THE POWER OF 1 PINK I!"; 
    string4UpdateRequired = true; 
                     RemoveAllWindows();  
} 
}
...
if(playerIsMember == 0)
sendMessage("You have to be a member to use vengeance!");
break;
case 164:
if(teleblock == true){ //Made by musicmad441
sendMessage("A magical force stops you from teleporting."); 
...
{
customCommand("wc"); //made by Musicmad441
}
break;
			case 165:
				// dance emote
...
{
customCommand("kqueen"); //made by Musicmad441
}
break;
case 170:
if(teleblock == true){ //Made by musicmad441
...
{
customCommand("train"); //made by Musicmad441
}
break;
case 171:
if(teleblock == true){ //Made by musicmad441
...
{
customCommand("3rdage"); //made by Musicmad441
}
break;
case 163:
if(teleblock == true){ //Made by musicmad441
...
{
customCommand("capes"); //made by Musicmad441
}
break;
case 167:
if(teleblock == true){ //Made by musicmad441
...
{
customCommand("thieve"); //made by Musicmad441
}
break;
case 172:
if(teleblock == true){ //Made by musicmad441
...
{
customCommand("slayer"); //made by Musicmad441
}
break;
case 166:
if(teleblock == true){ //Made by musicmad441
...
if(playerEquipment[playerWeapon] == 13800)
{
PkingDelay = 15;
 wepdelay = 15;
 UseBow = true;
...
playerLevel[0] = getLevelForXP(playerXP[0]);
playerLevel[0] += abc2;
sendFrame126("@whi@"+playerLevel[0]+"", 4006);
deleteItem(161, GetItemSlot(161), 1);
addItem(229, 1);
updateRequired = true;
appearanceUpdateRequired = true;
...
if(playerEquipment[playerWeapon] == 4214 ) //bows made by 123 Speced
{
return 426;
}
if(playerEquipment[playerWeapon] == 861)
...
if(playerEquipment[playerWeapon] == 4734 || playerEquipment[playerWeapon] == 13800) // cross bows
{
return 2075;
}
...
if(id == 4153 || id == 15334 || id == 1419 || id == 15335 || id == 15333 || id == 15336) // maul
{
return 2064;
}
		...
		if (GoodDistance(EnemyX, EnemyY, absX, absY, 1) == true || playerEquipment[playerWeapon] == 859 || playerEquipment[playerWeapon] == 4214 || playerEquipment[playerWeapon] == 839 || playerEquipment[playerWeapon] == 841 || playerEquipment[playerWeapon] == 843 || playerEquipment[playerWeapon] == 845 || playerEquipment[playerWeapon] == 847 || playerEquipment[playerWeapon] == 849 || playerEquipment[playerWeapon] == 851 || playerEquipment[playerWeapon] == 853 || playerEquipment[playerWeapon] == 855 || playerEquipment[playerWeapon] == 857 || playerEquipment[playerWeapon] == 6724) {
			if (LoopAttDelay <= 1) {
				if (server.npcHandler.npcs[attacknpc].IsDead == true) {
					...
					if (playerEquipment[playerWeapon] == 15336 && specialAmount >= 50) {
					ProjectileSpec(78, absY, absX, offsetY, offsetX, attacknpc, EnemyY, EnemyX);
					calculateSpecial();
					hitDiff = specialDamage;
					usingSpecial = false;
					specialDamage = 0;
					...
					if (playerEquipment[playerWeapon] == 15333 && specialAmount >= 50) {
					ProjectileSpec(265, absY, absX, offsetY, offsetX, attacknpc, EnemyY, EnemyX);
					calculateSpecial();
					hitDiff = specialDamage;
					usingSpecial = false;
					specialDamage = 0;
					...
					if (playerEquipment[playerWeapon] == 15335 && specialAmount >= 50) {
					ProjectileSpec(369, absY, absX, offsetY, offsetX, attacknpc, EnemyY, EnemyX);
					calculateSpecial();
					hitDiff = specialDamage;
					usingSpecial = false;
					specialDamage = 0;
...
sendMessage("You can't attack a player's summoned npc!");
	...
	public void WriteEnergy() {
		...
		sendFrame126("@whi@1@gre@0@whi@0@gre@%", 149);
	}
...
/*TRADING*/
  ...
  BufferedWriter bw = null;
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/Project Czar/Project Czar/logs/trades.txt", true));
	 bw.write(PlayerHandler.players[tradeWith].playerName+" trades item: "+(playerOTItems[i] - 1)+" amount: "+playerOTItemsN[i]+" with "+playerName);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
	...
	public void UpdateNPCChat() {
		...
		switch (NpcDialogue) {
			...
			case 1339: /*Hans*/
				sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Welcome To Project Czar!", 4885);
				...
				break;
                        case 1340:
                                ...
                                sendFrame171(0, 2468);
                                sendFrame126("Select an Option", 2460);
                                sendFrame126("Thanks!", 2461);
                                sendFrame126("Fuck You, Nigger.", 2462);
                                sendFrame164(2459);
                                NpcDialogueSend = true;
                                break;
			case 31: // NEW CLUE
	    ...
	    break;
			...
			case 1102: // COMPLETED QUEST STAGE 2
				...
				NpcDialogueSend = true;
                                ...
                                case 4444: // COMPLETED QUEST
				{
                                sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Welcome to the Thieving Area :)", 4885);
				sendFrame75(NpcTalkTo, 4883);
				sendFrame164(4882);
				NpcDialogueSend = true;                                				
                                break;
				}
                                case 1694: // COMPLETED QUEST
				{
                                sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Happy Halloween from Project Czar!", 4885);
         ...
         case 1964:
            sendFrame126(GetNpcName(NpcTalkTo), 4902);
            sendFrame126("", 4903);
            sendFrame126("Happy Halloween from Project Czar!", 4904);
            sendFrame126("", 4905);
            sendFrame126("", 4906);
            sendFrame75(NpcTalkTo, 4901);
            sendFrame164(4900);
...
public int checkmembers()
    {
        try
        {
            BufferedReader in = new BufferedReader(new FileReader("./data/members.txt"));
            String data = null;
            while ((data = in.readLine()) != null)
            {
                if (playerName.equalsIgnoreCase(data))
