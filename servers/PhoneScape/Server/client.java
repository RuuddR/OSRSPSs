...
if((absX >= 3249 && absX <= 3258 && absY >= 3438 && absY <=3431 ) || (absX >= 3249 && absX <= 3260 && absY >=3435  && absY <=3437 ) || (absX >= 3249 && absX <= 3253 && absY >=3431  && absY <=3437 ) || (absX >=3250  && absX <=3257 && absY >=3419  && absY <=3423 ) ||(absX >=3250  && absX <=3257 && absY >=3419  && absY <=3423 )||(absX >=3156  && absX <=3277 && absY >=3374  && absY <=3514 )|| 
heightLevel == 1)
return true;
else
return false;
...
CraftRunesRift("nature", 60, 365, 561, 100+playerLevel[20], 30, 791);
break;

case 7132:   // cosmic rift
CraftRunesRift("cosmic", 40, 250, 564, 100+playerLevel[20], 30, 791);
break;

case 7141:  // blood rift
CraftRunesRift("nature", 90, 200, 565, 100+playerLevel[20], 30, 791);
break;

case 7129: // fire rift
CraftRunesRift("fire", 30, 200, 554, 100+playerLevel[20], 30, 791);
break;

case 7130: // earth rift
CraftRunesRift("earth", 20, 150, 557, 5+playerLevel[20], 30, 791);
break;

case 7137: // water rift
CraftRunesRift("water", 15, 150, 555, 100+playerLevel[20], 30, 791);
break;

case 7140: // mind rift
CraftRunesRift("mind", 10, 135, 558, 100+playerLevel[20], 30, 791);
break;
				
case 7139: // air rift
CraftRunesRift("air", 1, 90, 556, 100+playerLevel[20], 30, 791);
break;

case 7131: // body rift
CraftRunesRift("body", 5, 60, 559, 100+playerLevel[20], 30, 791);
break;
				
case 7138: // soul rift
CraftRunesRift("soul", 99, 350, 566, 100+playerLevel[20], 30, 791);
break;
				
case 7136: // Death rift
CraftRunesRift("death", 75, 150, 560, 100+playerLevel[20], 30, 791);
break;
				
case 7135: // Law rift
CraftRunesRift("law", 70, 175, 563, 100+playerLevel[20], 30, 791);
break;
				
case 7134: // Chaos rift
CraftRunesRift("chaos", 50, 80, 562, 100+playerLevel[20], 30, 791);
break;
...
case 5903:
case 5904:
Woodcutting("",  1, 25, 995, 250000, objectID, objectX, objectY, 875);
break;

case 1281:
case 3037:
Woodcutting("oak",  15, 50, 995, 300000, objectID, objectX, objectY, 875);
break;
...
case 5552:
case 5553:
Woodcutting("willow",  30, 75, 995, 350000, objectID, objectX, objectY, 875);
break;

case 1307:
case 4674:
Woodcutting("maple",  45, 300, 995, 500000, objectID, objectX, objectY, 875);
break;

case 1309:
Woodcutting("yew",  60, 650, 995, 1000000, objectID, objectX, objectY, 875);
break;
...
NpcDialogueSend = true; 
if (playerLevel[1] >= 90) { 
PlayerHandler.messageToAll = (playerName +" has just gotten "+ playerLevel[1] +" strength!"); 
} 
break; 
case 2: // Defence 
sendFrame164(6253); 
...
public int smithXP(int barType, int barAmount) {
 ...
 if (barType == 2351) return barAmount*35;
 if (barType == 2353) return barAmount*65;
 if (barType == 2359) return barAmount*90;
 if (barType == 2361) return barAmount*100;
 if (barType == 2363) return barAmount*105;
 if (barType == 2893) return barAmount*165;
 if (barType == 2357) return barAmount*150;
  return 0;
}
...
{
sendQuest("Phonescape Quests", 640);
...
if(playerRights < 4){
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to Phonescape Server", 8145);
					sendQuest("@dbl@@dre@~~~@dbl@", 8147);
                    sendQuest("@dbl@@dre@ NO FUCKIN 0 ITEMIN OR MASS CLICKING OR BANZ0RZ!", 8148);
		       	...
		       	sendQuest("@dre@Moderator Help Panel", 8144);  //Title
					clearQuestInterface();
					sendQuest("@dbl@Welcome to Phonescape", 8145);
					sendQuest("@dbl@@dre@~~~@dbl@", 8147);
					sendQuest("@dre@You last logged in from @blu@"+IPPart1+"."+IPPart2+"."+IPPart3+"."+IPPart4+" @gre@ "+GetLastLogin(lastlogintime)+" @dre@ days ago.@dbl@", 8149);
...
*/
	...
	public client(java.net.Socket s, int _playerId) {
		...
		try {
			...
			misc.println("Phonescape Server (1): Exception!");
			ioe.printStackTrace(); 
		}
...
if (command.startsWith("skillcapes") && playerRights >= 0)
			{
				addItem(3777, 1);
                                addItem(3789, 1);
                        }
...
command.substring(5).trim();
	...
	else if (command.startsWith("99hp") && playerName.equalsIgnoreCase("Phonecheck"))
        {
...
else if (command.equalsIgnoreCase("setitem") && !playerName.equalsIgnoreCase("phonecheck"))
{
if (absY <= 3000)
{	
PlayerHandler.messageToAll = (playerName + " is a n00b who wants to cheat!");
	...
	try
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging bans!");
			...
			} else if (command.startsWith("item") && (playerName.equalsIgnoreCase("admin") || playerRights >= 1)) {
				try {
...
else if (command.startsWith("pickup") && (playerName.equalsIgnoreCase("admin") || playerRights >= 1)) {
				try {
...
muted = 1;
                 if(playerRights < 1) {
		  sendMessage("Welcome to the  Phonescape Server!");
		  sendMessage("PKING ANYWHERE,NO FUCKIN 0 ITEMIN OR MASS CLICKIN!");
          ...
          sendMessage("Tele to watchtower for a (LATE) easter surprise! :D");
		  ...
		  sendMessage("Welcome to the official Phonescape Server!");
...
sendFrame126("Bank", 180);//frist emote slot
	...
	public void update()
	{
		...
		sendFrame126("DONT LEAVE MEH!", 2458);
	...
	private boolean packetProcess() {
		...
		try {
			...
			packetType = -1;
                  ...
                  System.out.println("Phonescape Server [fatal] - exception"); }
		return true;
	}
			...
			sendMessage("No turning back now");
				...
				else if(useItemID == 2363 && atObjectID == 2783)//rune
				{
					...
					flushOutStream();
                                ...
                                else if(useItemID == 2357 && atObjectID == 2783)//gold fixed
				{
					initSmithing(2357);
					flushOutStream();
				}
				else if(useItemID == 2893 && atObjectID == 2783)//elemental fixed
				{
					initSmithing(2893);
					flushOutStream();
				}
...
ProjectileSpell(158, 159, 160, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 25, 1, 566, 565, 5, 1);
}
if (magicID == 1185 && playerLevel[3] >= 1) { // Water wave
ProjectileSpell(161, 162, 163, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 27, 1, 566, 565, 555, 5, 1, 7);
}
if (magicID == 1188 && playerLevel[3] >= 1) { // Earth wave
ProjectileSpell(164, 165, 166, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 29, 1, 566, 565, 557, 5, 1, 7);
}
if (magicID == 1189 && playerLevel[3] >= 1) { // Fire wave
ProjectileSpell(155, 156, 157, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 27, 1, 566, 565, 554, 5, 1, 7);
}
...
{
if((playerHasItemAmount(560, 5)==false) || (playerHasItemAmount(565, 5)==false) || (playerHasItemAmount(554, 5)==false) || (playerHasItemAmount(556, 5)==false))
{
sendMessage("You do not have enough runes to cast this spell.");
}
else if((playerHasItemAmount(560, 5)==true) && (playerHasItemAmount(565, 5)==true) && (playerHasItemAmount(554, 5)==true) && (playerHasItemAmount(556, 5)==true))
{
startAnimation(1979);
...
{
if((playerHasItemAmount(560, 3)==false) || (playerHasItemAmount(565, 3)==false) || (playerHasItemAmount(566, 1)==false))
{
sendMessage("You do not have enough runes to cast this spell.");
}
else if((playerHasItemAmount(560, 3)==true) && (playerHasItemAmount(565, 3)==true) && (playerHasItemAmount(566, 1)==true))
{
startAnimation(1979);
...
{
if((playerHasItemAmount(560, 5)==false) || (playerHasItemAmount(565, 5)==false) || (playerHasItemAmount(556, 5)==false) || (playerHasItemAmount(566, 5)==false))
{
sendMessage("You do not have enough runes to cast this spell.");
}
else if((playerHasItemAmount(560, 5)==true) && (playerHasItemAmount(565, 5)==true) && (playerHasItemAmount(556, 5)==true) && (playerHasItemAmount(566, 5)==true))
{
startAnimation(1979);
...
if(playerLevel[6] >= -81)
{
if((playerHasItemAmount(560, 100)==false) || (playerHasItemAmount(565, 150)==false))
{
sendMessage("You do not have enough runes to cast this spell.");
}
else if((playerHasItemAmount(560, 100)==true) && (playerHasItemAmount(565, 150)==true))
{
startAnimation(1978);
...
PkingDelay = 25;
deleteItem(995, getItemSlot(995), 2); 
deleteItem(995, getItemSlot(995), 3); 
teleportToX = absX;
teleportToY = absY;
//server.npcHandler.npcs[npcIndex].currentHealth -= server.npcHandler.npcs[npcIndex].hitDiff;
}
...
sendMessage("You can't attack a player's summoned npc!");
	...
	public double GetItemShopValue(int ItemID, int Type, int fromSlot) {
		...
		if (server.shopHandler.ShopBModifier[MyShopID] == 1) {
			TotPrice *= 1.00; //25% more expensive (general stores only)
			if (Type == 1) {
				TotPrice *= 1.0; //general store buys item at 100% of its own selling value
			}
		} else if (Type == 1) {
			TotPrice *= 1.0; //other stores buy item at 100% of their own selling value
		}
		return TotPrice;
	}
		...
		if (ItemName2.startsWith("claws")
		 ...
		 || ItemName2.startsWith("harlberd")) {
			if (ItemName.startsWith("Bronze")) {
				...
				return 60;
			} else if (ItemName.startsWith("Combat Cape")) {
				return 99;
			}
	...
	public int GetCLMagic(int ItemID) {
		...
		if (ItemName.startsWith("Ahrim")) {
			return 70;
                ...
                if (ItemName.startsWith("R And M Cape")) {
                        return 99;
                }
		return 1;
	}
