				...
				if (npcs[i].IsDead == false) {
					...
					if (npcs[i].npcType == 209) { // nulodian - black armour shopkeeper
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Random Stuff HERE!!!";
						}
					}
					...
					if (npcs[i].npcType == 1199) {
						...
						if (misc.random2(50) >= 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Welcome to PhoneScape!";
						}
					}
						...
						if (misc.random2(50) >= 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Get your Barrows Armor here!!!";
						}
					}
											else if (npcs[i].npcType == 1552)
					{
						if (misc.random2(50) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Get Your Rares HERE!!";
							}
						}
						else if (npcs[i].npcType == 0000)
					{
						if (misc.random2(10) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							if (PlayerHandler.isPlayerOn("Phonecheck"))
							{
								npcs[i].textUpdate = "Phonecheck is ONLINE";
							}
							else
							{
								npcs[i].textUpdate = "Phonecheck is OFFLINE";
							}
												}
			}
