    ...
    implements Runnable
{
    ...
    public Class17(byte byte0, Socket socket, Applet_Sub1 applet_sub1)
        throws IOException
    {
        aByte380 = 2;
        aBoolean384 = false;
    ...
    public void method227(byte abyte0[], int i, int j)
        throws IOException
    {
        if(aBoolean384)
            return;
    ...
    public void method228(int i, int j, int k, byte abyte0[])
        throws IOException
    {
        if(aBoolean384)
            return;
    ...
    public Applet_Sub1 anApplet_Sub1_385;
