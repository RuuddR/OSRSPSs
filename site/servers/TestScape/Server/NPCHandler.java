				...
				if (npcs[i].IsDead == false) {
					...
					if (npcs[i].actionTimer == 0 && npcs[i].DeadApply == false && npcs[i].NeedRespawn == false) {
						if (npcs[i].npcType == 81 || npcs[i].npcType == 397 || npcs[i].npcType == 1766 || npcs[i].npcType == 1767 || npcs[i].npcType == 1768) {
							...
							ItemHandler.addItem(Item2.randomKBD(), npcs[i].absX, npcs[i].absY, 1, GetNpcKiller(npcs[i].npcType), false); //KBD dead
						}
                                                else if (npcs[i].npcType == 50) {
							client.addItem(Item2.randomKBD(), 1); //KBD dead
						}*/  else {
...
int NPCID2 = NPCID+34;
//System.out.println("Npc id =" +NPCID2);
//System.out.println("Npc id =" +npcs[i].npcType);
//ItemHandler.addItem(newItemID, npcs[NPCID].absX, npcs[NPCID].absY, newItemAmount, GetNpcKiller(NPCID), false);
//if(NPCID2 == 200) // this is index number in autospawn cfg, not actual npc id, if using more than 1 of the desired npc use more than one index - cheez
//{
//ItemHandler.addItem(Item2.randomKBD(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
//}
if(NPCID2 == 297 || NPCID2 == 298 || NPCID2 == 299 || NPCID2 == 300 || NPCID2 == 301 || NPCID2 == 302 || NPCID2 == 303 || NPCID2 == 304) 
{
ItemHandler.addItem(Item2.randomAbyssal(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 360 || NPCID2 == 361 ||NPCID2 == 362 || NPCID2 == 363 || NPCID2 == 364 || NPCID2 == 365 || NPCID2 == 366)
{
ItemHandler.addItem(Item2.randomWknight(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
//if(NPCID2 == 161 || NPCID2 == 162 ||NPCID2 == 163)
//{
//ItemHandler.addItem(Item2.randomKofardy(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
//}
if(NPCID2 == 305)
{
ItemHandler.addItem(Item2.randomDragon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
//if(NPCID2 == 97) 
//{
//ItemHandler.addItem(6570, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
//}
if(NPCID2 == 400 || NPCID2 == 401 || NPCID2 == 402 || NPCID2 == 403 || NPCID2 == 412 || NPCID2 == 413 || NPCID2 == 414 || NPCID2 == 415)
{
ItemHandler.addItem(Item3.randomHighdemon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 100 || NPCID2 == 101) 
{
server.playerHandler.players[Play].Guard += 1;
}
if(NPCID2 ==466 || NPCID2 == 467 || NPCID2 == 468 || NPCID2 == 469 || NPCID2 == 470 || NPCID2 == 471 || NPCID2 == 472 || NPCID2 == 473 || NPCID2 == 474 || NPCID2 == 475 || NPCID2 == 476 || NPCID2 == 477 || NPCID2 == 478)// EVIL CHICKEN
{
ItemHandler.addItem(Item3.randomChicken(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
//if(NPCID2 == 102) 
//{
...
//}
//if(NPCID2 == 167 || NPCID2 == 168 || NPCID2 == 169 || NPCID2 == 170 || NPCID2 == 171 || NPCID2 == 172 || NPCID2 == 173 || NPCID2 == 174 || NPCID2 == 175) //Captured gobilns
//{
//ItemHandler.addItem(Item3.randomcapturedgoblin(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
//}
if(NPCID2 == 105) 
{
ItemHandler.addItem(Item3.randomchaos(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 44 || NPCID2 == 45 || NPCID2 == 50 || NPCID2 == 51 || NPCID2 == 52 || NPCID2 == 53 || NPCID2 == 54) 
{
ItemHandler.addItem(Item3.randomGuard(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 323 || NPCID2 == 324 || NPCID2 == 325 || NPCID2 == 326 || NPCID2 == 327 || NPCID2 == 328 || NPCID2 == 329 || NPCID2 == 330 || NPCID2 == 331 || NPCID2 == 332) // 75 slayer
{
ItemHandler.addItem(Item.randomSlayeritem75(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}

if(NPCID2 == 333 || NPCID2 == 334 || NPCID2 == 335 || NPCID2 == 336 || NPCID2 == 337 || NPCID2 == 338 || NPCID2 == 339) // 65 slayer
{
ItemHandler.addItem(Item.randomSlayeritem65(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 368 || NPCID2 == 369 || NPCID2 == 392 || NPCID2 == 393 || NPCID2 == 394 || NPCID2 == 395 || NPCID2 == 396 || NPCID2 == 397 || NPCID2 == 398 || NPCID2 == 399) //Tyras Guards
{
ItemHandler.addItem(Item3.randomTyrasguard(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 340 || NPCID2 == 341 || NPCID2 == 342 || NPCID2 == 343 || NPCID2 == 344 || NPCID2 == 345 || NPCID2 == 346 || NPCID2 == 347 || NPCID2 == 348 || NPCID2 == 349) // 85 slayer
{
ItemHandler.addItem(Item3.randomSlayeritem85(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 433 || NPCID2 == 434 || NPCID2 == 435 || NPCID2 == 436 || NPCID2 == 437 || NPCID2 == 438 || NPCID2 == 439 || NPCID2 == 440 || NPCID2 == 441)//guthan
{
ItemHandler.addItem(Item2.randomGuthan(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 450 || NPCID2 == 451 || NPCID2 == 452 || NPCID2 == 453 || NPCID2 == 454 || NPCID2 == 455 || NPCID2 == 456 || NPCID2 == 457) //Dharok
{
ItemHandler.addItem(Item2.randomDharok(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 442 || NPCID2 == 443 || NPCID2 == 444 || NPCID2 == 445 || NPCID2 == 446 || NPCID2 == 447 || NPCID2 == 448 || NPCID2 == 449) // Ahrim
{
ItemHandler.addItem(Item2.randomAhrims(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 425 || NPCID2 == 426 || NPCID2 == 427 || NPCID2 == 428 || NPCID2 == 429 || NPCID2 == 430 || NPCID2 == 431 || NPCID2 == 432) // Torag
{
ItemHandler.addItem(Item2.randomTorag(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 416 || NPCID2 == 417 || NPCID2 == 418 || NPCID2 == 419 || NPCID2 == 420 || NPCID2 == 421 || NPCID2 == 422 || NPCID2 == 423 || NPCID2 == 424)//Verac
{
ItemHandler.addItem(Item2.randomVerac(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(NPCID2 == 458 || NPCID2 == 459 || NPCID2 == 460 || NPCID2 == 461 || NPCID2 == 462 || NPCID2 == 463 || NPCID2 == 464 || NPCID2 == 465) // Karil
{
