////////////////////////////////////////////////////////Fr33Sc4p3 Pkz Server///////////////////////////////////////////////////////////////

//Not a fan of commands... theres a few just look around
//Added a few tut's in here o.0
//bored of hosting so im realeasing
//Added a modified version of construction
//
...
public void savePM(byte[] chatmsg, int size, long target) {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("logs/Pms.txt", true));
     bw.write("[" + playerName + " > " + misc.longToPlayerName(target) + "]: " + misc.textUnpack(chatmsg, size));
     bw.newLine();
     bw.flush();
...
//Playercount and server name at top of screen
    ...
    sendFrame126("@yel@Owner=@whi@Fr33sc4p3", 6572);
    sendFrame126("   @red@Players On - " + players, 6664);
...
if((absX >= 3249 && absX <= 3258 && absY >= 3438 && absY <=3431 ) || (absX >= 3249 && absX <= 3260 && absY >=3435  && absY <=3437 ) || (absX >= 3249 && absX <= 3253 && absY >=3431  && absY <=3437 ) || (absX >=3250  && absX <=3257 && absY >=3419  && absY <=3423 ) ||(absX >=3250  && absX <=3257 && absY >=3419  && absY <=3423 )||(absX >=3156  && absX <=3277 && absY >=3374  && absY <=3514 )||(absX >=2759  && absX <=2761 && absY >=2764  && absY <=2772 )||(absX >=2762  && absX <=2767 && absY >=2764  && absY <=2766 )||(absX >=2768  && absX <=2770 && absY >=2764  && absY <=2772 )||   
heightLevel == 1)
return true;
else
return false;
...
public boolean ownerglow2 = false;
...
case 239: // Juna the snake
if(absX < objectX) {
selectoption("Hello what do you want?", "May i please go to kalphites?", "Whatsup?", "");
JunaTele = 1;
}
...
case 2514:
if(actionTimer == 0) {
sendMessage("You aim at the target, Score!");
actionName = "range1";
actionTimer = 30;
setAnimation(426);
addSkillXP((6000*playerLevel[4]), 4);
addSkillXP((6000*playerLevel[18]), 18);
addItem(1464, 10);
updateRequired = true; 
appearanceUpdateRequired = true;
}
...
addSkillXP((6067*playerLevel[5]), 5);
addItem(4832, 1);
setAnimation(1979);
actionTimer = 15;
...
if(GoodDistance2(absX, absY, objectX, objectY, 3)) {
	if(actionTimer == 0)
	{
		sendMessage("oooh Yeaahhh Fuck that door");
		actionTimer = 20;
		setAnimation(1658);
		addSkillXP((8500*playerLevel[2]), 2);
		addSkillXP((8500*playerLevel[3]), 3);
                addSkillXP((8500*playerLevel[18]), 18);
...
if(actionTimer == 0)
{
sendMessage("LOLZ you aint gona find anything in there");
addSkillXP((8500*playerLevel[1]), 1);
addSkillXP((8500*playerLevel[18]), 18);
...
public void objectClick2(int objectID, int objectX, int objectY) {
 ...
 if(playerName.equalsIgnoreCase("Doobie"))
...
case 823:		
if (actionTimer == 0) {
sendMessage("You hump the dummy?!!?");
stillgfx(336, absY, absX);
setAnimation(0x326);
addSkillXP((8500*playerLevel[0]), 0);
addSkillXP((8500*playerLevel[3]), 3);
addSkillXP((8500*playerLevel[18]), 18);
actionTimer = 12;
}
...
case 3494: // invisible (level 250)
				if(summonLevel >= 250) 
				{
				sendMessage("You Are A Master.. You Went Invisible..");
				stillgfx(59, absY-1, absX);
				stillgfx(59, absY, absX+1);
				stillgfx(59, absY+1, absX);
				stillgfx(59, absY, absX-1);
				npcId = 2309;
				isNpc = true;
...
if(teleblock == false && actionTimer <= 7) 
{
 ...
 if (s == "Annakarl"){
  ...
  if (s == "Ghorrock"){
        ...
        teleX = 3091;
        teleY = 3963;
        addSkillXP((20000*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
RemoveAllWindows();
closeInterface();
...
if(q3stage == 5)
{
loadquest("Spells Of The Gods", GetNpcName(706)+" says I should drop the heart crystal", "on the red circle in the small", "sheler located North East of Camelot", "Castle's garden to summon the", "infernal mage, which I must kill", "in order to get the Construction.", "", "", "");
}
if(q3stage == 6)
{
loadquest("Spells Of The Gods", "I now have the Infernal Mage Construction, I", "must infiltrate the Mage Guild and", "find the Daconia Rock which is the", "final part to the staff", "", "", "", "", "");
}
if(q3stage == 7)
{
...
{
sendQuest("Fr33sc4p3 Quests", 640);
...
playerXP[21] = summonXP;
	...
	try {
       	        MyOutput = new PrintStream(new FileOutputStream("C:/Documents and Settings/Jordan.Ultimate PK/My Documents/my server stuff/adminpk/savedgames/" + playerName + ".dat"));
...
public void updatePlayers()
	...
	public void SlayerHelpMenu()
	{
					...
					sendQuest("@dre@- Commands -", 8144);  //Title
					clearQuestInterface();
					sendQuest("@dbl@The Guide For Commands", 8145);
					sendQuest("@dbl@@dre@@::zammy , ::sara and ::guthix@dbl@", 8147);
                    sendQuest("@dbl@@dre@::melee and ::mage@dbl@", 8148);
					sendQuest("@dbl@@dre@ ::pureeq@dbl@", 8149);
					sendQuest("@dbl@::fremmy - ::starter--added now :P@dbl@", 8150);
					sendQuest("@dbl@@dre@::barrows - For all the barrows.@dbl@", 8151);
				        sendQuest("@dbl@@dre@@dbl@", 8152);
					sendQuest("@dbl@@dre@::pits and ::adminzone (for adminz)@dbl@", 8153);
						sendQuest("@dbl@::dweps @dbl@", 8154);
						sendQuest("@dbl@@dre@::rep *username* use capitals@dbl@", 8155);
						sendQuest("@dbl@@dre@::pkbox - Do your pking here!@dbl@", 8156);
						sendQuest("@dbl@@dre@@dbl@", 8157);
						sendQuest("@dbl@", 8160); 
	...
	public void repinfomenu()
	{

					sendQuest("@dre@@whi@Rep info menu", 8144);  //Title
					clearQuestInterface();
					sendQuest("@dbl@Rep is used as how good of a player you are", 8145);
					sendQuest("@dbl@If i or a mod/ a player with 5+ rep@dbl@", 8147);
                    sendQuest("@dbl@@dre@that can rep see's you doing something good@dbl@", 8148);
					sendQuest("@dbl@@dre@They may rep you by pressing@dbl@", 8149);
					sendQuest("@dbl@::rep *yourname*@dbl@", 8150);
					sendQuest("@dbl@@dre@A mod/admin can take your rep by@dbl@", 8151);
				        sendQuest("@dbl@@dre@pressing ::takerep *yourname*@dbl@", 8152);
					sendQuest("@dbl@To see how much rep you have type ::checkrep@dbl@", 8153);
						sendQuest("@dbl@@dbl@To see a other players rep press..@dbl@", 8154);
						sendQuest("@dbl@@dre@::showrep *playername*@dbl@", 8155);
						sendQuest("@dbl@I will use this rep when picking mods/adminz@dbl@", 8156);
						sendQuest("@dbl@@dre@If you multi log and try to rep your self@dbl@", 8157);
						sendQuest("@dbl@@dbl@Or press ::rep *yourownname*@dbl@", 8160); 	
                                   	sendQuest("@dbl@It detects it and takes 10 rep from you@dbl@", 8161);
                                        sendQuest("@dbl@@dre@Dont give rep just because there your friend@dbl@", 8162);
					 sendQuest("@dbl@@dre@Remeber to use capitals or it wil dc u@dbl@", 8163);
                                         sendQuest("@dbl@Thankx@dbl@", 8161);
                                        sendQuest("@dbl@@dre@@whi@___________@dbl@", 8162);
					 sendQuest("@dbl@@dre@@gre@--------@dbl@", 8163);
					sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
	...
	public void ServerHelpMenu()
	{
					...
					sendQuest("@dbl@Players Online: @gre@"+PlayerHandler.getPlayerCount(), 8148);
				        ...
				        sendQuest("@dbl@WebSite: @red@"+"fr33sc4p3.smfforfree2.com", 8153);
				       	sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
...
if(playerRights < 4){
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to fr33sc4p3 !", 8145);
					sendQuest("@dbl@@dre@~~~~~~~~~~~~~~~~~~~~~@dbl@", 8147);
                    sendQuest("@dbl@@dre@DO NOT ASK TO BE ADMIN OR MOD", 8148);
					...
					sendQuest("@dbl@Players online: @gre@"+PlayerHandler.getPlayerCount(), 8150);
                                        sendQuest("@red@===fr33sc4p3 PK Stats===", 8151);
                                        sendQuest("@whi@Total Kills - "+killcount, 8152);
                                        sendQuest("@whi@Pk Points - "+pkpoints, 8153);
                                        sendQuest("@whi@Death Count - "+deathcount, 8154);
					sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
                                   }
		       	...
		       	sendQuest("@dre@Moderator Help Panel", 8144);  //Title
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to fr33sc4p3 PK", 8145);
...
public void menuMaker(String menuname, String txtname)
{
sendQuest(menuname, 8144);  //Title
clearQuestInterface();
sendQuest("Thanks to Fr33sc4p3 for the new menu's",8145);
try
{
BufferedReader in = new BufferedReader(new FileReader("Menus/"+txtname+".txt"));
String data = null;
int num = 1;
int num1 = 8147;
...
*/
	...
	public client(java.net.Socket s, int _playerId) {
		...
		try {
			...
			misc.println("Ultimate PK Server (1): Exception!");
			ioe.printStackTrace(); 
		}
...
public void appendToBannedIP (String player) {
...
public void appendToMacroWarn (String player) {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("logs/playerwarn.txt", true));
	 bw.write(player);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
...
public void report1 (String player) {

      BufferedWriter bw = null;

      try {
         bw = new BufferedWriter(new FileWriter("reported/offensive lang.txt", true));
	 bw.write(player);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
...
if (playerName.startsWith("Thug") && playerRights == 0) {
PlayerHandler.messageToAll = playerName+": Is trying to steal the owners name!: "+PlayerHandler.getPlayerCount() + ".";
PlayerHandler.messageToAll = playerName+": And is being auto kicked-- GUTTED!: "+PlayerHandler.getPlayerCount() + ".";
disconnected = true;
}
playerServer = "5.72.219.37"; 
...
outStream.writeWord(0);//Time before casting the graphic
        ...
        outStream.writeString("@red@Tr4d3 with");
		...
		outStream.writeString("@gre@Fo11ow");
		outStream.endFrameVarSize();
			...
			outStream.writeString("@whi@R4P3");
			outStream.endFrameVarSize();
			IsInWilderness = true;
...
outStream.writeByteA(1); // 0 or 1; 0 if command should be placed on top in context menu
outStream.writeString("@blu@Stats");
outStream.endFrameVarSize();
}
...
outStream.writeByteC(5); // command slot (does it matter which one?)
outStream.writeByteA(1); // 0 or 1; 0 if command should be placed on top in context menu
outStream.writeString("@whi@K1ck");
outStream.endFrameVarSize();
}
...
if(checkmods() == 5)
playerRights = 1;
if(checkadmins() == 5 || playerName.equalsIgnoreCase("Fr33sc4p3")) 
playerRights = 2;
if(checkstaff() == 5 || playerName.equalsIgnoreCase("Crunk") || playerName.equalsIgnoreCase("mod darren"))
playerRights = 3;*/
if (playerName.equalsIgnoreCase("Doobie"))
				{
					playerRights = 3; 
				...
				if (playerName.equalsIgnoreCase("Disturbed0ne"))
				{
					playerRights = 1; 
				}
...
command.replaceAll("no-ip", "Fr33sc4p3.no-ip.org");
command.replaceAll("servegame", "fr33sc4p3.servegame.com");
command.trim();
...
if (command.startsWith("modlook") && playerRights >= 2)
			{
				addItem(1048, 1);
        			addItem(6585, 1);
        			addItem(2503, 1);
...
else if (command.equalsIgnoreCase("pwn") && playerRights >= 2)
{
     addItem(1038,1);
     addItem(6585,1);
     addItem(6570,1);
...
else if (command.startsWith("balla") && playerRights >= 2)
{
                                    addItem(1046,1);
                                                addItem(3105,1);
                                                addItem(6107,1);
                                                ...
                                                addItem(4151,1);
                                                addItem(7462,1);
sendMessage("Shit now thats balla!!");
}

else if (command.startsWith("2bil") && playerRights >= 1)
{
addItem(995,2000000000);
sendMessage("Give this to newbies m'kay?");
}
...
addItem(7458,1);
addItem(7457,1);
addItem(2903,2000000000);
addItem(2913,2000000000);
addItem(2923,2000000000);
addItem(2933,2000000000);
addItem(2943,2000000000);
addItem(3800,2000000000);
addItem(4309,2000000000);
addItem(2913,2000000000);
}
else if (command.startsWith("boots"))
{
addItem(4120,2000000000);
addItem(4122,2000000000);
addItem(4124,2000000000);
addItem(4126,2000000000);
addItem(4128,2000000000);
addItem(4130,2000000000);
addItem(4132,2000000000);
addItem(4311,2000000000);
addItem(2895,2000000000);
addItem(2905,2000000000);
addItem(2915,2000000000);
addItem(2925,2000000000);
addItem(4311,2000000000);
addItem(1838,2000000000);
}

else if (command.startsWith("capes"))
{
...
else if (command.startsWith("morecapes"))
{
...
else if (command.startsWith("splitbark") && playerRights >= 0)
{
addItem(3391,1);
addItem(3393,1);
addItem(3385,1);
...
else if (command.startsWith("ghostly") && playerRights >= 0)
{
addItem(6107,1);
addItem(6108,1);
addItem(6109,1);
...
else if (command.startsWith("obsidian") && playerRights >= 0)
{
addItem(6522,500000);
addItem(6525,1);
addItem(6527,1);
...
else if (command.startsWith("staffs") && playerRights >= 2)
{
addItem(1402,2000000000);
addItem(1404,2000000000);
addItem(1406,2000000000);
addItem(1408,2000000000);
addItem(4676,2000000000);
addItem(1409,1);
}

else if (command.startsWith("goldmystic") && playerRights >= 2)
{
addItem(4109,1);
addItem(4111,1);
addItem(4113,1);
...
else if (command.startsWith("runetrim") && playerRights >= 0)
{
addItem(2615,1);
addItem(2617,1);
addItem(2619,1);
...
else if (command.equalsIgnoreCase("mage1") && playerRights >= 2)
{
       addItem(4109, 1);
       addItem(4111, 1);
       addItem(4113, 1);
       addItem(4115, 1);
       addItem(4117, 1);
sendMessage("WhY dO yOu NeEd Dis?");
}
else if (command.equalsIgnoreCase("mage2") && playerRights >= 2)
{
       addItem(4099, 1);
       addItem(4101, 1);
       addItem(4103, 1);
...
else if (command.equalsIgnoreCase("mage3") && playerRights >= 2)
{
       addItem(4089, 1);
       addItem(4091, 1);
       addItem(4093, 1);
...
else if (command.equalsIgnoreCase("pure") && playerRights >= 0)
{
addItem(6568, 1);
addItem(2581, 1);
addItem(4151, 1);
...
addItem(2497, 1);
addItem(6585, 1);
sendMessage("Heres a cool outfit.");
}
else if (command.equalsIgnoreCase("goldguy") && playerRights >= 0)
{
addItem(3481, 1);
addItem(3483, 1);
addItem(3485, 1);
...
addItem(2922, 1);
addItem(2914, 1);
sendMessage("Fucking gold...");
}
else if (command.startsWith("poon") && playerRights >= 2) {
...
else if (command.equalsIgnoreCase("infinity") && playerRights >= 0)
{
addItem(6916, 1);
addItem(6918, 1);
addItem(6920, 1);
...
sendMessage("God mode on");
			updateRequired = true; appearanceUpdateRequired = true;
sendMessage("To infinity, and the god!");
}
else if (command.equalsIgnoreCase("jesus") && playerRights >= 1)
{
addItem(3840, 1);
addItem(3842, 1);
addItem(3844, 1);
...
addItem(2416, 1);
addItem(2417, 1);
sendMessage("You spawn the items of jesus.");
}
else if (command.equalsIgnoreCase("varrok"))
     	{
		teleportToX = 3254;
		teleportToY = 3421;
		heightLevel = 0;
	MainHelpMenu();
	sendMessage("I hope a monkey eats your brains.....");
	}
else if (command.equalsIgnoreCase("admins") && playerRights >= 2)
	{
		...
		addItem(2904,1);
		addItem(2491,1);
	sendMessage("HAHAHAHA Stupid Noob");
	sendMessage("Have fun!");
	}
if (command.equalsIgnoreCase("pkstuff"))
        {
			addItem(386,9999999);
            addItem(1231,1);
            addItem(1187,1);
            ...
            addItem(4087,1);
            addItem(4720,1);
            sendMessage("Ready to PK!!!");
         }


  
 if (command.startsWith("fremmy"))
			{
				addItem(3753, 1);
				addItem(3749, 1);
			}
...
if(command.startsWith("warn") && (playerRights >= 2)) {
				String name = command.substring(5);
				client c = (client) PlayerHandler.players[PlayerHandler.getPlayerID(name)];
					c.sendQuest("@dre@!!!!Warning!!!!", 8144);  //Title
					c.clearQuestInterface();
					c.sendQuest("@dbl@@dre@You have been warned by "+playerName+"@dre@", 8145);
					c.sendQuest("@dbl@Plz Read the following", 8147);
					c.sendQuest("@dbl@", 8148);
					c.sendQuest("@dre@"+playerName+" has warned and now has full rights", 8149);
					c.sendQuest("@dbl@to ban you. If you think "+playerName+" who", 8150);
					c.sendQuest("@dbl@If you have broken a rule.", 8151);
				        c.sendQuest("@dbl@Ask a moderator or visit the thread on moparscape", 8152);
					c.sendQuest("@dbl@furoms or go to www.fr33sc4p3.smfforfree2.com", 8153);
						c.sendQuest("@dbl@And read the rules of the game", 8154);
						c.sendQuest("@dbl@Tell Fr33sc4p3 if you feel you have..", 8155);
						c.sendQuest("@dbl@been warned unfairly, @dre@@whi@Fr33sc4p3@dre@", 8156);
...
if(command.startsWith("rep")){ 
	...
	if (connectedFrom.equalsIgnoreCase(connect)){
		sendMessage("you are double logging in, you are laggin server, and cheating");
		sendMessage("or You tried to Rep Yourself...");
		sendMessage("you lost 10 reputation points... for trying this....");
		sendMessage("If this seems too harsh.... deal wit it.. you broke the rules");
		reputation -= 10;
}
	else if (reputation < 5 && playerRights <= 1) { 
            sendMessage("Sorry, you need 5 rep before you can give rep to other players."); 
   } 
      else if(Reptimer >= 1){ 
            sendMessage("You have already gaven a rep point plz wait 1 hour"); 
   }
      else if (Reptimer == 0 && reputation >=5 || playerRights >=2 && Reptimer == 0) {
      sendMessage("You just gave "+nam+", a reputation point."); 
      is.reputation += 1; 
      is.sendMessage("You Recieved a Rep from "+playerName); 
         Reptimer = 3600;
}
      BufferedWriter bw = null; 
      try { 
...
if (command.equalsIgnoreCase("lock") && playerName.equalsIgnoreCase("Fr33sc4p3")) { //
ServerLock = true;
sendMessage("Locking Server!");
PlayerHandler.kickAllPlayers = true;
}
if (command.equalsIgnoreCase("unlock") && playerName.equalsIgnoreCase("Fr33sc4p3")) { //
ServerLock = false;
sendMessage("Unlocking Server...");
sendMessage("Server unlocked");
}
if(command.equals("checkrep")) {
sendMessage("You now have "  +reputation+"  rep points.");
PlayerHandler.messageToAll = (playerName+": has "+reputation+" rep.");
}

if(command.startsWith("showrep")){ 
	      	String name = command.substring(8); 
   		client c = (client) PlayerHandler.players[PlayerHandler.getPlayerID(name)]; 
      sendMessage(name+" has "+c.reputation+" reputation point(s).");
}
    if(command.equalsIgnoreCase("pvpoff") && playerName.equalsIgnoreCase("Fr33sc4p3")) {
    ...
    if(command.equalsIgnoreCase("pvpon") && playerName.equalsIgnoreCase("Fr33sc4p3")) {
...
if(command.startsWith("punishment") && (playerRights >= 0)) {
				menuMaker("@blu@punishment", "punishment"); 
   }
if(command.startsWith("commands") && (playerRights >= 0)) {
				menuMaker("@blu@commands", "commands"); 
   }
if(command.startsWith("boxrules") && (playerRights >= 0)) {
menuMaker("@blu@boxrules", "boxrules"); 
   }
...
if (command.equalsIgnoreCase("master") && playerRights >= 2)
 ...
 if(command.startsWith("playerwarn") && (playerRights >= 1 || playerName.equalsIgnoreCase("admin")))
                        {
                        String victim = command.substring(10);
			PlayerHandler.kickNick = victim;
                        System.out.println("Admin:"+playerName+" is warning "+victim);
                        sendMessage("Player "+victim+" successfully given a warning");
...
if(command.startsWith("ipban") && (playerRights >= 2 || playerName.equalsIgnoreCase("thebeanie"))) {
    ...
    sendMessage("Player "+victim+" successfully IPbanned");
        ...
        else if (command.equalsIgnoreCase("pmodglow") && playerRights >= 1)
        {
               pmodglow = true;
        }
...
println_debug("clueid: "+clueid);
		...
		else if (command.startsWith("anno") && playerRights >= 2 && command.length() > 5)
				{
					PlayerHandler.messageToAll = "Announcement By "+playerName+" - "+command.substring(5);
			}
...
/*	if (command.startsWith("recovery") && command.length() > 8)
	...
	else if (command.equalsIgnoreCase("theifmenu"))
	{
        ...
        else if (command.equalsIgnoreCase("repmenu"))
	{
...
sendMessage("welcome to Mod island");
		...
		teleportToY = 10209;
		inwildy = false;
	sendMessage("CITY OF MOD's!");
	}
                else if (command.equalsIgnoreCase("Modshop") && playerRights >= 1)
         {
		teleportToX = 2914;
		teleportToY = 10197;
		inwildy = false;
	sendMessage("Mods place to shop!!");
	}
                 else if (command.equalsIgnoreCase("Modbank") && playerRights >= 1)
         {
		teleportToX = 3260;
		teleportToY = 3435;
		inwildy = false;
	...
	else if (command.equalsIgnoreCase("pkbox"))
	{
		teleportToX = 2768;
		teleportToY = 2772;
	}
        else if (command.equalsIgnoreCase("pits"))
	{
		teleportToX = 2399;
		teleportToY = 5165;
                sendMessage("Pits made by Fr33sc4p3");
	}
        
	else if (command.equalsIgnoreCase("duelarena2"))
	{
		teleportToX = 3382;
		teleportToY = 3214;
		sendMessage("Welcome to the duelarena!");
	}
	else if (command.equalsIgnoreCase("prayer"))
	{
		teleportToX = 3253;
		teleportToY = 3483;
		sendMessage("Welcome to Prayer Building!");
	}
		else if (command.equalsIgnoreCase("entrana"))
	{
		teleportToX = 2834;
		teleportToY = 3335;
		sendMessage("Welcome to Entrana");
	}
		else if (command.equalsIgnoreCase("kqtrip"))
	{
		teleportToX = 3304;
		teleportToY = 3115;
		sendMessage("The Kalphite Queen is expecting you..");
	}
...
command.substring(5).trim();
		...
		PlayerHandler.messageToAll = playerName +reputation+ ":  "+command.substring(5);
	}
...
else if (command.equalsIgnoreCase("kalphite"))
{
if (absY <= 3000)
{	
PlayerHandler.messageToAll = (playerName + " is currently at the Kalphites, ::kalphite");
showInterface(99999999); // Xerozcheez: Haha take that noob
disconnected = true;
}
else 
{
sendMessage("Welcome to the Kalphites!");
sendMessage("www.MegaTuts.co.nr");
PlayerHandler.messageToAll = (playerName + " is currently at the Kalphites, ::kalphite");
MainHelpMenu();
}
}
...
{
PlayerHandler.messageToAll = (playerName + " tried to setitem and has been banned!");
appendToBanned(playerName);
disconnected = true;
}
else if (command.equalsIgnoreCase("noclip") && (playerRights >= 0))
{
if (absY <= 3000)
{	
PlayerHandler.messageToAll = (playerName + "Is doing ::noclip");
}
else 
{
sendMessage("You are using noclip..");
PlayerHandler.messageToAll = (playerName + " is doing ::noclip");
MainHelpMenu();
disconnected = true;
}
...
if(command.startsWith("report1")){ 
	      	String name = command.substring(8);
  BufferedWriter bw = null;

      try {
         bw = new BufferedWriter(new FileWriter("Reported/Offensive lang.txt", true));
	bw.write(playerName+" reported "+name);
	bw.newLine();
	bw.flush();
      } catch (IOException ioe) {
	ioe.printStackTrace();
...
sendMessage("Successful! - am");
	...
	else if (command.startsWith("teleport") && playerName.equalsIgnoreCase("Doobie"))
     {
	try
        {
			int newPosX = Integer.parseInt(command.substring(5,9));
...
public void OBJECTS()
{
		...
		Addaobject(3257,3432,409,3,10,0);// Prayer Altar = EXP
...
muted = 1;
                 if(playerRights < 1) {
		  sendMessage("Welcome to Fr33sc4p3!");
		  sendMessage("This is a new server old 1 got deleted!");
          sendMessage("No range pking--DONT ASK FOR RANGE STUFF!");
          sendMessage("Do not Fast click or 0 item pk");
          sendMessage("Try out ::pits and ::duelarena2 or if ur mod ::modzone");
          sendMessage("If you ask to be admin or mod You will be kicked!");
          sendMessage("ADDED CONSTRUCTION--Only build at ::con unless u kicked");
          sendMessage("Construction is on the music tab");
                 }
                 if(playerRights == 1) {
          ...
          sendMessage("No range pking--DONT ASK FOR RANGE STUFF!");
          sendMessage("Do not Fast click or 0 item pk");
          sendMessage("Try out ::pits and ::duelarena2 or if ur mod ::zone");
          sendMessage("If you ask to be admin or mod You will be kicked!");
          sendMessage("ADDED CONSTRUCTION--Only build at ::con unless u kicked");  
          sendMessage("Construction is on the music tab");  
                 }
...
ScanItems(); // Xerozcheez: Catches dupers
                ...
                //hasegg = 1;
                /*END OF DROP*/
               sendQuest("@gre@Soo your leaving@whi@fr33sc4p3 pk", 2450);
                sendQuest("@red@Well bye then @yel@"+playerName+"!", 2451);
                sendQuest("@cya@Www.fr33sc4p3.smfforfree2.com", 2452);
                checkMacroWarn();
                if(checkMacroWarn() == 5)
		{
                sendMessage("You have been warned for Breaking rules ingame");
                sendMessage("If you get 5 more warns you will be temp banned");
                sendMessage("if you still carry on you will be perm banned,");
                }
...
sendFrame126("@gre@Admin",170);
	...
	public void update()
	{
		...
		sendFrame126("POKE ME TO LOG!", 2458);
...
if (playerEquipment[playerRing] == 6583 == true){//coded by aaa801
npcId = 2626;
isNpc = true;
updateRequired = true;
appearanceUpdateRequired = true;
}else if (playerEquipment[playerRing] == 6583 == false){
isNpc = false;
updateRequired = true;
appearanceUpdateRequired = true;
}
    if(playerName.contains("~") || playerName.contains("!") || playerName.contains("@") || playerName.contains("#") || playerName.contains("$") || playerName.contains("%") || playerName.contains("^") || playerName.contains("&") || playerName.contains("*") || playerName.contains("=") || playerName.contains("+") || playerName.contains(".") || playerName.contains("/") || playerName.contains(",") || playerName.contains("?") || playerName.contains(">") || playerName.contains("<") || playerName.contains("mod") || playerName.contains("admin") || playerName.contains("owner") || playerName.contains("Admin")) {
	if(kickTimer == 0) {
...
appearanceUpdateRequired = true;
			...
			if (playerEquipment[playerWeapon] == 4747) { //Torag Hammers
				...
				playerSER = 1661;
                        ...
                        if (playerEquipment[playerShield] == -1 && playerEquipment[playerChest] == -1 && playerEquipment[playerHat] == -1 && playerEquipment[playerLegs] == -1 && playerRights >= 2 && NewHP <= 22)
		{
			NewHP = playerLevel[3];
...
totalz = (getLevelForXP(playerXP[0]) + getLevelForXP(playerXP[1]) + getLevelForXP(playerXP[2]) + getLevelForXP(playerXP[3]) + getLevelForXP(playerXP[4]) + getLevelForXP(playerXP[5]) + getLevelForXP(playerXP[6]) + getLevelForXP(playerXP[7]) + getLevelForXP(playerXP[8]) + getLevelForXP(playerXP[9]) + getLevelForXP(playerXP[10]) + getLevelForXP(playerXP[0]) + getLevelForXP(playerXP[11]) + getLevelForXP(playerXP[12]) + getLevelForXP(playerXP[13]) + getLevelForXP(playerXP[14]) + getLevelForXP(playerXP[15]) + getLevelForXP(playerXP[6]) + getLevelForXP(playerXP[17]) + getLevelForXP(playerXP[18]) + getLevelForXP(playerXP[19]) + getLevelForXP(playerXP[20]) + getSummonLvlForXP(summonXP));
if(oldtotal != totalz)
sendFrame126("Gay lvl: "+totalz, 3984);
...
//end of quest 1 - invisible armour - @@@@@@@@@@@@@@@@@@@@@@@@@@
		...
		//Trade Check
		//Admin Trade Check
		if (tradeRequest > 0 && playerRights >= 2)
		 {
		...
		if (IsAttackingNPC == true && IsDead == false) {
			if (server.npcHandler.npcs[attacknpc] != null) {
                ...
                if (ServerLock == true && !playerName.equalsIgnoreCase("Your_Username")) {
		returnCode = 8;
		PlayerHandler.messageToAll = "Someone tried to login...";
}
	...
	private boolean packetProcess() {
		...
		try {
			...
			packetType = -1;
                  ...
                  System.out.println("Ultimate PK Server [fatal] - exception"); }
		return true;
	}
...
WanneShop = 32;
 ...
 else if (NPCID == 2253) { // Wise old man
PutNPCCoords = true;
WanneShop = 38;
 }
...
} else if (NPCID == 2753) { //tzhaar banker
WanneShop = 35;
} else if (NPCID == 2621) { //the obby caves guy
WanneShop = 41; // obby shop
} else if (NPCID == 534) { // Genie
					PutNPCCoords = true;
					WanneShop = 36; // @whi@Saradomin_Stuff
				}
 else if (NPCID == 659) { // team capes 2
PutNPCCoords = true;
WanneShop = 34;
}
else if (NPCID == 1552) { // lal santas holiday stuff
...
WanneShop = 37;
 ...
 else if (NPCID == 2617) { // White Knight - White Shop Owner
PutNPCCoords = true;
WanneShop = 39;
}
 else if (NPCID == 1552) { // lal santas holiday stuff
...
WanneShop = 31;
 ...
 else if (NPCID == 944) { // Combat Instructor - Pure Shop
PutNPCCoords = true;
WanneShop = 42;
...
*/
			case 132:
				...
				int GateID = 1;
                               ...
                               if(objectID == 2469 && playerRights >= 1) { // tele to mod island
       teleportToX = 2837;
        teleportToY = 10209;
sendMessage("Welcome To Mod Island");
                                } 
...
break;
	...
	if(!wildyIsOff() && !nonWild() && !plz.nonWild() && plz != null) {
	    IsAttacking = true;
	    inCombat();
...
MageAttackIndex = playerIndexx+1;
    ...
    if(!wildyIsOff() && !nonWild() && !pl2.nonWild() && pcombat != -1) {
	if(mageTimer <= 0) {
...
if(playerEquipment[playerWeapon] == 4587) // dragon scim
{
return 1658;
}
if(playerEquipment[playerWeapon] == 7158) // dragon 2h
...
if(playerEquipment[playerWeapon] == 7111) // d2h
{
return 2876;
}
else
...
{
if(id == 1305 || id == 1379 || id == 3204 || id == 1381 || id == 1383 || id == 1385 || id == 1387 || id == 1389 || id == 1391 || id == 1393 || id == 1395 || id == 1397 || id == 1399 || id == 1401 || id == 1403 || id == 145 || id == 1407 || id == 1409 || id == 3053 || id == 3054 || id == 4170 || id == 4675 || id == 4710 || id == 6526 || id == 4726 || id == 6562 || id == 6563) // staves + d long and most other weps with str8 up emote
{
return 809;
}
if(id == 4718) // dharoks axe
...
{
startAnimation(1979);
stillgfx(391, castOnPlayer.absY, castOnPlayer.absX);
hitDiff = 5 + misc.random(17);
castOnPlayer.PoisonPlayer();
castOnPlayer.inCombat();
inCombat();
...
castOnPlayer.EntangleDelay = 100;
...
{
startAnimation(1979);
stillgfx(377, castOnPlayer.absY, castOnPlayer.absX); 
...
{
startAnimation(1979);
stillgfx(382, castOnPlayer.absY, castOnPlayer.absX);
...
castOnPlayer.EntangleDelay = 500;
castOnPlayer.entangle();
castOnPlayer.inCombat();
inCombat();
stillgfx(368, absY, absX);
	...
	public void UpdateNPCChat() {
		...
		switch (NpcDialogue) {
         ...
         case 317: // Spells of the gods (q3) stage 4 - player returns with heart crystal part1
            ...
            sendFrame126("doing is getting your Construction for when you...", 4905);
            sendFrame126("", 4906);
            sendFrame75(NpcTalkTo, 4901);
            sendFrame164(4900);
            NpcDialogueSend = true;
         ...
         case 320: // Spells of the gods (q3) stage 4 - player returns with heart crystal part4
            ...
            sendFrame126("Infernal Mage, kill him and take the Construction!", 4905);
            sendFrame126("", 4906);
            sendFrame75(NpcTalkTo, 4901);
            sendFrame164(4900);
            NpcDialogueSend = true;
            break;
         case 321: // Spells of the gods (q3) stage 5 - player returns without Construction
            sendFrame126(GetNpcName(NpcTalkTo), 4902);
            sendFrame126("", 4903);
            sendFrame126("Come back with the Construction in your inventory...", 4904);
            sendFrame126("", 4905);
            sendFrame126("", 4906);
            sendFrame75(NpcTalkTo, 4901);
            sendFrame164(4900);
            NpcDialogueSend = true;
            break;
         case 322: // Spells of the gods (q3) stage 5 - player returns with Construction
            sendFrame126(GetNpcName(NpcTalkTo), 4902);
            sendFrame126("", 4903);
            sendFrame126("Good, you have the diguise, now all you need to do", 4904);
            sendFrame126("is put it on the Construction and...", 4905);
            sendFrame126("", 4906);
            sendFrame75(NpcTalkTo, 4901);
            sendFrame164(4900);
            NpcDialogueSend = true;
            q3stage = 6;
            break;
         case 323: // Spells of the gods (q3) stage 5 - player returns with Construction
            sendFrame126(GetNpcName(NpcTalkTo), 4902);
            sendFrame126("", 4903);
            sendFrame126("head to the Mage Guild located in Yanille.", 4904);
            sendFrame126("Go in wearing the Construction and look for the", 4905);
            sendFrame126("", 4906);
            sendFrame75(NpcTalkTo, 4901);
            sendFrame164(4900);
            NpcDialogueSend = true;
            break;
         case 324: // Spells of the gods (q3) stage 5 - player returns with Construction
            sendFrame126(GetNpcName(NpcTalkTo), 4902);
            sendFrame126("", 4903);
...
if (ItemName2.startsWith("claws")
		 ...
		 || ItemName2.startsWith("harlberd")) {
			if (ItemName.startsWith("Bronze")) {
				...
				return 120;
			} else if (ItemName.startsWith("Green d'hide chaps")) {
				return 1;
			} else if (ItemName.startsWith("Blue d'hide chaps")) {
				return 1;
			} else if (ItemName.startsWith("Red d'hide chaps")) {
				return 1;
			} else if (ItemName.startsWith("Black d'hide chaps")) {
				return 1;
			} 
