...
p.sendQuest("@whi@", 949);
p.sendQuest("@whi@", 950);
p.sendQuest("@gre@Players Online: @whi@"+PlayerHandler.getPlayerCount(), 174);
...
p.sendFrame126("", 180);
p.sendFrame126("@red@Jad",181);
p.sendFrame126("@cya@Veng", 178);
p.sendFrame126("@gre@Wc",175);
p.sendFrame126("@red@1v1",177);
p.sendFrame126("@cya@Cather",185);
p.sendFrame126("@whi@3rdage",186);
p.sendFrame126("@cya@ghosts",173);
p.sendFrame126("@gre@Thieve",179);
p.sendFrame126("@whi@Slayer",187);
p.sendFrame126("@gre@Smith",176);
p.sendFrame126("@red@Shops",13371);
...
p.sendFrame126("@whi@Auto Retaliate",155 );
p.sendFrame126("@whi@Kqueen",182 );
p.sendFrame126("@gre@Closewindow",3902 );
p.sendFrame126("@whi@On",157 );
p.sendFrame126("@whi@Off",156 );
