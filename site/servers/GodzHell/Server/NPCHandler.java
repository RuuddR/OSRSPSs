...
if (npcs[i].npcType == 399) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Welcome to mod island!";
}
}
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Another lost soul, MWJAJAJAJAJAJA!!!!!";
}
}
if (npcs[i].npcType == 1697) {
if (misc.random2(30) <= 2) {
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
...
npcs[i].updateRequired = true;
npcs[i].textUpdateRequired = true;
npcs[i].textUpdate = "Selling farm supplies!";
}
}
...
{ 
     if (person.distanceToPoint(npcs[i].absX, npcs[i].absY) >= 5)
     if (npcs[i].npcType != 1160 || npcs[i].npcType == 2745 || npcs[i].npcType == 50)
{
    npcs[i].RandomWalk = true;
}
}
...
teleportToX = 3551; // Change coordinates
teleportToY = 9677; // Change coordinates
sendMessage("Good job now kill Verac to go to Torag!");
}
{ 
...
int Player = npcs[NPCID].StartKilling;
teleportToX = 3551; // Change coordinates
teleportToY = 9711; // Change coordinates
sendMessage("Good job now kill Torag to go to Ahrims!");
}
{ 
if(npcs[NPCID].npcType == 2025 )
{
int Player = npcs[NPCID].StartKilling;
teleportToX = 3535; // Change coordinates
teleportToY = 9694; // Change coordinates
sendMessage("Good job now kill Ahrim to go to Guthan!");
}
{ 
...
teleportToX = 3535; // Change coordinates
teleportToY = 9694; // Change coordinates
sendMessage("Good job now kill Guthan to go to Karil!");
}
{ 
...
teleportToX = 3535; // Change coordinates
teleportToY = 9694; // Change coordinates
sendMessage("Good job now kill Karil to go to Chaos Elemental!!");
}
{ 
...
{
ItemHandler.addItem(15084, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 752) 
{
ItemHandler.addItem(15077, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 752) 
{
ItemHandler.addItem(15072, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
...
ItemHandler.addItem(Item2.randomDag(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
...
tele.teleportToX = 3551;
tele.teleportToY = 9677;
tele.sendMessage("Good job now kill Verac to go to Torag!");
...
client tele = (client) server.playerHandler.players[GetNpcKiller(NPCID)];
tele.teleportToX = 3551;
tele.teleportToY = 9711;
tele.sendMessage("Good job now kill Torag to go to Ahrims!");


}
if(npcs[NPCID].npcType == 2029) {
client tele = (client) server.playerHandler.players[GetNpcKiller(NPCID)];
tele.teleportToX = 3537;
tele.teleportToY = 9712;
tele.sendMessage("Good job now kill Ahrim to go to Guthan!");


}
if(npcs[NPCID].npcType == 2025) {
client tele = (client) server.playerHandler.players[GetNpcKiller(NPCID)];
tele.teleportToX = 3535;
tele.teleportToY = 9694;
tele.sendMessage("Good job now kill Guthan to go to Karil!");


}
if(npcs[NPCID].npcType == 2027) {
client tele = (client) server.playerHandler.players[GetNpcKiller(NPCID)];
tele.teleportToX = 3534;
tele.teleportToY = 9677;
tele.sendMessage("Good job now kill Karil to go to the Chaos Elemental!!");


}
if(npcs[NPCID].npcType == 2028) {
client tele = (client) server.playerHandler.players[GetNpcKiller(NPCID)];
tele.teleportToX = 3045;
tele.teleportToY = 3743;
tele.sendMessage("Good job now kill the Chaos Elemental to go to the chest!!");
...
client tele = (client) server.playerHandler.players[GetNpcKiller(NPCID)];
tele.teleportToX = 3045;
tele.teleportToY = 3751;
tele.sendMessage("SWEET YOU DID IT! CLICK THE CHEST!");
