				...
				if (npcs[i].IsDead == false) {
					if (npcs[i].npcType == 1268 || npcs[i].npcType == 1266) {
						...
						npcs[i].updateRequired = true;
                                                ...
                                                if(npcs[i].npcType == 1645 || npcs[i].npcType == 509 || npcs[i].npcType == 1241 || npcs[i].npcType == 2745 || npcs[i].npcType == 1246)
                                                AttackPlayerMage(i);
                                                else
						AttackPlayer(i);
					...
					if (npcs[i].npcType == 81 || npcs[i].npcType == 397 || npcs[i].npcType == 1766 || npcs[i].npcType == 1767 || npcs[i].npcType == 1768) {
						...
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Sellin Lots Of Stuff !";
						}
					}
						if (npcs[i].npcType == 1835) {
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Easter Event !";
						}
					}
						if (npcs[i].npcType == 356) {
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Easter Gift !";
						}
					}
						if (npcs[i].npcType == 1700) {
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
						...
						if (npcs[i].npcType == 278) {
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Cooking Shop !";
						}
					}
						...
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Range Supplies Here !";
						}
					}
						...
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Silab Items Here must have client!";
						}
					}
						if (npcs[i].npcType == 526) {
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Mage Supplies Here !";
						}
					}
						if (npcs[i].npcType == 577) {
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Melee Uniform !";
						}
					}
						if (npcs[i].npcType == 580) {
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "PK Supplies !";
						}
					}
						...
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Sell Your Junk Here !";
						}
					}
						if (npcs[i].npcType == 546) {
						if (misc.random2(22) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Food Here !";
						}
					}
						if (npcs[i].npcType == 170) {
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "There Are "+ PlayerHandler.getPlayerCount()+" Players Online !";
						}
					}
						...
						if (misc.random2(20) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Welcome to Godz-Pk !";
						}
					}
...
ppl.addSkillXP(1050, 18);
}
if(npcs[NPCID].npcType == 941) 
{
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.sendMessage("You killed the green dragon? Can you handle the blue one?");
ppl.teleportToX = 2713;
ppl.teleportToY = 4836;
}
if(npcs[NPCID].npcType == 55) 
{
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.sendMessage("The blue one is dead! Now for the red one!");
ppl.teleportToX = 2584;
ppl.teleportToY = 4836;
}
...
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.sendMessage("Wow! I can't believe you beat the red one, the Black one won't be that easy!");
ppl.teleportToX = 2845;
ppl.teleportToY = 4832;
}
if(npcs[NPCID].npcType == 54) 
{
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.sendMessage("Final Round: KBD! Kill it for your torso!");
ppl.teleportToX = 2269;
ppl.teleportToY = 4843;
}
if(npcs[NPCID].npcType == 50) 
{
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addItem(11268, 1);
ppl.sendMessage("The minigame is complete! Heres your torso!");
ppl.teleportToX = 2791;
ppl.teleportToY = 3181;
}
...
if(npcs[NPCID].npcType == 1125) 
{
ItemHandler.addItem(Item2.randomDad(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 1472) 
{
ItemHandler.addItem(Item2.randomJungle(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 742) 
{
ItemHandler.addItem(Item2.randomDemon(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
}
if(npcs[NPCID].npcType == 82) 
{
ItemHandler.addItem(Item.randomtrain(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(55, 18);
}
...
if(npcs[NPCID].npcType == 1157) 
{
ItemHandler.addItem(Item.randomtrain(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(60, 18);
}
// start of slayer house by i loot i
if (npcs[NPCID].npcType >= 1616 && npcs[NPCID].npcType <= 1650)
{
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
if(ppl.playerLevel[18] >= 50) { //Stop nerds
ItemHandler.addItem(Item.randomhouse(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ppl.addSkillXP(2500, 18);
}
}
if(npcs[NPCID].npcType == 1614) 
{
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
if(ppl.playerLevel[18] >= 50) { //Stop nerds
...
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
if(ppl.playerLevel[18] >= 85) { // stop nerds ...
ItemHandler.addItem(Item.randomabyss(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
ppl.addSkillXP(8500, 18);
}
}
// end of slayer house by i loot i
if (npcs[NPCID].npcType >= 1192 && npcs[NPCID].npcType <= 1194)
{
ItemHandler.addItem(4558, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(125, 18);
}
if(npcs[NPCID].npcType == 1154) 
{
ItemHandler.addItem(Item.randomtrain(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
...
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(255, 18);
}
if(npcs[NPCID].npcType == 182) 
{
ItemHandler.addItem(Item.randomtrain2(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(145, 18);
}
if(npcs[NPCID].npcType == 142) 
{
ItemHandler.addItem(Item.randomwhite(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(375, 18);
}
if (npcs[NPCID].npcType >= 2025 && npcs[NPCID].npcType <= 2030)
{
ItemHandler.addItem(Item.randombarrows(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(435, 18);
}
if(npcs[NPCID].npcType == 2745) 
{
ItemHandler.addItem(Item.randomtzokjad(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(1550, 18);
}
if(npcs[NPCID].npcType == 795) 
{
ItemHandler.addItem(Item.randomkalphite(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
server.playerHandler.players[Play].Killedqueen = true;
int Player = npcs[NPCID].StartKilling;
client ppl = (client) server.playerHandler.players[Player];
ppl.addSkillXP(1150, 18);
}
