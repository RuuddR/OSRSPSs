...
public int untradable[] = {}; // untradable items
...
break;
                      ...
                      case 4140:
if(myteletimer > 1) {
 TeleTo("Varrock", 0); ancientstele = false;myteletimer = 8;} break;

                      case 4143:
if(myteletimer > 1) {
 TeleTo("Lumby", 45); ancientstele = false;myteletimer = 8;} break;

                      case 4146:
if(myteletimer > 1) {
 TeleTo("Falador", 60); ancientstele = false;myteletimer = 8;} break;

                      case 4150:
if(myteletimer > 1) {
 TeleTo("Camelot", 70); ancientstele = false;myteletimer = 8;} break;

                      case 6004:
if(myteletimer > 1) {
 TeleTo("Ardougne", 78);ancientstele = false;myteletimer = 8;} break;

                      case 6005:
if(myteletimer > 1) {
 TeleTo("Watchtower", 80);ancientstele = false;myteletimer = 8;} break;

                      case 29031:
if(myteletimer > 1) {
 TeleTo("Trollheim", 90);ancientstele = false;myteletimer = 8;} break;

                      case 72038:
if(myteletimer > 1) {
 TeleTo("Ape", 110); ancientstele = false;myteletimer = 8;} break;

                    case 50235:
if(myteletimer > 1) {
 TeleTo("Paddewwa", 70); ancientstele = true;myteletimer = 8;} break;
                    case 50245:
if(myteletimer > 1) {
 TeleTo("Senntisten", 80); ancientstele = true;myteletimer = 8;} break;
                    case 50253:
if(myteletimer > 1) {
 TeleTo("Kharyrll", 90); ancientstele = true;myteletimer = 8;} break;
                    case 51005:
if(myteletimer > 1) {
 TeleTo("Lassar", 105); ancientstele = true; myteletimer = 8;}break;
                    case 51013:
if(myteletimer > 1) {
 TeleTo("Dareeyak", 118); ancientstele = true;myteletimer = 8;} break;
                    case 51023:
if(myteletimer > 1) {
 TeleTo("Carrallangar", 120); ancientstele = true;myteletimer = 8;} break;
                    case 51031:
if(myteletimer > 1) {
 TeleTo("Annakarl", 125); ancientstele = true;myteletimer = 8;} break;
                    case 51039:
if(myteletimer > 1) { 
TeleTo("Ghorrock", 130); 
ancientstele = true;
