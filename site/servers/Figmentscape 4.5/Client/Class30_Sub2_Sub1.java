...
public class Class30_Sub2_Sub1 extends Class30_Sub2
{
    ...
    public static void method333(int i, int j, boolean flag, int k, int l)
    {
        if(j < 0)
            j = 0;
        if(l < 0)
    ...
    public static void method334(boolean flag)
    {
        if(!flag)
            aBoolean1377 = !aBoolean1377;
    ...
    public static void method336(int i, int j, int k, int l, int i1, int j1)
    {
        if(k < anInt1383)
        {
            i1 -= anInt1383 - k;
    ...
    {
        method339(i1, l, j, i, (byte)4);
        method339((i1 + k) - 1, l, j, i, (byte)4);
        method341(i1, l, k, i, anInt1376);
        method341(i1, l, k, (i + j) - 1, anInt1376);
        if(flag);
    }
    ...
    public static void method339(int i, int j, int k, int l, byte byte0)
    {
    ...
    public static void method341(int i, int j, int k, int l, int i1)
    {
