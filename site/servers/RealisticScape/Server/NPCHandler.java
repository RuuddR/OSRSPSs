...
// -------------------------------- //Start NPC Drops
	...
	public void bone(int npc, int NPCID)
	{
        if (npcs[npc].npcType >= 0 && npcs[npc].npcType <= 81)
        {
...
// --------------------------------
	...
	public void bone2(int npc, int NPCID)
	{
		if (npcs[npc].npcType >= 85 && npcs[npc].npcType <= 3000)
		{         
			ItemHandler.addItem(Item3.randomBONE(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);                                               
		}
	}
...
// --------------------------------
	...
	public void ash(int npc, int NPCID)
	{
		if (npcs[npc].npcType >= 82 && npcs[npc].npcType <= 84)
		{         
			ItemHandler.addItem(Item3.randomASH(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);                                               
		}
	}

// --------------------------------

	public void rat(int npc, int NPCID)
	{
		if (npcs[npc].npcType >= 86 && npcs[npc].npcType <= 87)
		{         
...
// --------------------------------
	...
	public void man(int npc, int NPCID)
	{
		if (npcs[npc].npcType >= 1 && npcs[npc].npcType <= 6)
		{
...
// --------------------------------
	...
	public void guard(int npc, int NPCID)
	{
		if (npcs[npc].npcType >= 9 && npcs[npc].npcType <= 10)
		{
...
// --------------------------------
	...
	public void thief(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 8)
		{
...
// --------------------------------
	...
	public void goblin(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 1769 && npcs[npc].npcType == 1770 && npcs[npc].npcType == 1771 && npcs[npc].npcType == 1772 && npcs[npc].npcType == 1774)
		{
...
// --------------------------------
	...
	public void barbarians(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 12 && npcs[npc].npcType == 17)
		{
			ItemHandler.addItem(Item2.randomBARBARIANS(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);                                               
		}
	}

// --------------------------------

	public void wizard(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 13)
		{
...
// --------------------------------
	...
	public void lesser(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 82)
		{
			ItemHandler.addItem(Item2.randomLESSER(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);                                               
		}
	}

// --------------------------------

	public void greater(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 83)
		{         
			ItemHandler.addItem(Item2.randomGREATER(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);                                               
		}
	}

// --------------------------------

	public void whiteknight(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 19)
		{         
...
// --------------------------------
	...
	public void cow(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 81)
		{
			ItemHandler.addItem(Item2.randomCOW(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);                                               
		}
	}

// --------------------------------

	public void chicken(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 41)
		{         
...
// --------------------------------
	...
	public void kbd(int npc, int NPCID)
	{
		if (npcs[npc].npcType == 50)
		{
		...
		for (int i = 0; i < maxNPCs; i++)
		{
			if (npcs[i] != null) {
				...
				if (npcs[i].IsDead == false)
				{
					...
					else if (npcs[i].RandomWalk == true && misc.random2(10) == 1 && npcs[i].moverangeX1 > 0 && npcs[i].moverangeY1 > 0 && npcs[i].moverangeX2 > 0 && npcs[i].moverangeY2 > 0)
					{
...
//Start NPC Talking
				if (npcs[i].npcType == 2591)
				{
					if (misc.random2(25) <= 3)
					{
						npcs[i].updateRequired = true;
						npcs[i].textUpdateRequired = true;
						npcs[i].textUpdate = "Tzhaar Bank";
					}
				}
				if (npcs[i].npcType == 2619)
				{
					if (misc.random2(25) <= 3)
					{
						npcs[i].updateRequired = true;
						npcs[i].textUpdateRequired = true;
						npcs[i].textUpdate = "Tzhaar cave, beat the caves!!";
					}
				}
				if (npcs[i].npcType == 2622)
				{
					if (misc.random2(25) <= 3)
					{
						npcs[i].updateRequired = true;
						npcs[i].textUpdateRequired = true;
						npcs[i].textUpdate = "Tzhaar ore and gem store!!";
					}
				}
				if (npcs[i].npcType == 2620)
				{
					if (misc.random2(25) <= 3)
					{
						npcs[i].updateRequired = true;
						npcs[i].textUpdateRequired = true;
						npcs[i].textUpdate = "Tzhaar items here! includes swords cape!";
					}
				}
				if (npcs[i].npcType == 2623)
				{
					if (misc.random2(25) <= 3)
					{
						npcs[i].updateRequired = true;
						npcs[i].textUpdateRequired = true;
						npcs[i].textUpdate = "Tzhaar rune shop! buy and sell runes!";
					}
				}
				if (npcs[i].npcType == 342)
				{
					if (misc.random2(30) <= 3)
					{
						npcs[i].updateRequired = true;
						npcs[i].textUpdateRequired = true;
						npcs[i].textUpdate = "Welcome to Brimhaven Cave, try not to die.";
					}
				}
				if (npcs[i].npcType == 31)
				{
					if (misc.random2(25) <= 3)
					{
						npcs[i].updateRequired = true;
						npcs[i].textUpdateRequired = true;
						if (PlayerHandler.isPlayerOn("Alexia"))
						{
							npcs[i].textUpdate = "Wo0t! Alexia is online! =[)";
						}
						else
						{
							npcs[i].textUpdate = "Noooooo!!!! Alexia is offline right now. =(";
						}
					}
				}
//End NPC Talking
			...
			if (npcs[NPCID].actionTimer == 0)
			{
				...
				else
				{
					...
					else
					{
						...
						else if (npcs[NPCID].npcType == 3200)
						{
